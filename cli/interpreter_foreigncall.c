...
extern ssize_t ios_fillbuf(ios_t *);
...
struct small_arraylist_t;
typedef struct small_arraylist_t small_arraylist_t;
extern void small_arraylist_grow(small_arraylist_t *, uint32_t);
typedef short int16_t;
extern int16_t jl_threadid(void);
extern void jl_threading_profile(void);
extern void * jl_get_ptls_states(void);
#undef jl_cpu_pause
...
struct _jl_task_t;
extern void jl_gc_enable_finalizers(struct _jl_task_t *, int);
extern void jl_gc_disable_finalizers_internal(void);
extern void jl_gc_enable_finalizers_internal(void);
extern void jl_gc_run_pending_finalizers(struct _jl_task_t *);
...
extern void jl_gc_queue_root(const jl_value_t *);
extern void jl_gc_queue_multiroot(const jl_value_t *, const jl_value_t *);
...
extern jl_svec_t * jl_compute_fieldtypes(jl_datatype_t *, void *);
extern void * jl_symbol_name(jl_sym_t *);
extern int jl_subtype(jl_value_t *, jl_value_t *);
extern int jl_egal(const jl_value_t *, const jl_value_t *);
extern int jl_egal__bits(const jl_value_t *, const jl_value_t *, jl_datatype_t *);
extern int jl_egal__special(const jl_value_t *, const jl_value_t *, jl_datatype_t *);
extern int jl_egal__unboxed(const jl_value_t *, const jl_value_t *, jl_datatype_t *);
typedef unsigned long uintptr_t;
extern uintptr_t jl_object_id(jl_value_t *);
extern int jl_type_equality_is_identity(jl_value_t *, jl_value_t *);
...
extern jl_typename_t * jl_new_typename_in(jl_sym_t *, jl_module_t *, int, int);
...
extern jl_datatype_t * jl_apply_modify_type(jl_value_t *);
extern jl_datatype_t * jl_apply_cmpswap_type(jl_value_t *);
extern jl_tupletype_t * jl_apply_tuple_type(jl_svec_t *);
extern jl_tupletype_t * jl_apply_tuple_type_v(jl_value_t **, size_t);
extern jl_datatype_t * jl_new_datatype(jl_sym_t *, jl_module_t *, jl_datatype_t *, jl_svec_t *, jl_svec_t *, jl_svec_t *, jl_svec_t *, int, int, int);
extern jl_datatype_t * jl_new_primitivetype(jl_value_t *, jl_module_t *, jl_datatype_t *, jl_svec_t *, size_t);
extern jl_value_t * jl_new_bits(jl_value_t *, const void *);
extern jl_value_t * jl_atomic_new_bits(jl_value_t *, const char *);
extern void jl_atomic_store_bits(char *, const jl_value_t *, int);
extern jl_value_t * jl_atomic_swap_bits(jl_value_t *, char *, const jl_value_t *, int);
extern int jl_atomic_bool_cmpswap_bits(char *, const jl_value_t *, const jl_value_t *, int);
extern jl_value_t * jl_atomic_cmpswap_bits(jl_datatype_t *, jl_datatype_t *, char *, const jl_value_t *, const jl_value_t *, int);
...
extern jl_sym_t * jl_tagged_gensym(const char *, size_t);
extern jl_sym_t * jl_get_root_symbol(void);
extern jl_value_t * jl_generic_function_def(jl_sym_t *, jl_module_t *, _Atomic(jl_value_t *) *, jl_value_t *, jl_binding_t *);
extern jl_method_t * jl_method_def(jl_svec_t *, jl_methtable_t *, jl_code_info_t *, jl_module_t *);
...
extern jl_value_t * jl_box_uint8pointer(uint8_t *);
...
extern uint8_t * jl_unbox_uint8pointer(jl_value_t *);
...
extern int jl_array_validate_dims(size_t *, size_t *, uint32_t, size_t *, size_t);
...
extern void jl_set_module_optlevel(jl_module_t *, int);
extern int jl_get_module_optlevel(jl_module_t *);
extern void jl_set_module_compile(jl_module_t *, int);
extern int jl_get_module_compile(jl_module_t *);
extern void jl_set_module_infer(jl_module_t *, int);
extern int jl_get_module_infer(jl_module_t *);
extern void jl_set_module_max_methods(jl_module_t *, int);
extern int jl_get_module_max_methods(jl_module_t *);
...
extern jl_value_t * jl_binding_type(jl_module_t *, jl_sym_t *);
...
extern void jl_module_use_as(jl_module_t *, jl_module_t *, jl_sym_t *, jl_sym_t *);
extern void jl_module_import(jl_module_t *, jl_module_t *, jl_sym_t *);
extern void jl_module_import_as(jl_module_t *, jl_module_t *, jl_sym_t *, jl_sym_t *);
...
extern jl_value_t * jl_get_libllvm(void);
...
extern void jl_atomic_error(char *);
...
extern void jl_set_newly_inferred(jl_value_t *);
...
extern jl_value_t * jl_parse_all(const char *, size_t, const char *, size_t, size_t);
...
extern jl_value_t * jl_expand_with_loc_warn(jl_value_t *, jl_module_t *, const char *, int);
extern jl_value_t * jl_expand_in_world(jl_value_t *, jl_module_t *, const char *, int, size_t);
...
extern jl_libhandle jl_load_dynamic_library(const char *, unsigned int, int);
extern jl_libhandle jl_dlopen(const char *, unsigned int);
extern int jl_dlclose(jl_libhandle);
extern int jl_dlsym(jl_libhandle, const char *, void **, int);
...
extern jl_array_t * jl_compress_ir(jl_method_t *, jl_code_info_t *);
extern jl_code_info_t * jl_uncompress_ir(jl_method_t *, jl_code_instance_t *, jl_array_t *);
extern uint8_t jl_ir_flag_inferred(jl_array_t *);
extern uint8_t jl_ir_flag_inlineable(jl_array_t *);
extern uint8_t jl_ir_flag_pure(jl_array_t *);
extern ssize_t jl_ir_nslots(jl_array_t *);
extern uint8_t jl_ir_slotflag(jl_array_t *, size_t);
...
extern int jl_is_syntactic_operator(char *);
...
extern jl_value_t * jl_call(jl_function_t *, jl_value_t **, uint32_t);
...
extern int jl_set_task_tid(jl_task_t *, int);
...
#undef jl_get_pgcstack
extern jl_gcframe_t ** jl_get_pgcstack(void);
...
extern int jl_process_events(void);
struct uv_loop_s;
extern struct uv_loop_s * jl_global_event_loop(void);
struct uv_handle_s;
extern void jl_close_uv(struct uv_handle_s *);
extern jl_array_t * jl_take_buffer(ios_t *);
struct uv_stream_s;
extern void jl_uv_puts(struct uv_stream_s *, const char *, size_t);
extern int jl_printf(struct uv_stream_s *, const char *, ...);
extern void jl_safe_printf(const char *, ...);
extern struct uv_stream_s * jl_stdout_stream(void);
extern struct uv_stream_s * jl_stdin_stream(void);
extern struct uv_stream_s * jl_stderr_stream(void);
extern void jl_flush_cstdio(void);
extern jl_value_t * jl_stdout_obj(void);
extern jl_value_t * jl_stderr_obj(void);
extern size_t jl_static_show(struct uv_stream_s *, jl_value_t *);
extern size_t jl_static_show_func_sig(struct uv_stream_s *, jl_value_t *);
extern void jl_print_backtrace(void);
...
extern jl_task_t * jl_get_current_task(void);
struct __jmp_buf_tag;
typedef void *sigjmp_buf;
extern sigjmp_buf * jl_get_safe_restore(void);
typedef void *sigjmp_buf;
extern void jl_set_safe_restore(sigjmp_buf *);
...
extern void jl_start_alloc_profile(double);
extern void jl_stop_alloc_profile(void);
extern void jl_free_alloc_profile(void);
extern unsigned int uv_version(void);
extern const char * uv_version_string(void);
extern void uv_library_shutdown(void);
typedef void *uv_malloc_func;
typedef void *uv_realloc_func;
typedef void *uv_calloc_func;
typedef void *uv_free_func;
extern int uv_replace_allocator(uv_malloc_func, uv_realloc_func, uv_calloc_func, uv_free_func);
typedef struct uv_loop_s uv_loop_t;
extern uv_loop_t * uv_default_loop(void);
extern int uv_loop_init(uv_loop_t *);
extern int uv_loop_close(uv_loop_t *);
extern uv_loop_t * uv_loop_new(void);
extern void uv_loop_delete(uv_loop_t *);
extern size_t uv_loop_size(void);
extern int uv_loop_alive(const uv_loop_t *);
typedef int uv_loop_option;
extern int uv_loop_configure(uv_loop_t *, uv_loop_option, ...);
typedef int uv_run_mode;
extern int uv_run(uv_loop_t *, uv_run_mode);
...
extern uv_os_fd_t uv_backend_fd(const uv_loop_t *);
extern int uv_backend_timeout(const uv_loop_t *);
extern int uv_translate_sys_error(int);
extern const char * uv_strerror(int);
extern char * uv_strerror_r(int, char *, size_t);
extern const char * uv_err_name(int);
extern char * uv_err_name_r(int, char *, size_t);
struct uv_shutdown_s;
typedef struct uv_shutdown_s uv_shutdown_t;
typedef struct uv_stream_s uv_stream_t;
typedef void *uv_shutdown_cb;
extern int uv_shutdown(uv_shutdown_t *, uv_stream_t *, uv_shutdown_cb);
typedef int uv_handle_type;
extern size_t uv_handle_size(uv_handle_type);
typedef int uv_handle_type;
extern uv_handle_type uv_handle_get_type(const uv_handle_t *);
typedef int uv_handle_type;
extern const char * uv_handle_type_name(uv_handle_type);
extern void * uv_handle_get_data(const uv_handle_t *);
extern uv_loop_t * uv_handle_get_loop(const uv_handle_t *);
extern void uv_handle_set_data(uv_handle_t *, void *);
typedef int uv_req_type;
extern size_t uv_req_size(uv_req_type);
struct uv_req_s;
typedef struct uv_req_s uv_req_t;
extern void * uv_req_get_data(const uv_req_t *);
extern void uv_req_set_data(uv_req_t *, void *);
extern uv_loop_t * uv_req_get_loop(const uv_req_t *);
typedef int uv_req_type;
extern uv_req_type uv_req_get_type(const uv_req_t *);
typedef int uv_req_type;
extern const char * uv_req_type_name(uv_req_type);
extern int uv_is_active(const uv_handle_t *);
typedef void *uv_walk_cb;
extern void uv_walk(uv_loop_t *, uv_walk_cb, void *);
extern void uv_print_all_handles(uv_loop_t *, void *);
extern void uv_print_active_handles(uv_loop_t *, void *);
typedef void *uv_close_cb;
extern void uv_close(uv_handle_t *, uv_close_cb);
extern int uv_send_buffer_size(uv_handle_t *, int *);
extern int uv_recv_buffer_size(uv_handle_t *, int *);
extern int uv_fileno(const uv_handle_t *, uv_os_fd_t *);
extern int uv_pipe(uv_os_fd_t *, int, int);
extern int uv_socketpair(int, int, uv_os_sock_t *, int, int);
extern size_t uv_stream_get_write_queue_size(const uv_stream_t *);
typedef void *uv_connection_cb;
extern int uv_listen(uv_stream_t *, int, uv_connection_cb);
extern int uv_accept(uv_stream_t *, uv_stream_t *);
typedef void *uv_alloc_cb;
typedef void *uv_read_cb;
extern int uv_read_start(uv_stream_t *, uv_alloc_cb, uv_read_cb);
extern int uv_read_stop(uv_stream_t *);
struct uv_write_s;
typedef struct uv_write_s uv_write_t;
typedef void *uv_write_cb;
extern int uv_write(uv_write_t *, uv_stream_t *, const uv_buf_t *, unsigned int, uv_write_cb);
typedef void *uv_write_cb;
extern int uv_write2(uv_write_t *, uv_stream_t *, const uv_buf_t *, unsigned int, uv_stream_t *, uv_write_cb);
extern int uv_try_write(uv_stream_t *, const uv_buf_t *, unsigned int);
extern int uv_try_write2(uv_stream_t *, const uv_buf_t *, unsigned int, uv_stream_t *);
extern int uv_is_readable(const uv_stream_t *);
extern int uv_is_writable(const uv_stream_t *);
extern int uv_stream_set_blocking(uv_stream_t *, int);
extern int uv_is_closing(const uv_handle_t *);
struct uv_tcp_s;
typedef struct uv_tcp_s uv_tcp_t;
extern int uv_tcp_init(uv_loop_t *, uv_tcp_t *);
extern int uv_tcp_init_ex(uv_loop_t *, uv_tcp_t *, unsigned int);
typedef int uv_os_sock_t;
extern int uv_tcp_open(uv_tcp_t *, uv_os_sock_t);
extern int uv_tcp_nodelay(uv_tcp_t *, int);
extern int uv_tcp_keepalive(uv_tcp_t *, int, unsigned int);
extern int uv_tcp_simultaneous_accepts(uv_tcp_t *, int);
struct sockaddr;
extern int uv_tcp_bind(uv_tcp_t *, const struct sockaddr *, unsigned int);
extern int uv_tcp_getsockname(const uv_tcp_t *, struct sockaddr *, int *);
extern int uv_tcp_getpeername(const uv_tcp_t *, struct sockaddr *, int *);
typedef void *uv_close_cb;
extern int uv_tcp_close_reset(uv_tcp_t *, uv_close_cb);
struct uv_connect_s;
typedef struct uv_connect_s uv_connect_t;
typedef void *uv_connect_cb;
extern int uv_tcp_connect(uv_connect_t *, uv_tcp_t *, const struct sockaddr *, uv_connect_cb);
struct uv_udp_s;
typedef struct uv_udp_s uv_udp_t;
extern int uv_udp_init(uv_loop_t *, uv_udp_t *);
extern int uv_udp_init_ex(uv_loop_t *, uv_udp_t *, unsigned int);
extern int uv_udp_open(uv_udp_t *, uv_os_sock_t);
extern int uv_udp_bind(uv_udp_t *, const struct sockaddr *, unsigned int);
extern int uv_udp_connect(uv_udp_t *, const struct sockaddr *);
extern int uv_udp_getpeername(const uv_udp_t *, struct sockaddr *, int *);
extern int uv_udp_getsockname(const uv_udp_t *, struct sockaddr *, int *);
typedef int uv_membership;
extern int uv_udp_set_membership(uv_udp_t *, const char *, const char *, uv_membership);
typedef int uv_membership;
extern int uv_udp_set_source_membership(uv_udp_t *, const char *, const char *, const char *, uv_membership);
extern int uv_udp_set_multicast_loop(uv_udp_t *, int);
extern int uv_udp_set_multicast_ttl(uv_udp_t *, int);
extern int uv_udp_set_multicast_interface(uv_udp_t *, const char *);
extern int uv_udp_set_broadcast(uv_udp_t *, int);
extern int uv_udp_set_ttl(uv_udp_t *, int);
struct uv_udp_send_s;
typedef struct uv_udp_send_s uv_udp_send_t;
typedef void *uv_udp_send_cb;
extern int uv_udp_send(uv_udp_send_t *, uv_udp_t *, const uv_buf_t *, unsigned int, const struct sockaddr *, uv_udp_send_cb);
extern int uv_udp_try_send(uv_udp_t *, const uv_buf_t *, unsigned int, const struct sockaddr *);
typedef void *uv_alloc_cb;
typedef void *uv_udp_recv_cb;
extern int uv_udp_recv_start(uv_udp_t *, uv_alloc_cb, uv_udp_recv_cb);
extern int uv_udp_using_recvmmsg(const uv_udp_t *);
extern int uv_udp_recv_stop(uv_udp_t *);
extern size_t uv_udp_get_send_queue_size(const uv_udp_t *);
extern size_t uv_udp_get_send_queue_count(const uv_udp_t *);
struct uv_tty_s;
typedef struct uv_tty_s uv_tty_t;
extern int uv_tty_init(uv_loop_t *, uv_tty_t *, uv_os_fd_t, int);
typedef int uv_tty_mode_t;
extern int uv_tty_set_mode(uv_tty_t *, uv_tty_mode_t);
extern int uv_tty_reset_mode(void);
extern int uv_tty_get_winsize(uv_tty_t *, int *, int *);
typedef int uv_tty_vtermstate_t;
extern void uv_tty_set_vterm_state(uv_tty_vtermstate_t);
typedef int uv_tty_vtermstate_t;
extern int uv_tty_get_vterm_state(uv_tty_vtermstate_t *);
typedef int uv_handle_type;
extern uv_handle_type uv_guess_handle(uv_os_fd_t);
struct uv_pipe_s;
typedef struct uv_pipe_s uv_pipe_t;
extern int uv_pipe_init(uv_loop_t *, uv_pipe_t *, int);
extern int uv_pipe_open(uv_pipe_t *, uv_os_fd_t);
extern int uv_pipe_bind(uv_pipe_t *, const char *);
typedef void *uv_connect_cb;
extern void uv_pipe_connect(uv_connect_t *, uv_pipe_t *, const char *, uv_connect_cb);
extern int uv_pipe_getsockname(const uv_pipe_t *, char *, size_t *);
extern int uv_pipe_getpeername(const uv_pipe_t *, char *, size_t *);
extern void uv_pipe_pending_instances(uv_pipe_t *, int);
extern int uv_pipe_pending_count(uv_pipe_t *);
typedef int uv_handle_type;
extern uv_handle_type uv_pipe_pending_type(uv_pipe_t *);
extern int uv_pipe_chmod(uv_pipe_t *, int);
struct uv_poll_s;
typedef struct uv_poll_s uv_poll_t;
extern int uv_poll_init(uv_loop_t *, uv_poll_t *, uv_os_sock_t);
typedef void *uv_poll_cb;
extern int uv_poll_start(uv_poll_t *, int, uv_poll_cb);
extern int uv_poll_stop(uv_poll_t *);
struct uv_prepare_s;
typedef struct uv_prepare_s uv_prepare_t;
extern int uv_prepare_init(uv_loop_t *, uv_prepare_t *);
typedef void *uv_prepare_cb;
extern int uv_prepare_start(uv_prepare_t *, uv_prepare_cb);
extern int uv_prepare_stop(uv_prepare_t *);
struct uv_check_s;
typedef struct uv_check_s uv_check_t;
extern int uv_check_init(uv_loop_t *, uv_check_t *);
typedef void *uv_check_cb;
extern int uv_check_start(uv_check_t *, uv_check_cb);
extern int uv_check_stop(uv_check_t *);
struct uv_idle_s;
typedef struct uv_idle_s uv_idle_t;
extern int uv_idle_init(uv_loop_t *, uv_idle_t *);
typedef void *uv_idle_cb;
extern int uv_idle_start(uv_idle_t *, uv_idle_cb);
extern int uv_idle_stop(uv_idle_t *);
struct uv_async_s;
typedef struct uv_async_s uv_async_t;
typedef void *uv_async_cb;
extern int uv_async_init(uv_loop_t *, uv_async_t *, uv_async_cb);
extern int uv_async_send(uv_async_t *);
struct uv_timer_s;
typedef struct uv_timer_s uv_timer_t;
extern int uv_timer_init(uv_loop_t *, uv_timer_t *);
typedef void *uv_timer_cb;
extern int uv_timer_start(uv_timer_t *, uv_timer_cb, uint64_t, uint64_t);
extern int uv_timer_stop(uv_timer_t *);
extern int uv_timer_again(uv_timer_t *);
extern void uv_timer_set_repeat(uv_timer_t *, uint64_t);
extern uint64_t uv_timer_get_repeat(const uv_timer_t *);
extern uint64_t uv_timer_get_due_in(const uv_timer_t *);
struct uv_getaddrinfo_s;
typedef struct uv_getaddrinfo_s uv_getaddrinfo_t;
typedef void *uv_getaddrinfo_cb;
struct addrinfo;
extern int uv_getaddrinfo(uv_loop_t *, uv_getaddrinfo_t *, uv_getaddrinfo_cb, const char *, const char *, const struct addrinfo *);
extern void uv_freeaddrinfo(struct addrinfo *);
struct uv_getnameinfo_s;
typedef struct uv_getnameinfo_s uv_getnameinfo_t;
typedef void *uv_getnameinfo_cb;
extern int uv_getnameinfo(uv_loop_t *, uv_getnameinfo_t *, uv_getnameinfo_cb, const struct sockaddr *, int);
struct uv_process_s;
typedef struct uv_process_s uv_process_t;
struct uv_process_options_s;
typedef struct uv_process_options_s uv_process_options_t;
extern int uv_spawn(uv_loop_t *, uv_process_t *, const uv_process_options_t *);
extern int uv_process_kill(uv_process_t *, int);
extern int uv_kill(int, int);
typedef int uv_pid_t;
extern uv_pid_t uv_process_get_pid(const uv_process_t *);
struct uv_work_s;
typedef struct uv_work_s uv_work_t;
typedef void *uv_work_cb;
typedef void *uv_after_work_cb;
extern int uv_queue_work(uv_loop_t *, uv_work_t *, uv_work_cb, uv_after_work_cb);
extern int uv_cancel(uv_req_t *);
extern char ** uv_setup_args(int, char **);
extern int uv_get_process_title(char *, size_t);
extern int uv_set_process_title(const char *);
extern int uv_resident_set_memory(size_t *);
extern int uv_uptime(double *);
struct uv_rusage_t;
typedef struct uv_rusage_t uv_rusage_t;
extern int uv_getrusage(uv_rusage_t *);
extern int uv_os_homedir(char *, size_t *);
extern int uv_os_tmpdir(char *, size_t *);
struct uv_passwd_s;
typedef struct uv_passwd_s uv_passwd_t;
extern int uv_os_get_passwd(uv_passwd_t *);
extern void uv_os_free_passwd(uv_passwd_t *);
typedef unsigned int uv_uid_t;
extern int uv_os_get_passwd2(uv_passwd_t *, uv_uid_t);
struct uv_group_s;
typedef struct uv_group_s uv_group_t;
extern int uv_os_get_group(uv_group_t *, uv_uid_t);
extern void uv_os_free_group(uv_group_t *);
extern uv_pid_t uv_os_getpid(void);
extern uv_pid_t uv_os_getppid(void);
extern int uv_os_getpriority(uv_pid_t, int *);
extern int uv_os_setpriority(uv_pid_t, int);
extern unsigned int uv_available_parallelism(void);
extern int uv_cpu_info(uv_cpu_info_t **, int *);
struct uv_cpu_info_s;
typedef struct uv_cpu_info_s uv_cpu_info_t;
extern void uv_free_cpu_info(uv_cpu_info_t *, int);
extern int uv_cpumask_size(void);
extern int uv_interface_addresses(uv_interface_address_t **, int *);
struct uv_interface_address_s;
typedef struct uv_interface_address_s uv_interface_address_t;
extern void uv_free_interface_addresses(uv_interface_address_t *, int);
extern int uv_os_environ(uv_env_item_t **, int *);
struct uv_env_item_s;
typedef struct uv_env_item_s uv_env_item_t;
extern void uv_os_free_environ(uv_env_item_t *, int);
extern int uv_os_getenv(const char *, char *, size_t *);
extern int uv_os_setenv(const char *, const char *);
extern int uv_os_unsetenv(const char *);
extern int uv_os_gethostname(char *, size_t *);
struct uv_utsname_s;
typedef struct uv_utsname_s uv_utsname_t;
extern int uv_os_uname(uv_utsname_t *);
extern uint64_t uv_metrics_idle_time(uv_loop_t *);
typedef int uv_fs_type;
struct uv_fs_s;
typedef struct uv_fs_s uv_fs_t;
extern uv_fs_type uv_fs_get_type(const uv_fs_t *);
extern ssize_t uv_fs_get_result(const uv_fs_t *);
extern int uv_fs_get_system_error(const uv_fs_t *);
extern void * uv_fs_get_ptr(const uv_fs_t *);
extern const char * uv_fs_get_path(const uv_fs_t *);
struct uv_stat_t;
typedef struct uv_stat_t uv_stat_t;
extern uv_stat_t * uv_fs_get_statbuf(uv_fs_t *);
extern void uv_fs_req_cleanup(uv_fs_t *);
typedef void *uv_fs_cb;
extern int uv_fs_close(uv_loop_t *, uv_fs_t *, uv_os_fd_t, uv_fs_cb);
typedef void *uv_fs_cb;
extern int uv_fs_open(uv_loop_t *, uv_fs_t *, const char *, int, int, uv_fs_cb);
typedef void *uv_fs_cb;
extern int uv_fs_read(uv_loop_t *, uv_fs_t *, uv_os_fd_t, const uv_buf_t *, unsigned int, int64_t, uv_fs_cb);
typedef void *uv_fs_cb;
extern int uv_fs_unlink(uv_loop_t *, uv_fs_t *, const char *, uv_fs_cb);
typedef void *uv_fs_cb;
extern int uv_fs_write(uv_loop_t *, uv_fs_t *, uv_os_fd_t, const uv_buf_t *, unsigned int, int64_t, uv_fs_cb);
typedef void *uv_fs_cb;
extern int uv_fs_copyfile(uv_loop_t *, uv_fs_t *, const char *, const char *, int, uv_fs_cb);
typedef void *uv_fs_cb;
extern int uv_fs_mkdir(uv_loop_t *, uv_fs_t *, const char *, int, uv_fs_cb);
typedef void *uv_fs_cb;
extern int uv_fs_mkdtemp(uv_loop_t *, uv_fs_t *, const char *, uv_fs_cb);
typedef void *uv_fs_cb;
extern int uv_fs_mkstemp(uv_loop_t *, uv_fs_t *, const char *, uv_fs_cb);
typedef void *uv_fs_cb;
extern int uv_fs_rmdir(uv_loop_t *, uv_fs_t *, const char *, uv_fs_cb);
typedef void *uv_fs_cb;
extern int uv_fs_scandir(uv_loop_t *, uv_fs_t *, const char *, int, uv_fs_cb);
struct uv_dirent_s;
typedef struct uv_dirent_s uv_dirent_t;
extern int uv_fs_scandir_next(uv_fs_t *, uv_dirent_t *);
typedef void *uv_fs_cb;
extern int uv_fs_opendir(uv_loop_t *, uv_fs_t *, const char *, uv_fs_cb);
struct uv_dir_s;
typedef struct uv_dir_s uv_dir_t;
typedef void *uv_fs_cb;
extern int uv_fs_readdir(uv_loop_t *, uv_fs_t *, uv_dir_t *, uv_fs_cb);
typedef void *uv_fs_cb;
extern int uv_fs_closedir(uv_loop_t *, uv_fs_t *, uv_dir_t *, uv_fs_cb);
typedef void *uv_fs_cb;
extern int uv_fs_stat(uv_loop_t *, uv_fs_t *, const char *, uv_fs_cb);
typedef void *uv_fs_cb;
extern int uv_fs_fstat(uv_loop_t *, uv_fs_t *, uv_os_fd_t, uv_fs_cb);
typedef void *uv_fs_cb;
extern int uv_fs_rename(uv_loop_t *, uv_fs_t *, const char *, const char *, uv_fs_cb);
typedef void *uv_fs_cb;
extern int uv_fs_fsync(uv_loop_t *, uv_fs_t *, uv_os_fd_t, uv_fs_cb);
typedef void *uv_fs_cb;
extern int uv_fs_fdatasync(uv_loop_t *, uv_fs_t *, uv_os_fd_t, uv_fs_cb);
typedef void *uv_fs_cb;
extern int uv_fs_ftruncate(uv_loop_t *, uv_fs_t *, uv_os_fd_t, int64_t, uv_fs_cb);
typedef void *uv_fs_cb;
extern int uv_fs_sendfile(uv_loop_t *, uv_fs_t *, uv_os_fd_t, uv_os_fd_t, int64_t, size_t, uv_fs_cb);
typedef void *uv_fs_cb;
extern int uv_fs_access(uv_loop_t *, uv_fs_t *, const char *, int, uv_fs_cb);
typedef void *uv_fs_cb;
extern int uv_fs_chmod(uv_loop_t *, uv_fs_t *, const char *, int, uv_fs_cb);
typedef void *uv_fs_cb;
extern int uv_fs_utime(uv_loop_t *, uv_fs_t *, const char *, double, double, uv_fs_cb);
typedef void *uv_fs_cb;
extern int uv_fs_utime_ex(uv_loop_t *, uv_fs_t *, const char *, double, double, double, uv_fs_cb);
typedef void *uv_fs_cb;
extern int uv_fs_futime(uv_loop_t *, uv_fs_t *, uv_os_fd_t, double, double, uv_fs_cb);
typedef void *uv_fs_cb;
extern int uv_fs_futime_ex(uv_loop_t *, uv_fs_t *, uv_os_fd_t, double, double, double, uv_fs_cb);
typedef void *uv_fs_cb;
extern int uv_fs_lutime(uv_loop_t *, uv_fs_t *, const char *, double, double, uv_fs_cb);
typedef void *uv_fs_cb;
extern int uv_fs_lstat(uv_loop_t *, uv_fs_t *, const char *, uv_fs_cb);
typedef void *uv_fs_cb;
extern int uv_fs_link(uv_loop_t *, uv_fs_t *, const char *, const char *, uv_fs_cb);
typedef void *uv_fs_cb;
extern int uv_fs_symlink(uv_loop_t *, uv_fs_t *, const char *, const char *, int, uv_fs_cb);
typedef void *uv_fs_cb;
extern int uv_fs_readlink(uv_loop_t *, uv_fs_t *, const char *, uv_fs_cb);
typedef void *uv_fs_cb;
extern int uv_fs_realpath(uv_loop_t *, uv_fs_t *, const char *, uv_fs_cb);
typedef void *uv_fs_cb;
extern int uv_fs_fchmod(uv_loop_t *, uv_fs_t *, uv_os_fd_t, int, uv_fs_cb);
typedef unsigned int uv_gid_t;
typedef void *uv_fs_cb;
extern int uv_fs_chown(uv_loop_t *, uv_fs_t *, const char *, uv_uid_t, uv_gid_t, uv_fs_cb);
typedef void *uv_fs_cb;
extern int uv_fs_fchown(uv_loop_t *, uv_fs_t *, uv_os_fd_t, uv_uid_t, uv_gid_t, uv_fs_cb);
typedef void *uv_fs_cb;
extern int uv_fs_lchown(uv_loop_t *, uv_fs_t *, const char *, uv_uid_t, uv_gid_t, uv_fs_cb);
typedef void *uv_fs_cb;
extern int uv_fs_statfs(uv_loop_t *, uv_fs_t *, const char *, uv_fs_cb);
struct uv_fs_poll_s;
typedef struct uv_fs_poll_s uv_fs_poll_t;
extern int uv_fs_poll_init(uv_loop_t *, uv_fs_poll_t *);
typedef void *uv_fs_poll_cb;
extern int uv_fs_poll_start(uv_fs_poll_t *, uv_fs_poll_cb, const char *, unsigned int);
extern int uv_fs_poll_stop(uv_fs_poll_t *);
extern int uv_fs_poll_getpath(uv_fs_poll_t *, char *, size_t *);
struct uv_signal_s;
typedef struct uv_signal_s uv_signal_t;
extern int uv_signal_init(uv_loop_t *, uv_signal_t *);
typedef void *uv_signal_cb;
extern int uv_signal_start(uv_signal_t *, uv_signal_cb, int);
typedef void *uv_signal_cb;
extern int uv_signal_start_oneshot(uv_signal_t *, uv_signal_cb, int);
extern int uv_signal_stop(uv_signal_t *);
extern void uv_loadavg(double *);
struct uv_fs_event_s;
typedef struct uv_fs_event_s uv_fs_event_t;
extern int uv_fs_event_init(uv_loop_t *, uv_fs_event_t *);
typedef void *uv_fs_event_cb;
extern int uv_fs_event_start(uv_fs_event_t *, uv_fs_event_cb, const char *, unsigned int);
extern int uv_fs_event_stop(uv_fs_event_t *);
extern int uv_fs_event_getpath(uv_fs_event_t *, char *, size_t *);
struct sockaddr_in;
extern int uv_ip4_addr(const char *, int, struct sockaddr_in *);
struct sockaddr_in6;
extern int uv_ip6_addr(const char *, int, struct sockaddr_in6 *);
extern int uv_ip4_name(const struct sockaddr_in *, char *, size_t);
extern int uv_ip6_name(const struct sockaddr_in6 *, char *, size_t);
extern int uv_ip_name(const struct sockaddr *, char *, size_t);
extern int uv_inet_ntop(int, const void *, char *, size_t);
extern int uv_inet_pton(int, const char *, void *);
struct uv_random_s;
typedef struct uv_random_s uv_random_t;
typedef void *uv_random_cb;
extern int uv_random(uv_loop_t *, uv_random_t *, void *, size_t, unsigned int, uv_random_cb);
extern int uv_if_indextoname(unsigned int, char *, size_t *);
extern int uv_if_indextoiid(unsigned int, char *, size_t *);
extern int uv_exepath(char *, size_t *);
extern int uv_cwd(char *, size_t *);
extern int uv_chdir(const char *);
extern uint64_t uv_get_free_memory(void);
extern uint64_t uv_get_total_memory(void);
extern uint64_t uv_get_constrained_memory(void);
extern uint64_t uv_hrtime(void);
extern void uv_sleep(unsigned int);
extern void uv_disable_stdio_inheritance(void);
struct uv_lib_t;
typedef struct uv_lib_t uv_lib_t;
extern int uv_dlopen(const char *, uv_lib_t *);
extern void uv_dlclose(uv_lib_t *);
extern int uv_dlsym(uv_lib_t *, const char *, void **);
extern const char * uv_dlerror(const uv_lib_t *);
struct pthread_mutex_t;
typedef struct uv_mutex_t uv_mutex_t;
extern int uv_mutex_init(uv_mutex_t *);
typedef struct uv_mutex_t uv_mutex_t;
extern int uv_mutex_init_recursive(uv_mutex_t *);
typedef struct uv_mutex_t uv_mutex_t;
extern void uv_mutex_destroy(uv_mutex_t *);
typedef struct uv_mutex_t uv_mutex_t;
extern void uv_mutex_lock(uv_mutex_t *);
typedef struct uv_mutex_t uv_mutex_t;
extern int uv_mutex_trylock(uv_mutex_t *);
typedef struct uv_mutex_t uv_mutex_t;
extern void uv_mutex_unlock(uv_mutex_t *);
struct pthread_rwlock_t;
typedef struct uv_rwlock_t uv_rwlock_t;
extern int uv_rwlock_init(uv_rwlock_t *);
typedef struct uv_rwlock_t uv_rwlock_t;
extern void uv_rwlock_destroy(uv_rwlock_t *);
typedef struct uv_rwlock_t uv_rwlock_t;
extern void uv_rwlock_rdlock(uv_rwlock_t *);
typedef struct uv_rwlock_t uv_rwlock_t;
extern int uv_rwlock_tryrdlock(uv_rwlock_t *);
typedef struct uv_rwlock_t uv_rwlock_t;
extern void uv_rwlock_rdunlock(uv_rwlock_t *);
typedef struct uv_rwlock_t uv_rwlock_t;
extern void uv_rwlock_wrlock(uv_rwlock_t *);
typedef struct uv_rwlock_t uv_rwlock_t;
extern int uv_rwlock_trywrlock(uv_rwlock_t *);
typedef struct uv_rwlock_t uv_rwlock_t;
extern void uv_rwlock_wrunlock(uv_rwlock_t *);
struct sem_t;
typedef struct uv_sem_t uv_sem_t;
extern int uv_sem_init(uv_sem_t *, unsigned int);
typedef struct uv_sem_t uv_sem_t;
extern void uv_sem_destroy(uv_sem_t *);
typedef struct uv_sem_t uv_sem_t;
extern void uv_sem_post(uv_sem_t *);
typedef struct uv_sem_t uv_sem_t;
extern void uv_sem_wait(uv_sem_t *);
typedef struct uv_sem_t uv_sem_t;
extern int uv_sem_trywait(uv_sem_t *);
struct pthread_cond_t;
typedef struct uv_cond_t uv_cond_t;
extern int uv_cond_init(uv_cond_t *);
typedef struct uv_cond_t uv_cond_t;
extern void uv_cond_destroy(uv_cond_t *);
typedef struct uv_cond_t uv_cond_t;
extern void uv_cond_signal(uv_cond_t *);
typedef struct uv_cond_t uv_cond_t;
extern void uv_cond_broadcast(uv_cond_t *);
struct pthread_barrier_t;
typedef struct uv_barrier_t uv_barrier_t;
extern int uv_barrier_init(uv_barrier_t *, unsigned int);
typedef struct uv_barrier_t uv_barrier_t;
extern void uv_barrier_destroy(uv_barrier_t *);
typedef struct uv_barrier_t uv_barrier_t;
extern int uv_barrier_wait(uv_barrier_t *);
typedef struct uv_cond_t uv_cond_t;
typedef struct uv_mutex_t uv_mutex_t;
extern void uv_cond_wait(uv_cond_t *, uv_mutex_t *);
typedef struct uv_cond_t uv_cond_t;
typedef struct uv_mutex_t uv_mutex_t;
extern int uv_cond_timedwait(uv_cond_t *, uv_mutex_t *, uint64_t);
typedef int uv_once_t;
extern void uv_once(uv_once_t *, void (*)(void));
typedef unsigned int uv_key_t;
extern int uv_key_create(uv_key_t *);
extern void uv_key_delete(uv_key_t *);
extern void * uv_key_get(uv_key_t *);
extern void uv_key_set(uv_key_t *, void *);
struct uv_timeval64_t;
typedef struct uv_timeval64_t uv_timeval64_t;
extern int uv_gettimeofday(uv_timeval64_t *);
typedef unsigned long uv_thread_t;
typedef void *uv_thread_cb;
extern int uv_thread_create(uv_thread_t *, uv_thread_cb, void *);
struct uv_thread_options_s;
typedef struct uv_thread_options_s uv_thread_options_t;
typedef void *uv_thread_cb;
extern int uv_thread_create_ex(uv_thread_t *, const uv_thread_options_t *, uv_thread_cb, void *);
extern int uv_thread_setaffinity(uv_thread_t *, char *, char *, size_t);
extern int uv_thread_getaffinity(uv_thread_t *, char *, size_t);
extern int uv_thread_detach(uv_thread_t *);
extern int uv_thread_join(uv_thread_t *);
extern uv_thread_t uv_thread_self(void);
extern int uv_thread_equal(const uv_thread_t *, const uv_thread_t *);
extern void * uv_loop_get_data(const uv_loop_t *);
extern void uv_loop_set_data(uv_loop_t *, void *);
extern uint64_t jl_hrtime(void);
extern void jl_set_peek_cond(uintptr_t);
extern double jl_get_profile_peek_duration(void);
extern void jl_set_profile_peek_duration(double);
extern int jl_gc_classify_pools(size_t, int *);
...
extern int64_t jl_gc_sync_total_bytes(int64_t);
extern void jl_gc_debug_critical_error(void);
extern jl_code_info_t * jl_type_infer(jl_method_instance_t *, size_t, int);
extern jl_code_instance_t * jl_compile_method_internal(jl_method_instance_t *, size_t);
...
extern void jl_add_method_root(jl_method_t *, jl_module_t *, jl_value_t *);
extern jl_value_t * jl_apply_2va(jl_value_t *, jl_value_t **, uint32_t);
extern jl_value_t * jl_get_exceptionf(jl_datatype_t *, const char *, ...);
...
extern jl_value_t * jl_f_opaque_closure_call(jl_value_t *, jl_value_t **, uint32_t);
extern jl_fptr_args_t jl_get_builtin_fptr(jl_value_t *);
extern int jl_has_intersect_type_not_kind(jl_value_t *);
...
extern int jl_struct_try_layout(jl_datatype_t *);
extern int jl_type_mappable_to_c(jl_value_t *);
extern int jl_types_egal(jl_value_t *, jl_value_t *);
...
extern jl_value_t * jl_unwrap_unionall(jl_value_t *);
extern jl_value_t * jl_rewrap_unionall(jl_value_t *, jl_value_t *);
extern jl_value_t * jl_nth_union_component(jl_value_t *, int);
extern jl_datatype_t * jl_wrap_Type(jl_value_t *);
extern int jl_is_submodule(jl_module_t *, jl_module_t *);
extern int jl_datatype_isinlinealloc(jl_datatype_t *, int);
extern int jl_is_toplevel_only_expr(jl_value_t *);
extern jl_value_t * jl_matching_methods(jl_tupletype_t *, jl_value_t *, int, int, size_t, size_t *, size_t *, int *);
...
extern jl_methtable_t * jl_method_get_table(jl_method_t *);
extern int jl_pointer_egal(jl_value_t *);
extern jl_value_t * jl_nth_slot_type(jl_value_t *, size_t);
extern void jl_binding_deprecation_warning(jl_module_t *, jl_binding_t *);
extern int jl_is_valid_oc_argtype(jl_tupletype_t *, jl_method_t *);
extern void jl_init_options(void);
extern void jl_pgcstack_getkey(jl_get_pgcstack_func **, jl_pgcstack_key_t *);
extern jl_value_t * jl_dump_method_asm(jl_method_instance_t *, size_t, char, char, const char *, const char *, char);
extern jl_value_t * jl_dump_fptr_asm(uint64_t, char, const char *, const char *, char);
extern jl_value_t * jl_dump_function_ir(void *, char, char, const char *);
extern jl_value_t * jl_dump_function_asm(void *, char, const char *, const char *, char);
struct LLVMOpaqueContext;
typedef struct LLVMOpaqueContext * LLVMContextRef;
extern LLVMContextRef jl_get_ee_context(void);
extern void jl_get_function_id(void *, jl_code_instance_t *, int32_t *, int32_t *);
...
extern jl_method_instance_t * jl_get_specialization1(jl_tupletype_t *, size_t, size_t *, size_t *, int);
extern jl_value_t * jl_rettype_inferred(jl_method_instance_t *, size_t, size_t);
extern jl_code_instance_t * jl_method_compiled(jl_method_instance_t *, size_t);
...
extern int jl_has_meta(jl_array_t *, jl_sym_t *);
extern jl_value_t * jl_get_backtrace(void);
extern void jl_raise_debugger(void);
extern void jl_gdblookup(void *);
extern size_t jl_capture_interp_frame(jl_bt_element_t *, void *, size_t);
extern void * jl_get_library_(const char *, int);
extern void * jl_load_and_lookup(const char *, const char *, _Atomic(void *) *);
extern void * jl_lazy_load_and_lookup(jl_value_t *, const char *);
...
extern const char * jl_dlfind_win32(const char *);
extern int jl_fs_rename(const char *, const char *);
extern const char * jl_intrinsic_name(int);
extern unsigned int jl_intrinsic_nargs(int);
...
extern jl_value_t * jl_atomic_fence(jl_value_t *);
extern jl_value_t * jl_atomic_pointerref(jl_value_t *, jl_value_t *);
extern jl_value_t * jl_atomic_pointerset(jl_value_t *, jl_value_t *, jl_value_t *);
extern jl_value_t * jl_atomic_pointerswap(jl_value_t *, jl_value_t *, jl_value_t *);
extern jl_value_t * jl_atomic_pointermodify(jl_value_t *, jl_value_t *, jl_value_t *, jl_value_t *);
extern jl_value_t * jl_atomic_pointerreplace(jl_value_t *, jl_value_t *, jl_value_t *, jl_value_t *, jl_value_t *);
...
extern jl_value_t * jl_have_fma(jl_value_t *);
extern int jl_stored_inline(jl_value_t *);
...
extern void jl_set_next_task(jl_task_t *);
#undef jl_svec_len
extern size_t jl_svec_len(jl_svec_t *);
extern int8_t jl_svec_isassigned(jl_svec_t *, ssize_t);
extern jl_value_t * jl_svec_ref(jl_svec_t *, ssize_t);
extern unsigned int jl_special_vector_alignment(size_t, jl_value_t *);
extern jl_array_t * jl_array_cconvert_cstring(jl_array_t *);
extern int jl_isabspath(const char *);
extern enum jl_memory_order jl_get_atomic_order(jl_sym_t *, char, char);
extern enum jl_memory_order jl_get_atomic_order_checked(jl_sym_t *, char, char);
...
extern int jl_sizeof_uv_fs_t(void);
extern char * jl_uv_fs_t_ptr(uv_fs_t *);
extern char * jl_uv_fs_t_path(uv_fs_t *);
extern int jl_sizeof_stat(void);
extern int32_t jl_lstat(const char *, char *);
extern int32_t jl_fstat(uv_os_fd_t, char *);
...
extern unsigned long jl_getuid(void);
extern unsigned long jl_geteuid(void);
...
extern jl_value_t * jl_f__call_in_world(jl_value_t *, jl_value_t **, uint32_t);
extern jl_value_t * jl_f__call_in_world_total(jl_value_t *, jl_value_t **, uint32_t);
extern jl_value_t * jl_f__call_latest(jl_value_t *, jl_value_t **, uint32_t);
extern jl_value_t * jl_f_replacefield(jl_value_t *, jl_value_t **, uint32_t);
...
extern jl_value_t * jl_f_modifyfield(jl_value_t *, jl_value_t **, uint32_t);
...
extern jl_value_t * jl_f_swapfield(jl_value_t *, jl_value_t **, uint32_t);
...
extern jl_value_t * jl_f__typebody(jl_value_t *, jl_value_t **, uint32_t);
...
extern jl_value_t * jl_f_donotdelete(jl_value_t *, jl_value_t **, uint32_t);
extern jl_value_t * jl_f_invoke_kwsorter(jl_value_t *, jl_value_t **, uint32_t);
extern jl_value_t * jl_f__structtype(jl_value_t *, jl_value_t **, uint32_t);
extern jl_value_t * jl_f__abstracttype(jl_value_t *, jl_value_t **, uint32_t);
extern jl_value_t * jl_f__primitivetype(jl_value_t *, jl_value_t **, uint32_t);
extern jl_value_t * jl_f__setsuper(jl_value_t *, jl_value_t **, uint32_t);
extern jl_value_t * jl_f__equiv_typedef(jl_value_t *, jl_value_t **, uint32_t);
extern jl_value_t * jl_f_get_binding_type(jl_value_t *, jl_value_t **, uint32_t);
extern jl_value_t * jl_f_set_binding_type(jl_value_t *, jl_value_t **, uint32_t);
extern int jl_test_cpu_feature(jl_cpu_feature_t);
extern jl_value_t * jl_get_cpu_name(void);
extern void jl_dump_host_cpu(void);
extern int32_t jl_set_zero_subnormals(int8_t);
extern int32_t jl_get_zero_subnormals(void);
extern int32_t jl_set_default_nans(int8_t);
extern int32_t jl_get_default_nans(void);
extern int jl_running_on_valgrind(void);
extern size_t ios_write_direct(ios_t *, ios_t *);
extern void jl_init__threading(void);
extern void jl_init_with_image__threading(const char *, const char *);
...
extern int ijl_egal(jl_value_t *, jl_value_t *);
...
extern uint64_t jl_cumulative_compile_time_ns_before(void);
extern uint64_t jl_cumulative_compile_time_ns_after(void);
extern void jl_get_fenv_consts(int *);
extern int jl_get_fenv_rounding(void);
extern int jl_set_fenv_rounding(int);
extern int jl_repl_entrypoint(int, char **);
...
extern jl_module_t * jl_new_module_(jl_sym_t *, uint8_t);
extern jl_value_t * jl_f_new_module(jl_sym_t *, uint8_t, uint8_t);
...
extern void jl_clear_implicit_imports(jl_module_t *);
extern void jl_enable_gc_logging(int);
...
extern int jl_is_foreign_type(jl_datatype_t *);
...
extern void jl_active_task_stack(jl_task_t *, char **, char **, char **, char **);
extern int jl_gc_get_finalizers_inhibited(jl_ptls_t);
extern void jl_gc_add_finalizer_th(jl_ptls_t, jl_value_t *, jl_function_t *);
extern void jl_finalize_th(jl_task_t *, jl_value_t *);
...
extern int64_t jl_gc_live_bytes(void);
...
extern int jl_profile_is_buffer_full(void);
...
extern jl_code_instance_t * jl_new_codeinst(jl_method_instance_t *, jl_value_t *, jl_value_t *, jl_value_t *, int32_t, size_t, size_t, uint8_t, uint8_t, jl_value_t *, uint8_t);
extern void jl_mi_cache_insert(jl_method_instance_t *, jl_code_instance_t *);
extern jl_value_t * jl_call_in_typeinf_world(jl_value_t **, int);
extern void jl_set_typeinf_func(jl_value_t *);
extern jl_value_t * jl_debug_method_invalidation(int);
extern void jl_method_table_disable(jl_methtable_t *, jl_method_t *);
extern jl_value_t * jl_normalize_to_compilable_sig(jl_methtable_t *, jl_tupletype_t *, jl_svec_t *, jl_method_t *);
extern jl_value_t * jl_gf_invoke_lookup(jl_value_t *, jl_value_t *, size_t);
extern jl_value_t * jl_gf_invoke_lookup_worlds(jl_value_t *, jl_value_t *, size_t, size_t *, size_t *);
extern void jl_typeinf_begin(void);
extern void jl_typeinf_end(void);
extern jl_task_t * jl_get_next_task(void);
extern void jl_switch(void);
extern uint64_t jl_tasklocal_genrandom(jl_task_t *);
extern int jl_is_task_started(jl_task_t *);
extern int16_t jl_get_task_tid(jl_task_t *);
extern int jl_enqueue_task(jl_task_t *);
...
extern int pcre2_set_character_tables_8(pcre2_compile_context_8 *, const uint8_t *);
...
extern int pcre2_set_substitute_callout_8(pcre2_match_context_8 *, int (*)(pcre2_substitute_callout_block_8 *, void *), void *);
...
extern size_t pcre2_get_match_data_size_8(pcre2_match_data_8 *);
...
extern void pcre2_maketables_free_8(pcre2_general_context_8 *, const uint8_t *);
...
extern int pcre2_set_character_tables_16(pcre2_compile_context_16 *, const uint8_t *);
...
extern int pcre2_set_substitute_callout_16(pcre2_match_context_16 *, int (*)(pcre2_substitute_callout_block_16 *, void *), void *);
...
extern size_t pcre2_get_match_data_size_16(pcre2_match_data_16 *);
...
extern void pcre2_maketables_free_16(pcre2_general_context_16 *, const uint8_t *);
...
extern int pcre2_set_character_tables_32(pcre2_compile_context_32 *, const uint8_t *);
...
extern int pcre2_set_substitute_callout_32(pcre2_match_context_32 *, int (*)(pcre2_substitute_callout_block_32 *, void *), void *);
...
extern size_t pcre2_get_match_data_size_32(pcre2_match_data_32 *);
...
extern void pcre2_maketables_free_32(pcre2_general_context_32 *, const uint8_t *);
...
extern int utf8proc_islower(utf8proc_int32_t);
extern int utf8proc_isupper(utf8proc_int32_t);
...
extern mp_limb_t __gmpn_gcd_11(mp_limb_t, mp_limb_t);
...
typedef int mpfr_rnd_t;
extern int mpfr_dot(mpfr_ptr, const mpfr_ptr *, const mpfr_ptr *, unsigned long, mpfr_rnd_t);
...
extern void emscripten_set_window_title(const char *);
extern void emscripten_get_screen_size(int *, int *);
...
typedef void *em_idb_onload_func;
typedef void *em_arg_callback_func;
extern void emscripten_idb_async_load(const char *, const char *, void *, em_idb_onload_func, em_arg_callback_func);
typedef void *em_arg_callback_func;
typedef void *em_arg_callback_func;
...
extern void emscripten_log(int, const char *, ...);
...
typedef void *em_dlopen_callback;
typedef void *em_arg_callback_func;
extern void emscripten_dlopen(const char *, int, void *, em_dlopen_callback, em_arg_callback_func);
extern void emscripten_throw_number(double);
extern void emscripten_throw_string(const char *);
...
if (strcmp(target, "jl_value_ptr") == 0) {
	...
	*(void**)jl_data_ptr(v) = (void*)result;
	...
	return jl_box_long(result);
} else if (strcmp(target, "ios_filesize") == 0) {
	int64_t result = ios_filesize(
			(ios_t *) jl_unbox_voidpointer(eval_value(args[5], s))
		);
	return jl_box_long(result);
	...
	*(void**)jl_data_ptr(v) = (void*)result;
	...
	return jl_box_uint32(result);
} else if (strcmp(target, "ios_fillbuf") == 0) {
	ssize_t result = ios_fillbuf(
			(ios_t *) jl_unbox_voidpointer(eval_value(args[5], s))
		);
	return jl_box_long(result);
	...
	*(void**)jl_data_ptr(v) = (void*)result;
	...
	libsupport_init();
	return jl_nothing;
} else if (strcmp(target, "small_arraylist_grow") == 0) {
	small_arraylist_grow(
			(small_arraylist_t *) jl_unbox_voidpointer(eval_value(args[5], s)),
			(uint32_t) jl_unbox_uint32(eval_value(args[6], s))
		);
	return jl_nothing;
	...
	void * result = jl_get_ptls_states();
	jl_ptls_t ptls = jl_get_ptls_states();
	jl_datatype_t *rt = eval_value(args[1], s);
	rt = instantiate_foreigncall_rt(rt, s);
	jl_value_t *v = jl_gc_alloc(ptls, sizeof(void*), rt);
	*(void**)jl_data_ptr(v) = (void*)result;
	...
	jl_gc_enable_finalizers(
			(struct _jl_task_t *) jl_unbox_voidpointer(eval_value(args[5], s)),
			(int) jl_unbox_int32(eval_value(args[6], s))
		);
	return jl_nothing;
} else if (strcmp(target, "jl_gc_disable_finalizers_internal") == 0) {
	jl_gc_disable_finalizers_internal();
	return jl_nothing;
} else if (strcmp(target, "jl_gc_enable_finalizers_internal") == 0) {
	jl_gc_enable_finalizers_internal();
	return jl_nothing;
} else if (strcmp(target, "jl_gc_run_pending_finalizers") == 0) {
	...
	*(void**)jl_data_ptr(v) = (void*)result;
	...
	jl_gc_queue_root(
			(const jl_value_t *) jl_unbox_voidpointer(eval_value(args[5], s))
		);
	return jl_nothing;
} else if (strcmp(target, "jl_gc_queue_multiroot") == 0) {
	jl_gc_queue_multiroot(
			(const jl_value_t *) jl_unbox_voidpointer(eval_value(args[5], s)),
			(const jl_value_t *) jl_unbox_voidpointer(eval_value(args[6], s))
		);
	return jl_nothing;
	...
	*(void**)jl_data_ptr(v) = (void*)result;
	...
	return jl_box_int32(result);
} else if (strcmp(target, "jl_egal__bits") == 0) {
	int result = jl_egal__bits(
			(const jl_value_t *) jl_unbox_voidpointer(eval_value(args[5], s)),
			(const jl_value_t *) jl_unbox_voidpointer(eval_value(args[6], s)),
			(jl_datatype_t *) eval_value(args[7], s)
		);
	return jl_box_int32(result);
} else if (strcmp(target, "jl_egal__special") == 0) {
	int result = jl_egal__special(
			(const jl_value_t *) jl_unbox_voidpointer(eval_value(args[5], s)),
			(const jl_value_t *) jl_unbox_voidpointer(eval_value(args[6], s)),
			(jl_datatype_t *) eval_value(args[7], s)
		);
	return jl_box_int32(result);
} else if (strcmp(target, "jl_egal__unboxed") == 0) {
	int result = jl_egal__unboxed(
			(const jl_value_t *) jl_unbox_voidpointer(eval_value(args[5], s)),
			(const jl_value_t *) jl_unbox_voidpointer(eval_value(args[6], s)),
			(jl_datatype_t *) eval_value(args[7], s)
		);
	...
	return jl_box_uint32(result);
} else if (strcmp(target, "jl_type_equality_is_identity") == 0) {
	int result = jl_type_equality_is_identity(
			(jl_value_t *) eval_value(args[5], s),
			(jl_value_t *) eval_value(args[6], s)
		);
	return jl_box_int32(result);
	...
	*(void**)jl_data_ptr(v) = (void*)result;
	...
	return result;
} else if (strcmp(target, "jl_apply_modify_type") == 0) {
	jl_datatype_t * result = jl_apply_modify_type(
			(jl_value_t *) eval_value(args[5], s)
		);
	return result;
} else if (strcmp(target, "jl_apply_cmpswap_type") == 0) {
	jl_datatype_t * result = jl_apply_cmpswap_type(
			(jl_value_t *) eval_value(args[5], s)
		);
	return result;
	...
	return result;
} else if (strcmp(target, "jl_atomic_new_bits") == 0) {
	jl_value_t * result = jl_atomic_new_bits(
			(jl_value_t *) eval_value(args[5], s),
			(const char *) jl_unbox_voidpointer(eval_value(args[6], s))
		);
	return result;
} else if (strcmp(target, "jl_atomic_store_bits") == 0) {
	...
	return jl_nothing;
} else if (strcmp(target, "jl_atomic_swap_bits") == 0) {
	jl_value_t * result = jl_atomic_swap_bits(
			(jl_value_t *) eval_value(args[5], s),
			(char *) jl_unbox_voidpointer(eval_value(args[6], s)),
			(const jl_value_t *) jl_unbox_voidpointer(eval_value(args[7], s)),
			(int) jl_unbox_int32(eval_value(args[8], s))
		);
	return result;
} else if (strcmp(target, "jl_atomic_bool_cmpswap_bits") == 0) {
	int result = jl_atomic_bool_cmpswap_bits(
			(char *) jl_unbox_voidpointer(eval_value(args[5], s)),
			(const jl_value_t *) jl_unbox_voidpointer(eval_value(args[6], s)),
			(const jl_value_t *) jl_unbox_voidpointer(eval_value(args[7], s)),
			(int) jl_unbox_int32(eval_value(args[8], s))
	...
	return jl_box_int32(result);
} else if (strcmp(target, "jl_atomic_cmpswap_bits") == 0) {
	jl_value_t * result = jl_atomic_cmpswap_bits(
			(jl_datatype_t *) eval_value(args[5], s),
			(jl_datatype_t *) eval_value(args[6], s),
			(char *) jl_unbox_voidpointer(eval_value(args[7], s)),
			(const jl_value_t *) jl_unbox_voidpointer(eval_value(args[8], s)),
			(const jl_value_t *) jl_unbox_voidpointer(eval_value(args[9], s)),
			(int) jl_unbox_int32(eval_value(args[10], s))
		);
	return result;
	...
	jl_value_t * result = jl_generic_function_def(
			(jl_sym_t *) eval_value(args[5], s),
			(jl_module_t *) eval_value(args[6], s),
			(_Atomic(jl_value_t *) *) jl_unbox_voidpointer(eval_value(args[7], s)),
			(jl_value_t *) eval_value(args[8], s),
			(jl_binding_t *) jl_unbox_voidpointer(eval_value(args[9], s))
		);
	return result;
} else if (strcmp(target, "jl_method_def") == 0) {
	jl_method_t * result = jl_method_def(
			(jl_svec_t *) eval_value(args[5], s),
			(jl_methtable_t *) eval_value(args[6], s),
			(jl_code_info_t *) eval_value(args[7], s),
	...
	return result;
} else if (strcmp(target, "jl_box_uint8pointer") == 0) {
	jl_value_t * result = jl_box_uint8pointer(
...
} else if (strcmp(target, "jl_unbox_uint8pointer") == 0) {
	uint8_t * result = jl_unbox_uint8pointer(
			(jl_value_t *) eval_value(args[5], s)
		);
	jl_ptls_t ptls = jl_get_ptls_states();
	jl_datatype_t *rt = eval_value(args[1], s);
	...
	*(void**)jl_data_ptr(v) = (void*)result;
	...
	return result;
} else if (strcmp(target, "jl_array_validate_dims") == 0) {
	int result = jl_array_validate_dims(
			(size_t *) jl_unbox_voidpointer(eval_value(args[5], s)),
			(size_t *) jl_unbox_voidpointer(eval_value(args[6], s)),
			(uint32_t) jl_unbox_uint32(eval_value(args[7], s)),
	...
	*(void**)jl_data_ptr(v) = (void*)result;
	...
	return jl_nothing;
} else if (strcmp(target, "jl_set_module_optlevel") == 0) {
	jl_set_module_optlevel(
			(jl_module_t *) eval_value(args[5], s),
			(int) jl_unbox_int32(eval_value(args[6], s))
		);
	return jl_nothing;
} else if (strcmp(target, "jl_get_module_optlevel") == 0) {
	int result = jl_get_module_optlevel(
			(jl_module_t *) eval_value(args[5], s)
		);
	return jl_box_int32(result);
} else if (strcmp(target, "jl_set_module_compile") == 0) {
	jl_set_module_compile(
			(jl_module_t *) eval_value(args[5], s),
			(int) jl_unbox_int32(eval_value(args[6], s))
		);
	return jl_nothing;
} else if (strcmp(target, "jl_get_module_compile") == 0) {
	int result = jl_get_module_compile(
			(jl_module_t *) eval_value(args[5], s)
		);
	return jl_box_int32(result);
} else if (strcmp(target, "jl_set_module_infer") == 0) {
	jl_set_module_infer(
			(jl_module_t *) eval_value(args[5], s),
			(int) jl_unbox_int32(eval_value(args[6], s))
		);
	return jl_nothing;
} else if (strcmp(target, "jl_get_module_infer") == 0) {
	int result = jl_get_module_infer(
			(jl_module_t *) eval_value(args[5], s)
		);
	return jl_box_int32(result);
} else if (strcmp(target, "jl_set_module_max_methods") == 0) {
	jl_set_module_max_methods(
			(jl_module_t *) eval_value(args[5], s),
			(int) jl_unbox_int32(eval_value(args[6], s))
		);
	return jl_nothing;
} else if (strcmp(target, "jl_get_module_max_methods") == 0) {
	int result = jl_get_module_max_methods(
			(jl_module_t *) eval_value(args[5], s)
		);
	return jl_box_int32(result);
	...
	*(void**)jl_data_ptr(v) = (void*)result;
	...
	return result;
} else if (strcmp(target, "jl_binding_type") == 0) {
	jl_value_t * result = jl_binding_type(
			(jl_module_t *) eval_value(args[5], s),
			(jl_sym_t *) eval_value(args[6], s)
		);
	return result;
	...
	*(void**)jl_data_ptr(v) = (void*)result;
	...
	return jl_nothing;
} else if (strcmp(target, "jl_module_use_as") == 0) {
	jl_module_use_as(
			(jl_module_t *) eval_value(args[5], s),
			(jl_module_t *) eval_value(args[6], s),
			(jl_sym_t *) eval_value(args[7], s),
			(jl_sym_t *) eval_value(args[8], s)
		);
	return jl_nothing;
	...
	return jl_nothing;
} else if (strcmp(target, "jl_module_import_as") == 0) {
	jl_module_import_as(
			(jl_module_t *) eval_value(args[5], s),
			(jl_module_t *) eval_value(args[6], s),
			(jl_sym_t *) eval_value(args[7], s),
	...
	return result;
} else if (strcmp(target, "jl_get_libllvm") == 0) {
	jl_value_t * result = jl_get_libllvm();
	return result;
	...
	return jl_nothing;
} else if (strcmp(target, "jl_atomic_error") == 0) {
	jl_atomic_error(
			(char *) jl_unbox_voidpointer(eval_value(args[5], s))
		);
	return jl_nothing;
	...
	jl_exception_clear();
	return jl_nothing;
} else if (strcmp(target, "jl_get_libdir") == 0) {
	const char * result = jl_get_libdir();
	jl_ptls_t ptls = jl_get_ptls_states();
	jl_datatype_t *rt = eval_value(args[1], s);
	rt = instantiate_foreigncall_rt(rt, s);
	jl_value_t *v = jl_gc_alloc(ptls, sizeof(void*), rt);
	...
	*(void**)jl_data_ptr(v) = (void*)result;
	...
	return jl_nothing;
} else if (strcmp(target, "jl_set_newly_inferred") == 0) {
	...
	return result;
} else if (strcmp(target, "jl_expand_with_loc_warn") == 0) {
	jl_value_t * result = jl_expand_with_loc_warn(
			(jl_value_t *) eval_value(args[5], s),
			(jl_module_t *) eval_value(args[6], s),
			(const char *) jl_unbox_voidpointer(eval_value(args[7], s)),
			(int) jl_unbox_int32(eval_value(args[8], s))
	...
	return result;
} else if (strcmp(target, "jl_expand_in_world") == 0) {
	jl_value_t * result = jl_expand_in_world(
			(jl_value_t *) eval_value(args[5], s),
			(jl_module_t *) eval_value(args[6], s),
			(const char *) jl_unbox_voidpointer(eval_value(args[7], s)),
			(int) jl_unbox_int32(eval_value(args[8], s)),
	...
	jl_libhandle result = jl_load_dynamic_library(
			(const char *) jl_unbox_voidpointer(eval_value(args[5], s)),
	...
	*(void**)jl_data_ptr(v) = (void*)result;
	...
	int result = jl_dlclose(
			(jl_libhandle) jl_unbox_voidpointer(eval_value(args[5], s))
		);
	return jl_box_int32(result);
	...
	return result;
} else if (strcmp(target, "jl_compress_ir") == 0) {
	jl_array_t * result = jl_compress_ir(
			(jl_method_t *) eval_value(args[5], s),
			(jl_code_info_t *) eval_value(args[6], s)
		);
	return result;
} else if (strcmp(target, "jl_uncompress_ir") == 0) {
	jl_code_info_t * result = jl_uncompress_ir(
			(jl_method_t *) eval_value(args[5], s),
			(jl_code_instance_t *) eval_value(args[6], s),
			(jl_array_t *) eval_value(args[7], s)
		);
	return result;
} else if (strcmp(target, "jl_ir_flag_inferred") == 0) {
	uint8_t result = jl_ir_flag_inferred(
			(jl_array_t *) eval_value(args[5], s)
		);
	jl_datatype_t *rt = (jl_datatype_t*)eval_value(args[1], s);
...
} else if (strcmp(target, "jl_ir_flag_inlineable") == 0) {
	uint8_t result = jl_ir_flag_inlineable(
			(jl_array_t *) eval_value(args[5], s)
		);
	jl_datatype_t *rt = (jl_datatype_t*)eval_value(args[1], s);
...
} else if (strcmp(target, "jl_ir_flag_pure") == 0) {
	uint8_t result = jl_ir_flag_pure(
			(jl_array_t *) eval_value(args[5], s)
		);
	jl_datatype_t *rt = (jl_datatype_t*)eval_value(args[1], s);
...
} else if (strcmp(target, "jl_ir_nslots") == 0) {
	ssize_t result = jl_ir_nslots(
			(jl_array_t *) eval_value(args[5], s)
		);
	return jl_box_long(result);
} else if (strcmp(target, "jl_ir_slotflag") == 0) {
	uint8_t result = jl_ir_slotflag(
			(jl_array_t *) eval_value(args[5], s),
			(size_t) jl_unbox_uint32(eval_value(args[6], s))
		);
	jl_datatype_t *rt = (jl_datatype_t*)eval_value(args[1], s);
	...
	return jl_box_int32(result);
} else if (strcmp(target, "jl_is_syntactic_operator") == 0) {
	int result = jl_is_syntactic_operator(
			(char *) jl_unbox_voidpointer(eval_value(args[5], s))
		);
	return jl_box_int32(result);
	...
	return jl_nothing;
} else if (strcmp(target, "jl_get_pgcstack") == 0) {
	jl_gcframe_t ** result = jl_get_pgcstack();
	jl_ptls_t ptls = jl_get_ptls_states();
	jl_datatype_t *rt = eval_value(args[1], s);
	rt = instantiate_foreigncall_rt(rt, s);
	jl_value_t *v = jl_gc_alloc(ptls, sizeof(void*), rt);
	*(void**)jl_data_ptr(v) = (void*)result;
	...
	return jl_nothing;
} else if (strcmp(target, "jl_process_events") == 0) {
	int result = jl_process_events();
	return jl_box_int32(result);
} else if (strcmp(target, "jl_global_event_loop") == 0) {
	struct uv_loop_s * result = jl_global_event_loop();
	jl_ptls_t ptls = jl_get_ptls_states();
	jl_datatype_t *rt = eval_value(args[1], s);
	rt = instantiate_foreigncall_rt(rt, s);
	jl_value_t *v = jl_gc_alloc(ptls, sizeof(void*), rt);
	*(void**)jl_data_ptr(v) = (void*)result;
...
} else if (strcmp(target, "jl_close_uv") == 0) {
	jl_close_uv(
			(struct uv_handle_s *) jl_unbox_voidpointer(eval_value(args[5], s))
		);
	return jl_nothing;
	...
	jl_uv_puts(
			(struct uv_stream_s *) jl_unbox_voidpointer(eval_value(args[5], s)),
			(const char *) jl_unbox_voidpointer(eval_value(args[6], s)),
			(size_t) jl_unbox_uint32(eval_value(args[7], s))
		);
	return jl_nothing;
	...
	struct uv_stream_s * result = jl_stdout_stream();
	jl_ptls_t ptls = jl_get_ptls_states();
	jl_datatype_t *rt = eval_value(args[1], s);
	rt = instantiate_foreigncall_rt(rt, s);
	jl_value_t *v = jl_gc_alloc(ptls, sizeof(void*), rt);
	*(void**)jl_data_ptr(v) = (void*)result;
	...
	struct uv_stream_s * result = jl_stdin_stream();
	jl_ptls_t ptls = jl_get_ptls_states();
	jl_datatype_t *rt = eval_value(args[1], s);
	rt = instantiate_foreigncall_rt(rt, s);
	jl_value_t *v = jl_gc_alloc(ptls, sizeof(void*), rt);
	*(void**)jl_data_ptr(v) = (void*)result;
	...
	struct uv_stream_s * result = jl_stderr_stream();
	jl_ptls_t ptls = jl_get_ptls_states();
	jl_datatype_t *rt = eval_value(args[1], s);
	rt = instantiate_foreigncall_rt(rt, s);
	jl_value_t *v = jl_gc_alloc(ptls, sizeof(void*), rt);
	*(void**)jl_data_ptr(v) = (void*)result;
	...
	return jl_box_uint32(result);
} else if (strcmp(target, "jl_print_backtrace") == 0) {
	jl_print_backtrace();
	return jl_nothing;
	...
	*(void**)jl_data_ptr(v) = (void*)result;
	...
	jl_task_t * result = jl_get_current_task();
	return result;
} else if (strcmp(target, "jl_get_safe_restore") == 0) {
	sigjmp_buf * result = jl_get_safe_restore();
	jl_ptls_t ptls = jl_get_ptls_states();
	jl_datatype_t *rt = eval_value(args[1], s);
	rt = instantiate_foreigncall_rt(rt, s);
	jl_value_t *v = jl_gc_alloc(ptls, sizeof(void*), rt);
	*(void**)jl_data_ptr(v) = (void*)result;
...
} else if (strcmp(target, "jl_set_safe_restore") == 0) {
	jl_set_safe_restore(
			(sigjmp_buf *) jl_unbox_voidpointer(eval_value(args[5], s))
		);
	return jl_nothing;
	...
	return jl_box_float32(result);
} else if (strcmp(target, "jl_start_alloc_profile") == 0) {
	jl_start_alloc_profile(
			(double) jl_unbox_float64(eval_value(args[5], s))
		);
	return jl_nothing;
} else if (strcmp(target, "jl_stop_alloc_profile") == 0) {
	jl_stop_alloc_profile();
	return jl_nothing;
} else if (strcmp(target, "jl_free_alloc_profile") == 0) {
	jl_free_alloc_profile();
	return jl_nothing;
} else if (strcmp(target, "uv_version") == 0) {
	unsigned int result = uv_version();
	return jl_box_uint32(result);
} else if (strcmp(target, "uv_version_string") == 0) {
	const char * result = uv_version_string();
	jl_ptls_t ptls = jl_get_ptls_states();
	jl_datatype_t *rt = eval_value(args[1], s);
	rt = instantiate_foreigncall_rt(rt, s);
	jl_value_t *v = jl_gc_alloc(ptls, sizeof(void*), rt);
...
} else if (strcmp(target, "uv_library_shutdown") == 0) {
	uv_library_shutdown();
	return jl_nothing;
} else if (strcmp(target, "uv_replace_allocator") == 0) {
	int result = uv_replace_allocator(
			(uv_malloc_func) jl_unbox_voidpointer(eval_value(args[5], s)),
			(uv_realloc_func) jl_unbox_voidpointer(eval_value(args[6], s)),
			(uv_calloc_func) jl_unbox_voidpointer(eval_value(args[7], s)),
			(uv_free_func) jl_unbox_voidpointer(eval_value(args[8], s))
		);
	return jl_box_int32(result);
} else if (strcmp(target, "uv_default_loop") == 0) {
...
} else if (strcmp(target, "uv_loop_init") == 0) {
	int result = uv_loop_init(
			(uv_loop_t *) jl_unbox_voidpointer(eval_value(args[5], s))
		);
	return jl_box_int32(result);
} else if (strcmp(target, "uv_loop_close") == 0) {
	int result = uv_loop_close(
			(uv_loop_t *) jl_unbox_voidpointer(eval_value(args[5], s))
		);
	return jl_box_int32(result);
} else if (strcmp(target, "uv_loop_new") == 0) {
	uv_loop_t * result = uv_loop_new();
	jl_ptls_t ptls = jl_get_ptls_states();
	jl_datatype_t *rt = eval_value(args[1], s);
	rt = instantiate_foreigncall_rt(rt, s);
	jl_value_t *v = jl_gc_alloc(ptls, sizeof(void*), rt);
...
} else if (strcmp(target, "uv_loop_delete") == 0) {
	uv_loop_delete(
			(uv_loop_t *) jl_unbox_voidpointer(eval_value(args[5], s))
		);
	return jl_nothing;
} else if (strcmp(target, "uv_loop_size") == 0) {
	size_t result = uv_loop_size();
	return jl_box_uint32(result);
} else if (strcmp(target, "uv_loop_alive") == 0) {
	int result = uv_loop_alive(
			(const uv_loop_t *) jl_unbox_voidpointer(eval_value(args[5], s))
		);
	return jl_box_int32(result);
} else if (strcmp(target, "uv_loop_configure") == 0) {
	int result = uv_loop_configure(
			(uv_loop_t *) jl_unbox_voidpointer(eval_value(args[5], s)),
			(uv_loop_option) jl_unbox_int32(eval_value(args[6], s))
		);
	return jl_box_int32(result);
} else if (strcmp(target, "uv_run") == 0) {
	int result = uv_run(
			(uv_loop_t *) jl_unbox_voidpointer(eval_value(args[5], s)),
			(uv_run_mode) jl_unbox_int32(eval_value(args[6], s))
		);
	return jl_box_int32(result);
} else if (strcmp(target, "uv_stop") == 0) {
	uv_stop(
			(uv_loop_t *) jl_unbox_voidpointer(eval_value(args[5], s))
		);
	return jl_nothing;
} else if (strcmp(target, "uv_ref") == 0) {
	uv_ref(
			(uv_handle_t *) jl_unbox_voidpointer(eval_value(args[5], s))
		);
	return jl_nothing;
} else if (strcmp(target, "uv_unref") == 0) {
	uv_unref(
			(uv_handle_t *) jl_unbox_voidpointer(eval_value(args[5], s))
		);
	return jl_nothing;
} else if (strcmp(target, "uv_has_ref") == 0) {
	int result = uv_has_ref(
			(const uv_handle_t *) jl_unbox_voidpointer(eval_value(args[5], s))
		);
	return jl_box_int32(result);
} else if (strcmp(target, "uv_update_time") == 0) {
	uv_update_time(
			(uv_loop_t *) jl_unbox_voidpointer(eval_value(args[5], s))
		);
	return jl_nothing;
} else if (strcmp(target, "uv_now") == 0) {
	uint64_t result = uv_now(
			(const uv_loop_t *) jl_unbox_voidpointer(eval_value(args[5], s))
		);
	return jl_box_uint32(result);
} else if (strcmp(target, "uv_backend_fd") == 0) {
	uv_os_fd_t result = uv_backend_fd(
			(const uv_loop_t *) jl_unbox_voidpointer(eval_value(args[5], s))
		);
	return jl_box_int32(result);
} else if (strcmp(target, "uv_backend_timeout") == 0) {
	int result = uv_backend_timeout(
			(const uv_loop_t *) jl_unbox_voidpointer(eval_value(args[5], s))
		);
	return jl_box_int32(result);
} else if (strcmp(target, "uv_translate_sys_error") == 0) {
	int result = uv_translate_sys_error(
			(int) jl_unbox_int32(eval_value(args[5], s))
		);
	return jl_box_int32(result);
} else if (strcmp(target, "uv_strerror") == 0) {
	const char * result = uv_strerror(
			(int) jl_unbox_int32(eval_value(args[5], s))
		);
	jl_ptls_t ptls = jl_get_ptls_states();
	jl_datatype_t *rt = eval_value(args[1], s);
...
} else if (strcmp(target, "uv_strerror_r") == 0) {
	char * result = uv_strerror_r(
			(int) jl_unbox_int32(eval_value(args[5], s)),
			(char *) jl_unbox_voidpointer(eval_value(args[6], s)),
			(size_t) jl_unbox_uint32(eval_value(args[7], s))
		);
...
} else if (strcmp(target, "uv_err_name") == 0) {
	const char * result = uv_err_name(
			(int) jl_unbox_int32(eval_value(args[5], s))
		);
	jl_ptls_t ptls = jl_get_ptls_states();
	jl_datatype_t *rt = eval_value(args[1], s);
...
} else if (strcmp(target, "uv_err_name_r") == 0) {
	char * result = uv_err_name_r(
			(int) jl_unbox_int32(eval_value(args[5], s)),
			(char *) jl_unbox_voidpointer(eval_value(args[6], s)),
			(size_t) jl_unbox_uint32(eval_value(args[7], s))
		);
...
} else if (strcmp(target, "uv_shutdown") == 0) {
	int result = uv_shutdown(
			(uv_shutdown_t *) jl_unbox_voidpointer(eval_value(args[5], s)),
			(uv_stream_t *) jl_unbox_voidpointer(eval_value(args[6], s)),
			(uv_shutdown_cb) jl_unbox_voidpointer(eval_value(args[7], s))
		);
	return jl_box_int32(result);
} else if (strcmp(target, "uv_handle_size") == 0) {
	size_t result = uv_handle_size(
			(uv_handle_type) jl_unbox_int32(eval_value(args[5], s))
		);
	return jl_box_uint32(result);
} else if (strcmp(target, "uv_handle_get_type") == 0) {
	uv_handle_type result = uv_handle_get_type(
			(const uv_handle_t *) jl_unbox_voidpointer(eval_value(args[5], s))
		);
	return jl_box_int32(result);
} else if (strcmp(target, "uv_handle_type_name") == 0) {
	const char * result = uv_handle_type_name(
			(uv_handle_type) jl_unbox_int32(eval_value(args[5], s))
		);
	jl_ptls_t ptls = jl_get_ptls_states();
	jl_datatype_t *rt = eval_value(args[1], s);
...
} else if (strcmp(target, "uv_handle_get_data") == 0) {
	void * result = uv_handle_get_data(
			(const uv_handle_t *) jl_unbox_voidpointer(eval_value(args[5], s))
		);
	jl_ptls_t ptls = jl_get_ptls_states();
	jl_datatype_t *rt = eval_value(args[1], s);
...
} else if (strcmp(target, "uv_handle_get_loop") == 0) {
	uv_loop_t * result = uv_handle_get_loop(
			(const uv_handle_t *) jl_unbox_voidpointer(eval_value(args[5], s))
		);
	jl_ptls_t ptls = jl_get_ptls_states();
	jl_datatype_t *rt = eval_value(args[1], s);
...
} else if (strcmp(target, "uv_handle_set_data") == 0) {
	uv_handle_set_data(
			(uv_handle_t *) jl_unbox_voidpointer(eval_value(args[5], s)),
			(void *) jl_unbox_voidpointer(eval_value(args[6], s))
		);
	return jl_nothing;
} else if (strcmp(target, "uv_req_size") == 0) {
	size_t result = uv_req_size(
			(uv_req_type) jl_unbox_int32(eval_value(args[5], s))
		);
	return jl_box_uint32(result);
} else if (strcmp(target, "uv_req_get_data") == 0) {
	void * result = uv_req_get_data(
			(const uv_req_t *) jl_unbox_voidpointer(eval_value(args[5], s))
		);
	jl_ptls_t ptls = jl_get_ptls_states();
	jl_datatype_t *rt = eval_value(args[1], s);
	rt = instantiate_foreigncall_rt(rt, s);
...
} else if (strcmp(target, "uv_req_set_data") == 0) {
	uv_req_set_data(
			(uv_req_t *) jl_unbox_voidpointer(eval_value(args[5], s)),
			(void *) jl_unbox_voidpointer(eval_value(args[6], s))
		);
	return jl_nothing;
} else if (strcmp(target, "uv_req_get_loop") == 0) {
	uv_loop_t * result = uv_req_get_loop(
			(const uv_req_t *) jl_unbox_voidpointer(eval_value(args[5], s))
		);
	jl_ptls_t ptls = jl_get_ptls_states();
	jl_datatype_t *rt = eval_value(args[1], s);
...
} else if (strcmp(target, "uv_req_get_type") == 0) {
	uv_req_type result = uv_req_get_type(
			(const uv_req_t *) jl_unbox_voidpointer(eval_value(args[5], s))
		);
	return jl_box_int32(result);
} else if (strcmp(target, "uv_req_type_name") == 0) {
	const char * result = uv_req_type_name(
			(uv_req_type) jl_unbox_int32(eval_value(args[5], s))
		);
	jl_ptls_t ptls = jl_get_ptls_states();
	jl_datatype_t *rt = eval_value(args[1], s);
	...
	*(void**)jl_data_ptr(v) = (void*)result;
...
} else if (strcmp(target, "uv_is_active") == 0) {
	int result = uv_is_active(
			(const uv_handle_t *) jl_unbox_voidpointer(eval_value(args[5], s))
		);
	return jl_box_int32(result);
} else if (strcmp(target, "uv_walk") == 0) {
	uv_walk(
			(uv_loop_t *) jl_unbox_voidpointer(eval_value(args[5], s)),
			(uv_walk_cb) jl_unbox_voidpointer(eval_value(args[6], s)),
			(void *) jl_unbox_voidpointer(eval_value(args[7], s))
		);
	return jl_nothing;
} else if (strcmp(target, "uv_print_all_handles") == 0) {
	uv_print_all_handles(
			(uv_loop_t *) jl_unbox_voidpointer(eval_value(args[5], s)),
			(void *) jl_unbox_voidpointer(eval_value(args[6], s))
		);
	return jl_nothing;
} else if (strcmp(target, "uv_print_active_handles") == 0) {
	uv_print_active_handles(
			(uv_loop_t *) jl_unbox_voidpointer(eval_value(args[5], s)),
			(void *) jl_unbox_voidpointer(eval_value(args[6], s))
		);
	return jl_nothing;
} else if (strcmp(target, "uv_close") == 0) {
	uv_close(
			(uv_handle_t *) jl_unbox_voidpointer(eval_value(args[5], s)),
			(uv_close_cb) jl_unbox_voidpointer(eval_value(args[6], s))
		);
	return jl_nothing;
} else if (strcmp(target, "uv_send_buffer_size") == 0) {
	int result = uv_send_buffer_size(
			(uv_handle_t *) jl_unbox_voidpointer(eval_value(args[5], s)),
			(int *) jl_unbox_voidpointer(eval_value(args[6], s))
		);
	return jl_box_int32(result);
} else if (strcmp(target, "uv_recv_buffer_size") == 0) {
	int result = uv_recv_buffer_size(
			(uv_handle_t *) jl_unbox_voidpointer(eval_value(args[5], s)),
			(int *) jl_unbox_voidpointer(eval_value(args[6], s))
		);
	return jl_box_int32(result);
} else if (strcmp(target, "uv_fileno") == 0) {
	int result = uv_fileno(
			(const uv_handle_t *) jl_unbox_voidpointer(eval_value(args[5], s)),
			(uv_os_fd_t *) jl_unbox_voidpointer(eval_value(args[6], s))
		);
	return jl_box_int32(result);
} else if (strcmp(target, "uv_pipe") == 0) {
	int result = uv_pipe(
			(uv_os_fd_t [2]) jl_unbox_voidpointer(eval_value(args[5], s)),
			(int) jl_unbox_int32(eval_value(args[6], s)),
			(int) jl_unbox_int32(eval_value(args[7], s))
		);
	return jl_box_int32(result);
} else if (strcmp(target, "uv_socketpair") == 0) {
	int result = uv_socketpair(
			(int) jl_unbox_int32(eval_value(args[5], s)),
			(int) jl_unbox_int32(eval_value(args[6], s)),
			(uv_os_sock_t [2]) jl_unbox_voidpointer(eval_value(args[7], s)),
			(int) jl_unbox_int32(eval_value(args[8], s)),
			(int) jl_unbox_int32(eval_value(args[9], s))
		);
	return jl_box_int32(result);
} else if (strcmp(target, "uv_stream_get_write_queue_size") == 0) {
	size_t result = uv_stream_get_write_queue_size(
			(const uv_stream_t *) jl_unbox_voidpointer(eval_value(args[5], s))
		);
	return jl_box_uint32(result);
} else if (strcmp(target, "uv_listen") == 0) {
	int result = uv_listen(
			(uv_stream_t *) jl_unbox_voidpointer(eval_value(args[5], s)),
			(int) jl_unbox_int32(eval_value(args[6], s)),
			(uv_connection_cb) jl_unbox_voidpointer(eval_value(args[7], s))
		);
	return jl_box_int32(result);
} else if (strcmp(target, "uv_accept") == 0) {
	int result = uv_accept(
			(uv_stream_t *) jl_unbox_voidpointer(eval_value(args[5], s)),
			(uv_stream_t *) jl_unbox_voidpointer(eval_value(args[6], s))
		);
	return jl_box_int32(result);
} else if (strcmp(target, "uv_read_start") == 0) {
	int result = uv_read_start(
			(uv_stream_t *) jl_unbox_voidpointer(eval_value(args[5], s)),
			(uv_alloc_cb) jl_unbox_voidpointer(eval_value(args[6], s)),
			(uv_read_cb) jl_unbox_voidpointer(eval_value(args[7], s))
		);
	return jl_box_int32(result);
} else if (strcmp(target, "uv_read_stop") == 0) {
	int result = uv_read_stop(
			(uv_stream_t *) jl_unbox_voidpointer(eval_value(args[5], s))
		);
	return jl_box_int32(result);
} else if (strcmp(target, "uv_write") == 0) {
	int result = uv_write(
			(uv_write_t *) jl_unbox_voidpointer(eval_value(args[5], s)),
			(uv_stream_t *) jl_unbox_voidpointer(eval_value(args[6], s)),
			(const uv_buf_t *) jl_unbox_voidpointer(eval_value(args[7], s)),
			(unsigned int) jl_unbox_uint32(eval_value(args[8], s)),
			(uv_write_cb) jl_unbox_voidpointer(eval_value(args[9], s))
		);
	return jl_box_int32(result);
} else if (strcmp(target, "uv_write2") == 0) {
	int result = uv_write2(
			(uv_write_t *) jl_unbox_voidpointer(eval_value(args[5], s)),
			(uv_stream_t *) jl_unbox_voidpointer(eval_value(args[6], s)),
			(const uv_buf_t *) jl_unbox_voidpointer(eval_value(args[7], s)),
			(unsigned int) jl_unbox_uint32(eval_value(args[8], s)),
			(uv_stream_t *) jl_unbox_voidpointer(eval_value(args[9], s)),
			(uv_write_cb) jl_unbox_voidpointer(eval_value(args[10], s))
		);
	return jl_box_int32(result);
} else if (strcmp(target, "uv_try_write") == 0) {
	int result = uv_try_write(
			(uv_stream_t *) jl_unbox_voidpointer(eval_value(args[5], s)),
			(const uv_buf_t *) jl_unbox_voidpointer(eval_value(args[6], s)),
			(unsigned int) jl_unbox_uint32(eval_value(args[7], s))
		);
	return jl_box_int32(result);
} else if (strcmp(target, "uv_try_write2") == 0) {
	int result = uv_try_write2(
			(uv_stream_t *) jl_unbox_voidpointer(eval_value(args[5], s)),
			(const uv_buf_t *) jl_unbox_voidpointer(eval_value(args[6], s)),
			(unsigned int) jl_unbox_uint32(eval_value(args[7], s)),
			(uv_stream_t *) jl_unbox_voidpointer(eval_value(args[8], s))
		);
	return jl_box_int32(result);
} else if (strcmp(target, "uv_is_readable") == 0) {
	int result = uv_is_readable(
			(const uv_stream_t *) jl_unbox_voidpointer(eval_value(args[5], s))
		);
	return jl_box_int32(result);
} else if (strcmp(target, "uv_is_writable") == 0) {
	int result = uv_is_writable(
			(const uv_stream_t *) jl_unbox_voidpointer(eval_value(args[5], s))
		);
	return jl_box_int32(result);
} else if (strcmp(target, "uv_stream_set_blocking") == 0) {
	int result = uv_stream_set_blocking(
			(uv_stream_t *) jl_unbox_voidpointer(eval_value(args[5], s)),
			(int) jl_unbox_int32(eval_value(args[6], s))
		);
	return jl_box_int32(result);
} else if (strcmp(target, "uv_is_closing") == 0) {
	int result = uv_is_closing(
			(const uv_handle_t *) jl_unbox_voidpointer(eval_value(args[5], s))
		);
	return jl_box_int32(result);
} else if (strcmp(target, "uv_tcp_init") == 0) {
	int result = uv_tcp_init(
			(uv_loop_t *) jl_unbox_voidpointer(eval_value(args[5], s)),
			(uv_tcp_t *) jl_unbox_voidpointer(eval_value(args[6], s))
		);
	return jl_box_int32(result);
} else if (strcmp(target, "uv_tcp_init_ex") == 0) {
	int result = uv_tcp_init_ex(
			(uv_loop_t *) jl_unbox_voidpointer(eval_value(args[5], s)),
			(uv_tcp_t *) jl_unbox_voidpointer(eval_value(args[6], s)),
			(unsigned int) jl_unbox_uint32(eval_value(args[7], s))
		);
	return jl_box_int32(result);
} else if (strcmp(target, "uv_tcp_open") == 0) {
	int result = uv_tcp_open(
			(uv_tcp_t *) jl_unbox_voidpointer(eval_value(args[5], s)),
			(uv_os_sock_t) jl_unbox_int32(eval_value(args[6], s))
		);
	return jl_box_int32(result);
} else if (strcmp(target, "uv_tcp_nodelay") == 0) {
	int result = uv_tcp_nodelay(
			(uv_tcp_t *) jl_unbox_voidpointer(eval_value(args[5], s)),
			(int) jl_unbox_int32(eval_value(args[6], s))
		);
	return jl_box_int32(result);
} else if (strcmp(target, "uv_tcp_keepalive") == 0) {
	int result = uv_tcp_keepalive(
			(uv_tcp_t *) jl_unbox_voidpointer(eval_value(args[5], s)),
			(int) jl_unbox_int32(eval_value(args[6], s)),
			(unsigned int) jl_unbox_uint32(eval_value(args[7], s))
		);
	return jl_box_int32(result);
} else if (strcmp(target, "uv_tcp_simultaneous_accepts") == 0) {
	int result = uv_tcp_simultaneous_accepts(
			(uv_tcp_t *) jl_unbox_voidpointer(eval_value(args[5], s)),
			(int) jl_unbox_int32(eval_value(args[6], s))
		);
	return jl_box_int32(result);
} else if (strcmp(target, "uv_tcp_bind") == 0) {
	int result = uv_tcp_bind(
			(uv_tcp_t *) jl_unbox_voidpointer(eval_value(args[5], s)),
			(const struct sockaddr *) jl_unbox_voidpointer(eval_value(args[6], s)),
			(unsigned int) jl_unbox_uint32(eval_value(args[7], s))
		);
	return jl_box_int32(result);
} else if (strcmp(target, "uv_tcp_getsockname") == 0) {
	int result = uv_tcp_getsockname(
			(const uv_tcp_t *) jl_unbox_voidpointer(eval_value(args[5], s)),
			(struct sockaddr *) jl_unbox_voidpointer(eval_value(args[6], s)),
			(int *) jl_unbox_voidpointer(eval_value(args[7], s))
		);
	return jl_box_int32(result);
} else if (strcmp(target, "uv_tcp_getpeername") == 0) {
	int result = uv_tcp_getpeername(
			(const uv_tcp_t *) jl_unbox_voidpointer(eval_value(args[5], s)),
			(struct sockaddr *) jl_unbox_voidpointer(eval_value(args[6], s)),
			(int *) jl_unbox_voidpointer(eval_value(args[7], s))
		);
	return jl_box_int32(result);
} else if (strcmp(target, "uv_tcp_close_reset") == 0) {
	int result = uv_tcp_close_reset(
			(uv_tcp_t *) jl_unbox_voidpointer(eval_value(args[5], s)),
			(uv_close_cb) jl_unbox_voidpointer(eval_value(args[6], s))
		);
	return jl_box_int32(result);
} else if (strcmp(target, "uv_tcp_connect") == 0) {
	int result = uv_tcp_connect(
			(uv_connect_t *) jl_unbox_voidpointer(eval_value(args[5], s)),
			(uv_tcp_t *) jl_unbox_voidpointer(eval_value(args[6], s)),
			(const struct sockaddr *) jl_unbox_voidpointer(eval_value(args[7], s)),
			(uv_connect_cb) jl_unbox_voidpointer(eval_value(args[8], s))
		);
	return jl_box_int32(result);
} else if (strcmp(target, "uv_udp_init") == 0) {
	int result = uv_udp_init(
			(uv_loop_t *) jl_unbox_voidpointer(eval_value(args[5], s)),
			(uv_udp_t *) jl_unbox_voidpointer(eval_value(args[6], s))
		);
	return jl_box_int32(result);
} else if (strcmp(target, "uv_udp_init_ex") == 0) {
	int result = uv_udp_init_ex(
			(uv_loop_t *) jl_unbox_voidpointer(eval_value(args[5], s)),
			(uv_udp_t *) jl_unbox_voidpointer(eval_value(args[6], s)),
			(unsigned int) jl_unbox_uint32(eval_value(args[7], s))
		);
	return jl_box_int32(result);
} else if (strcmp(target, "uv_udp_open") == 0) {
	int result = uv_udp_open(
			(uv_udp_t *) jl_unbox_voidpointer(eval_value(args[5], s)),
			(uv_os_sock_t) jl_unbox_int32(eval_value(args[6], s))
		);
	return jl_box_int32(result);
} else if (strcmp(target, "uv_udp_bind") == 0) {
	...
	return jl_box_int32(result);
} else if (strcmp(target, "uv_udp_connect") == 0) {
	int result = uv_udp_connect(
			(uv_udp_t *) jl_unbox_voidpointer(eval_value(args[5], s)),
			(const struct sockaddr *) jl_unbox_voidpointer(eval_value(args[6], s))
		);
	return jl_box_int32(result);
} else if (strcmp(target, "uv_udp_getpeername") == 0) {
	int result = uv_udp_getpeername(
			(const uv_udp_t *) jl_unbox_voidpointer(eval_value(args[5], s)),
			(struct sockaddr *) jl_unbox_voidpointer(eval_value(args[6], s)),
			(int *) jl_unbox_voidpointer(eval_value(args[7], s))
		);
	return jl_box_int32(result);
} else if (strcmp(target, "uv_udp_getsockname") == 0) {
	int result = uv_udp_getsockname(
			(const uv_udp_t *) jl_unbox_voidpointer(eval_value(args[5], s)),
			(struct sockaddr *) jl_unbox_voidpointer(eval_value(args[6], s)),
			(int *) jl_unbox_voidpointer(eval_value(args[7], s))
		);
	return jl_box_int32(result);
} else if (strcmp(target, "uv_udp_set_membership") == 0) {
	int result = uv_udp_set_membership(
			(uv_udp_t *) jl_unbox_voidpointer(eval_value(args[5], s)),
			(const char *) jl_unbox_voidpointer(eval_value(args[6], s)),
			(const char *) jl_unbox_voidpointer(eval_value(args[7], s)),
			(uv_membership) jl_unbox_int32(eval_value(args[8], s))
		);
	return jl_box_int32(result);
} else if (strcmp(target, "uv_udp_set_source_membership") == 0) {
	int result = uv_udp_set_source_membership(
			(uv_udp_t *) jl_unbox_voidpointer(eval_value(args[5], s)),
			(const char *) jl_unbox_voidpointer(eval_value(args[6], s)),
			(const char *) jl_unbox_voidpointer(eval_value(args[7], s)),
			(const char *) jl_unbox_voidpointer(eval_value(args[8], s)),
			(uv_membership) jl_unbox_int32(eval_value(args[9], s))
		);
	return jl_box_int32(result);
} else if (strcmp(target, "uv_udp_set_multicast_loop") == 0) {
	int result = uv_udp_set_multicast_loop(
			(uv_udp_t *) jl_unbox_voidpointer(eval_value(args[5], s)),
			(int) jl_unbox_int32(eval_value(args[6], s))
		);
	return jl_box_int32(result);
} else if (strcmp(target, "uv_udp_set_multicast_ttl") == 0) {
	int result = uv_udp_set_multicast_ttl(
			(uv_udp_t *) jl_unbox_voidpointer(eval_value(args[5], s)),
			(int) jl_unbox_int32(eval_value(args[6], s))
		);
	return jl_box_int32(result);
} else if (strcmp(target, "uv_udp_set_multicast_interface") == 0) {
	int result = uv_udp_set_multicast_interface(
			(uv_udp_t *) jl_unbox_voidpointer(eval_value(args[5], s)),
			(const char *) jl_unbox_voidpointer(eval_value(args[6], s))
		);
	return jl_box_int32(result);
} else if (strcmp(target, "uv_udp_set_broadcast") == 0) {
	int result = uv_udp_set_broadcast(
			(uv_udp_t *) jl_unbox_voidpointer(eval_value(args[5], s)),
			(int) jl_unbox_int32(eval_value(args[6], s))
		);
	return jl_box_int32(result);
} else if (strcmp(target, "uv_udp_set_ttl") == 0) {
	int result = uv_udp_set_ttl(
			(uv_udp_t *) jl_unbox_voidpointer(eval_value(args[5], s)),
			(int) jl_unbox_int32(eval_value(args[6], s))
		);
	return jl_box_int32(result);
} else if (strcmp(target, "uv_udp_send") == 0) {
	int result = uv_udp_send(
			(uv_udp_send_t *) jl_unbox_voidpointer(eval_value(args[5], s)),
			(uv_udp_t *) jl_unbox_voidpointer(eval_value(args[6], s)),
			(const uv_buf_t *) jl_unbox_voidpointer(eval_value(args[7], s)),
			(unsigned int) jl_unbox_uint32(eval_value(args[8], s)),
			(const struct sockaddr *) jl_unbox_voidpointer(eval_value(args[9], s)),
			(uv_udp_send_cb) jl_unbox_voidpointer(eval_value(args[10], s))
		);
	return jl_box_int32(result);
} else if (strcmp(target, "uv_udp_try_send") == 0) {
	int result = uv_udp_try_send(
			(uv_udp_t *) jl_unbox_voidpointer(eval_value(args[5], s)),
			(const uv_buf_t *) jl_unbox_voidpointer(eval_value(args[6], s)),
			(unsigned int) jl_unbox_uint32(eval_value(args[7], s)),
			(const struct sockaddr *) jl_unbox_voidpointer(eval_value(args[8], s))
		);
	return jl_box_int32(result);
} else if (strcmp(target, "uv_udp_recv_start") == 0) {
	int result = uv_udp_recv_start(
			(uv_udp_t *) jl_unbox_voidpointer(eval_value(args[5], s)),
			(uv_alloc_cb) jl_unbox_voidpointer(eval_value(args[6], s)),
			(uv_udp_recv_cb) jl_unbox_voidpointer(eval_value(args[7], s))
		);
	return jl_box_int32(result);
} else if (strcmp(target, "uv_udp_using_recvmmsg") == 0) {
	int result = uv_udp_using_recvmmsg(
			(const uv_udp_t *) jl_unbox_voidpointer(eval_value(args[5], s))
		);
	return jl_box_int32(result);
} else if (strcmp(target, "uv_udp_recv_stop") == 0) {
	int result = uv_udp_recv_stop(
			(uv_udp_t *) jl_unbox_voidpointer(eval_value(args[5], s))
		);
	return jl_box_int32(result);
} else if (strcmp(target, "uv_udp_get_send_queue_size") == 0) {
	size_t result = uv_udp_get_send_queue_size(
			(const uv_udp_t *) jl_unbox_voidpointer(eval_value(args[5], s))
		);
	return jl_box_uint32(result);
} else if (strcmp(target, "uv_udp_get_send_queue_count") == 0) {
	size_t result = uv_udp_get_send_queue_count(
			(const uv_udp_t *) jl_unbox_voidpointer(eval_value(args[5], s))
		);
	return jl_box_uint32(result);
} else if (strcmp(target, "uv_tty_init") == 0) {
	int result = uv_tty_init(
			(uv_loop_t *) jl_unbox_voidpointer(eval_value(args[5], s)),
			(uv_tty_t *) jl_unbox_voidpointer(eval_value(args[6], s)),
			(uv_os_fd_t) jl_unbox_int32(eval_value(args[7], s)),
			(int) jl_unbox_int32(eval_value(args[8], s))
		);
	return jl_box_int32(result);
} else if (strcmp(target, "uv_tty_set_mode") == 0) {
	int result = uv_tty_set_mode(
			(uv_tty_t *) jl_unbox_voidpointer(eval_value(args[5], s)),
			(uv_tty_mode_t) jl_unbox_int32(eval_value(args[6], s))
		);
	return jl_box_int32(result);
} else if (strcmp(target, "uv_tty_reset_mode") == 0) {
	int result = uv_tty_reset_mode();
	return jl_box_int32(result);
} else if (strcmp(target, "uv_tty_get_winsize") == 0) {
	int result = uv_tty_get_winsize(
			(uv_tty_t *) jl_unbox_voidpointer(eval_value(args[5], s)),
			(int *) jl_unbox_voidpointer(eval_value(args[6], s)),
			(int *) jl_unbox_voidpointer(eval_value(args[7], s))
		);
	return jl_box_int32(result);
} else if (strcmp(target, "uv_tty_set_vterm_state") == 0) {
	uv_tty_set_vterm_state(
			(uv_tty_vtermstate_t) jl_unbox_int32(eval_value(args[5], s))
		);
	return jl_nothing;
} else if (strcmp(target, "uv_tty_get_vterm_state") == 0) {
	int result = uv_tty_get_vterm_state(
			(uv_tty_vtermstate_t *) jl_unbox_voidpointer(eval_value(args[5], s))
		);
	return jl_box_int32(result);
} else if (strcmp(target, "uv_guess_handle") == 0) {
	uv_handle_type result = uv_guess_handle(
			(uv_os_fd_t) jl_unbox_int32(eval_value(args[5], s))
		);
	return jl_box_int32(result);
} else if (strcmp(target, "uv_pipe_init") == 0) {
	int result = uv_pipe_init(
			(uv_loop_t *) jl_unbox_voidpointer(eval_value(args[5], s)),
			(uv_pipe_t *) jl_unbox_voidpointer(eval_value(args[6], s)),
			(int) jl_unbox_int32(eval_value(args[7], s))
		);
	return jl_box_int32(result);
} else if (strcmp(target, "uv_pipe_open") == 0) {
	int result = uv_pipe_open(
			(uv_pipe_t *) jl_unbox_voidpointer(eval_value(args[5], s)),
			(uv_os_fd_t) jl_unbox_int32(eval_value(args[6], s))
		);
	return jl_box_int32(result);
} else if (strcmp(target, "uv_pipe_bind") == 0) {
	int result = uv_pipe_bind(
			(uv_pipe_t *) jl_unbox_voidpointer(eval_value(args[5], s)),
			(const char *) jl_unbox_voidpointer(eval_value(args[6], s))
		);
	return jl_box_int32(result);
} else if (strcmp(target, "uv_pipe_connect") == 0) {
	uv_pipe_connect(
			(uv_connect_t *) jl_unbox_voidpointer(eval_value(args[5], s)),
			(uv_pipe_t *) jl_unbox_voidpointer(eval_value(args[6], s)),
			(const char *) jl_unbox_voidpointer(eval_value(args[7], s)),
	...
	return jl_nothing;
} else if (strcmp(target, "uv_pipe_getsockname") == 0) {
	int result = uv_pipe_getsockname(
			(const uv_pipe_t *) jl_unbox_voidpointer(eval_value(args[5], s)),
			(char *) jl_unbox_voidpointer(eval_value(args[6], s)),
			(size_t *) jl_unbox_voidpointer(eval_value(args[7], s))
		);
	return jl_box_int32(result);
} else if (strcmp(target, "uv_pipe_getpeername") == 0) {
	int result = uv_pipe_getpeername(
			(const uv_pipe_t *) jl_unbox_voidpointer(eval_value(args[5], s)),
			(char *) jl_unbox_voidpointer(eval_value(args[6], s)),
			(size_t *) jl_unbox_voidpointer(eval_value(args[7], s))
		);
	return jl_box_int32(result);
} else if (strcmp(target, "uv_pipe_pending_instances") == 0) {
	uv_pipe_pending_instances(
			(uv_pipe_t *) jl_unbox_voidpointer(eval_value(args[5], s)),
			(int) jl_unbox_int32(eval_value(args[6], s))
		);
	return jl_nothing;
} else if (strcmp(target, "uv_pipe_pending_count") == 0) {
	int result = uv_pipe_pending_count(
			(uv_pipe_t *) jl_unbox_voidpointer(eval_value(args[5], s))
		);
	return jl_box_int32(result);
} else if (strcmp(target, "uv_pipe_pending_type") == 0) {
	uv_handle_type result = uv_pipe_pending_type(
			(uv_pipe_t *) jl_unbox_voidpointer(eval_value(args[5], s))
		);
	return jl_box_int32(result);
} else if (strcmp(target, "uv_pipe_chmod") == 0) {
	int result = uv_pipe_chmod(
			(uv_pipe_t *) jl_unbox_voidpointer(eval_value(args[5], s)),
			(int) jl_unbox_int32(eval_value(args[6], s))
		);
	return jl_box_int32(result);
} else if (strcmp(target, "uv_poll_init") == 0) {
	int result = uv_poll_init(
			(uv_loop_t *) jl_unbox_voidpointer(eval_value(args[5], s)),
			(uv_poll_t *) jl_unbox_voidpointer(eval_value(args[6], s)),
			(uv_os_sock_t) jl_unbox_int32(eval_value(args[7], s))
		);
	return jl_box_int32(result);
} else if (strcmp(target, "uv_poll_start") == 0) {
	int result = uv_poll_start(
			(uv_poll_t *) jl_unbox_voidpointer(eval_value(args[5], s)),
			(int) jl_unbox_int32(eval_value(args[6], s)),
			(uv_poll_cb) jl_unbox_voidpointer(eval_value(args[7], s))
		);
	return jl_box_int32(result);
} else if (strcmp(target, "uv_poll_stop") == 0) {
	int result = uv_poll_stop(
			(uv_poll_t *) jl_unbox_voidpointer(eval_value(args[5], s))
		);
	return jl_box_int32(result);
} else if (strcmp(target, "uv_prepare_init") == 0) {
	int result = uv_prepare_init(
			(uv_loop_t *) jl_unbox_voidpointer(eval_value(args[5], s)),
			(uv_prepare_t *) jl_unbox_voidpointer(eval_value(args[6], s))
		);
	return jl_box_int32(result);
} else if (strcmp(target, "uv_prepare_start") == 0) {
	int result = uv_prepare_start(
			(uv_prepare_t *) jl_unbox_voidpointer(eval_value(args[5], s)),
			(uv_prepare_cb) jl_unbox_voidpointer(eval_value(args[6], s))
		);
	return jl_box_int32(result);
} else if (strcmp(target, "uv_prepare_stop") == 0) {
	int result = uv_prepare_stop(
			(uv_prepare_t *) jl_unbox_voidpointer(eval_value(args[5], s))
		);
	return jl_box_int32(result);
} else if (strcmp(target, "uv_check_init") == 0) {
	int result = uv_check_init(
			(uv_loop_t *) jl_unbox_voidpointer(eval_value(args[5], s)),
			(uv_check_t *) jl_unbox_voidpointer(eval_value(args[6], s))
		);
	return jl_box_int32(result);
} else if (strcmp(target, "uv_check_start") == 0) {
	int result = uv_check_start(
			(uv_check_t *) jl_unbox_voidpointer(eval_value(args[5], s)),
			(uv_check_cb) jl_unbox_voidpointer(eval_value(args[6], s))
		);
	return jl_box_int32(result);
} else if (strcmp(target, "uv_check_stop") == 0) {
	int result = uv_check_stop(
			(uv_check_t *) jl_unbox_voidpointer(eval_value(args[5], s))
		);
	return jl_box_int32(result);
} else if (strcmp(target, "uv_idle_init") == 0) {
	int result = uv_idle_init(
			(uv_loop_t *) jl_unbox_voidpointer(eval_value(args[5], s)),
			(uv_idle_t *) jl_unbox_voidpointer(eval_value(args[6], s))
		);
	return jl_box_int32(result);
} else if (strcmp(target, "uv_idle_start") == 0) {
	int result = uv_idle_start(
			(uv_idle_t *) jl_unbox_voidpointer(eval_value(args[5], s)),
			(uv_idle_cb) jl_unbox_voidpointer(eval_value(args[6], s))
		);
	return jl_box_int32(result);
} else if (strcmp(target, "uv_idle_stop") == 0) {
	int result = uv_idle_stop(
			(uv_idle_t *) jl_unbox_voidpointer(eval_value(args[5], s))
		);
	return jl_box_int32(result);
} else if (strcmp(target, "uv_async_init") == 0) {
	int result = uv_async_init(
			(uv_loop_t *) jl_unbox_voidpointer(eval_value(args[5], s)),
			(uv_async_t *) jl_unbox_voidpointer(eval_value(args[6], s)),
			(uv_async_cb) jl_unbox_voidpointer(eval_value(args[7], s))
		);
	return jl_box_int32(result);
} else if (strcmp(target, "uv_async_send") == 0) {
	int result = uv_async_send(
			(uv_async_t *) jl_unbox_voidpointer(eval_value(args[5], s))
		);
	return jl_box_int32(result);
} else if (strcmp(target, "uv_timer_init") == 0) {
	int result = uv_timer_init(
			(uv_loop_t *) jl_unbox_voidpointer(eval_value(args[5], s)),
			(uv_timer_t *) jl_unbox_voidpointer(eval_value(args[6], s))
		);
	return jl_box_int32(result);
} else if (strcmp(target, "uv_timer_start") == 0) {
	int result = uv_timer_start(
			(uv_timer_t *) jl_unbox_voidpointer(eval_value(args[5], s)),
			(uv_timer_cb) jl_unbox_voidpointer(eval_value(args[6], s)),
			(uint64_t) jl_unbox_uint32(eval_value(args[7], s)),
			(uint64_t) jl_unbox_uint32(eval_value(args[8], s))
		);
	return jl_box_int32(result);
} else if (strcmp(target, "uv_timer_stop") == 0) {
	int result = uv_timer_stop(
			(uv_timer_t *) jl_unbox_voidpointer(eval_value(args[5], s))
		);
	return jl_box_int32(result);
} else if (strcmp(target, "uv_timer_again") == 0) {
	int result = uv_timer_again(
			(uv_timer_t *) jl_unbox_voidpointer(eval_value(args[5], s))
		);
	return jl_box_int32(result);
} else if (strcmp(target, "uv_timer_set_repeat") == 0) {
	uv_timer_set_repeat(
			(uv_timer_t *) jl_unbox_voidpointer(eval_value(args[5], s)),
			(uint64_t) jl_unbox_uint32(eval_value(args[6], s))
		);
	return jl_nothing;
} else if (strcmp(target, "uv_timer_get_repeat") == 0) {
	uint64_t result = uv_timer_get_repeat(
			(const uv_timer_t *) jl_unbox_voidpointer(eval_value(args[5], s))
		);
	return jl_box_uint32(result);
} else if (strcmp(target, "uv_timer_get_due_in") == 0) {
	uint64_t result = uv_timer_get_due_in(
			(const uv_timer_t *) jl_unbox_voidpointer(eval_value(args[5], s))
		);
	return jl_box_uint32(result);
} else if (strcmp(target, "uv_getaddrinfo") == 0) {
	int result = uv_getaddrinfo(
			(uv_loop_t *) jl_unbox_voidpointer(eval_value(args[5], s)),
			(uv_getaddrinfo_t *) jl_unbox_voidpointer(eval_value(args[6], s)),
			(uv_getaddrinfo_cb) jl_unbox_voidpointer(eval_value(args[7], s)),
			(const char *) jl_unbox_voidpointer(eval_value(args[8], s)),
			(const char *) jl_unbox_voidpointer(eval_value(args[9], s)),
			(const struct addrinfo *) jl_unbox_voidpointer(eval_value(args[10], s))
		);
	return jl_box_int32(result);
} else if (strcmp(target, "uv_freeaddrinfo") == 0) {
	uv_freeaddrinfo(
			(struct addrinfo *) jl_unbox_voidpointer(eval_value(args[5], s))
		);
	return jl_nothing;
} else if (strcmp(target, "uv_getnameinfo") == 0) {
	int result = uv_getnameinfo(
			(uv_loop_t *) jl_unbox_voidpointer(eval_value(args[5], s)),
			(uv_getnameinfo_t *) jl_unbox_voidpointer(eval_value(args[6], s)),
			(uv_getnameinfo_cb) jl_unbox_voidpointer(eval_value(args[7], s)),
			(const struct sockaddr *) jl_unbox_voidpointer(eval_value(args[8], s)),
			(int) jl_unbox_int32(eval_value(args[9], s))
		);
	return jl_box_int32(result);
} else if (strcmp(target, "uv_spawn") == 0) {
	int result = uv_spawn(
			(uv_loop_t *) jl_unbox_voidpointer(eval_value(args[5], s)),
			(uv_process_t *) jl_unbox_voidpointer(eval_value(args[6], s)),
			(const uv_process_options_t *) jl_unbox_voidpointer(eval_value(args[7], s))
		);
	return jl_box_int32(result);
} else if (strcmp(target, "uv_process_kill") == 0) {
	int result = uv_process_kill(
			(uv_process_t *) jl_unbox_voidpointer(eval_value(args[5], s)),
			(int) jl_unbox_int32(eval_value(args[6], s))
		);
	return jl_box_int32(result);
} else if (strcmp(target, "uv_kill") == 0) {
	int result = uv_kill(
			(int) jl_unbox_int32(eval_value(args[5], s)),
			(int) jl_unbox_int32(eval_value(args[6], s))
		);
	return jl_box_int32(result);
} else if (strcmp(target, "uv_process_get_pid") == 0) {
	uv_pid_t result = uv_process_get_pid(
			(const uv_process_t *) jl_unbox_voidpointer(eval_value(args[5], s))
		);
	return jl_box_int32(result);
} else if (strcmp(target, "uv_queue_work") == 0) {
	int result = uv_queue_work(
			(uv_loop_t *) jl_unbox_voidpointer(eval_value(args[5], s)),
			(uv_work_t *) jl_unbox_voidpointer(eval_value(args[6], s)),
			(uv_work_cb) jl_unbox_voidpointer(eval_value(args[7], s)),
			(uv_after_work_cb) jl_unbox_voidpointer(eval_value(args[8], s))
		);
	return jl_box_int32(result);
} else if (strcmp(target, "uv_cancel") == 0) {
	int result = uv_cancel(
			(uv_req_t *) jl_unbox_voidpointer(eval_value(args[5], s))
		);
	return jl_box_int32(result);
} else if (strcmp(target, "uv_setup_args") == 0) {
	char ** result = uv_setup_args(
			(int) jl_unbox_int32(eval_value(args[5], s)),
			(char **) jl_unbox_voidpointer(eval_value(args[6], s))
		);
	jl_ptls_t ptls = jl_get_ptls_states();
...
} else if (strcmp(target, "uv_get_process_title") == 0) {
	int result = uv_get_process_title(
			(char *) jl_unbox_voidpointer(eval_value(args[5], s)),
			(size_t) jl_unbox_uint32(eval_value(args[6], s))
		);
	return jl_box_int32(result);
} else if (strcmp(target, "uv_set_process_title") == 0) {
	int result = uv_set_process_title(
			(const char *) jl_unbox_voidpointer(eval_value(args[5], s))
		);
	return jl_box_int32(result);
} else if (strcmp(target, "uv_resident_set_memory") == 0) {
	int result = uv_resident_set_memory(
			(size_t *) jl_unbox_voidpointer(eval_value(args[5], s))
		);
	return jl_box_int32(result);
} else if (strcmp(target, "uv_uptime") == 0) {
	int result = uv_uptime(
			(double *) jl_unbox_voidpointer(eval_value(args[5], s))
		);
	return jl_box_int32(result);
} else if (strcmp(target, "uv_getrusage") == 0) {
	int result = uv_getrusage(
			(uv_rusage_t *) jl_unbox_voidpointer(eval_value(args[5], s))
		);
	return jl_box_int32(result);
} else if (strcmp(target, "uv_os_homedir") == 0) {
	int result = uv_os_homedir(
			(char *) jl_unbox_voidpointer(eval_value(args[5], s)),
			(size_t *) jl_unbox_voidpointer(eval_value(args[6], s))
		);
	return jl_box_int32(result);
} else if (strcmp(target, "uv_os_tmpdir") == 0) {
	int result = uv_os_tmpdir(
			(char *) jl_unbox_voidpointer(eval_value(args[5], s)),
			(size_t *) jl_unbox_voidpointer(eval_value(args[6], s))
		);
	return jl_box_int32(result);
} else if (strcmp(target, "uv_os_get_passwd") == 0) {
	int result = uv_os_get_passwd(
			(uv_passwd_t *) jl_unbox_voidpointer(eval_value(args[5], s))
		);
	return jl_box_int32(result);
} else if (strcmp(target, "uv_os_free_passwd") == 0) {
	uv_os_free_passwd(
			(uv_passwd_t *) jl_unbox_voidpointer(eval_value(args[5], s))
		);
	return jl_nothing;
} else if (strcmp(target, "uv_os_get_passwd2") == 0) {
	int result = uv_os_get_passwd2(
			(uv_passwd_t *) jl_unbox_voidpointer(eval_value(args[5], s)),
			(uv_uid_t) jl_unbox_uint32(eval_value(args[6], s))
		);
	return jl_box_int32(result);
} else if (strcmp(target, "uv_os_get_group") == 0) {
	int result = uv_os_get_group(
			(uv_group_t *) jl_unbox_voidpointer(eval_value(args[5], s)),
			(uv_uid_t) jl_unbox_uint32(eval_value(args[6], s))
		);
	return jl_box_int32(result);
} else if (strcmp(target, "uv_os_free_group") == 0) {
	uv_os_free_group(
			(uv_group_t *) jl_unbox_voidpointer(eval_value(args[5], s))
		);
	return jl_nothing;
} else if (strcmp(target, "uv_os_getpid") == 0) {
	uv_pid_t result = uv_os_getpid();
	return jl_box_int32(result);
} else if (strcmp(target, "uv_os_getppid") == 0) {
	uv_pid_t result = uv_os_getppid();
	return jl_box_int32(result);
} else if (strcmp(target, "uv_os_getpriority") == 0) {
	int result = uv_os_getpriority(
			(uv_pid_t) jl_unbox_int32(eval_value(args[5], s)),
			(int *) jl_unbox_voidpointer(eval_value(args[6], s))
		);
	return jl_box_int32(result);
} else if (strcmp(target, "uv_os_setpriority") == 0) {
	int result = uv_os_setpriority(
			(uv_pid_t) jl_unbox_int32(eval_value(args[5], s)),
			(int) jl_unbox_int32(eval_value(args[6], s))
		);
	return jl_box_int32(result);
} else if (strcmp(target, "uv_available_parallelism") == 0) {
	unsigned int result = uv_available_parallelism();
	return jl_box_uint32(result);
} else if (strcmp(target, "uv_cpu_info") == 0) {
	int result = uv_cpu_info(
			(uv_cpu_info_t **) jl_unbox_voidpointer(eval_value(args[5], s)),
			(int *) jl_unbox_voidpointer(eval_value(args[6], s))
		);
	return jl_box_int32(result);
} else if (strcmp(target, "uv_free_cpu_info") == 0) {
	uv_free_cpu_info(
			(uv_cpu_info_t *) jl_unbox_voidpointer(eval_value(args[5], s)),
			(int) jl_unbox_int32(eval_value(args[6], s))
		);
	return jl_nothing;
} else if (strcmp(target, "uv_cpumask_size") == 0) {
	int result = uv_cpumask_size();
	return jl_box_int32(result);
} else if (strcmp(target, "uv_interface_addresses") == 0) {
	int result = uv_interface_addresses(
			(uv_interface_address_t **) jl_unbox_voidpointer(eval_value(args[5], s)),
			(int *) jl_unbox_voidpointer(eval_value(args[6], s))
		);
	return jl_box_int32(result);
} else if (strcmp(target, "uv_free_interface_addresses") == 0) {
	uv_free_interface_addresses(
			(uv_interface_address_t *) jl_unbox_voidpointer(eval_value(args[5], s)),
			(int) jl_unbox_int32(eval_value(args[6], s))
		);
	return jl_nothing;
} else if (strcmp(target, "uv_os_environ") == 0) {
	int result = uv_os_environ(
			(uv_env_item_t **) jl_unbox_voidpointer(eval_value(args[5], s)),
			(int *) jl_unbox_voidpointer(eval_value(args[6], s))
		);
	return jl_box_int32(result);
} else if (strcmp(target, "uv_os_free_environ") == 0) {
	uv_os_free_environ(
			(uv_env_item_t *) jl_unbox_voidpointer(eval_value(args[5], s)),
			(int) jl_unbox_int32(eval_value(args[6], s))
		);
	return jl_nothing;
} else if (strcmp(target, "uv_os_getenv") == 0) {
	int result = uv_os_getenv(
			(const char *) jl_unbox_voidpointer(eval_value(args[5], s)),
			(char *) jl_unbox_voidpointer(eval_value(args[6], s)),
			(size_t *) jl_unbox_voidpointer(eval_value(args[7], s))
		);
	return jl_box_int32(result);
} else if (strcmp(target, "uv_os_setenv") == 0) {
	int result = uv_os_setenv(
			(const char *) jl_unbox_voidpointer(eval_value(args[5], s)),
			(const char *) jl_unbox_voidpointer(eval_value(args[6], s))
		);
	return jl_box_int32(result);
} else if (strcmp(target, "uv_os_unsetenv") == 0) {
	int result = uv_os_unsetenv(
			(const char *) jl_unbox_voidpointer(eval_value(args[5], s))
		);
	return jl_box_int32(result);
} else if (strcmp(target, "uv_os_gethostname") == 0) {
	int result = uv_os_gethostname(
			(char *) jl_unbox_voidpointer(eval_value(args[5], s)),
			(size_t *) jl_unbox_voidpointer(eval_value(args[6], s))
		);
	return jl_box_int32(result);
} else if (strcmp(target, "uv_os_uname") == 0) {
	int result = uv_os_uname(
			(uv_utsname_t *) jl_unbox_voidpointer(eval_value(args[5], s))
		);
	return jl_box_int32(result);
} else if (strcmp(target, "uv_metrics_idle_time") == 0) {
	uint64_t result = uv_metrics_idle_time(
			(uv_loop_t *) jl_unbox_voidpointer(eval_value(args[5], s))
		);
	return jl_box_uint32(result);
} else if (strcmp(target, "uv_fs_get_type") == 0) {
	uv_fs_type result = uv_fs_get_type(
			(const uv_fs_t *) jl_unbox_voidpointer(eval_value(args[5], s))
		);
	return jl_box_int32(result);
} else if (strcmp(target, "uv_fs_get_result") == 0) {
	ssize_t result = uv_fs_get_result(
			(const uv_fs_t *) jl_unbox_voidpointer(eval_value(args[5], s))
		);
	return jl_box_long(result);
} else if (strcmp(target, "uv_fs_get_system_error") == 0) {
	int result = uv_fs_get_system_error(
			(const uv_fs_t *) jl_unbox_voidpointer(eval_value(args[5], s))
		);
	return jl_box_int32(result);
} else if (strcmp(target, "uv_fs_get_ptr") == 0) {
	void * result = uv_fs_get_ptr(
			(const uv_fs_t *) jl_unbox_voidpointer(eval_value(args[5], s))
		);
	jl_ptls_t ptls = jl_get_ptls_states();
	jl_datatype_t *rt = eval_value(args[1], s);
...
} else if (strcmp(target, "uv_fs_get_path") == 0) {
	const char * result = uv_fs_get_path(
			(const uv_fs_t *) jl_unbox_voidpointer(eval_value(args[5], s))
		);
	jl_ptls_t ptls = jl_get_ptls_states();
	jl_datatype_t *rt = eval_value(args[1], s);
...
} else if (strcmp(target, "uv_fs_get_statbuf") == 0) {
	uv_stat_t * result = uv_fs_get_statbuf(
			(uv_fs_t *) jl_unbox_voidpointer(eval_value(args[5], s))
		);
	jl_ptls_t ptls = jl_get_ptls_states();
	jl_datatype_t *rt = eval_value(args[1], s);
	rt = instantiate_foreigncall_rt(rt, s);
	...
	*(void**)jl_data_ptr(v) = (void*)result;
...
} else if (strcmp(target, "uv_fs_req_cleanup") == 0) {
	uv_fs_req_cleanup(
			(uv_fs_t *) jl_unbox_voidpointer(eval_value(args[5], s))
		);
	return jl_nothing;
} else if (strcmp(target, "uv_fs_close") == 0) {
	int result = uv_fs_close(
			(uv_loop_t *) jl_unbox_voidpointer(eval_value(args[5], s)),
			(uv_fs_t *) jl_unbox_voidpointer(eval_value(args[6], s)),
			(uv_os_fd_t) jl_unbox_int32(eval_value(args[7], s)),
			(uv_fs_cb) jl_unbox_voidpointer(eval_value(args[8], s))
		);
	return jl_box_int32(result);
} else if (strcmp(target, "uv_fs_open") == 0) {
	int result = uv_fs_open(
			...
			(int) jl_unbox_int32(eval_value(args[8], s)),
			(int) jl_unbox_int32(eval_value(args[9], s)),
			(uv_fs_cb) jl_unbox_voidpointer(eval_value(args[10], s))
		);
	return jl_box_int32(result);
} else if (strcmp(target, "uv_fs_read") == 0) {
	int result = uv_fs_read(
			(uv_loop_t *) jl_unbox_voidpointer(eval_value(args[5], s)),
			(uv_fs_t *) jl_unbox_voidpointer(eval_value(args[6], s)),
			(uv_os_fd_t) jl_unbox_int32(eval_value(args[7], s)),
			(const uv_buf_t *) jl_unbox_voidpointer(eval_value(args[8], s)),
			(unsigned int) jl_unbox_uint32(eval_value(args[9], s)),
			(int64_t) jl_unbox_long(eval_value(args[10], s)),
			(uv_fs_cb) jl_unbox_voidpointer(eval_value(args[11], s))
		);
	return jl_box_int32(result);
} else if (strcmp(target, "uv_fs_unlink") == 0) {
	...
	return jl_box_int32(result);
} else if (strcmp(target, "uv_fs_write") == 0) {
	...
	return jl_box_int32(result);
} else if (strcmp(target, "uv_fs_copyfile") == 0) {
	int result = uv_fs_copyfile(
			(uv_loop_t *) jl_unbox_voidpointer(eval_value(args[5], s)),
			(uv_fs_t *) jl_unbox_voidpointer(eval_value(args[6], s)),
			(const char *) jl_unbox_voidpointer(eval_value(args[7], s)),
			(const char *) jl_unbox_voidpointer(eval_value(args[8], s)),
	...
	return jl_box_int32(result);
} else if (strcmp(target, "uv_fs_mkdir") == 0) {
	int result = uv_fs_mkdir(
			(uv_loop_t *) jl_unbox_voidpointer(eval_value(args[5], s)),
			(uv_fs_t *) jl_unbox_voidpointer(eval_value(args[6], s)),
			(const char *) jl_unbox_voidpointer(eval_value(args[7], s)),
			(int) jl_unbox_int32(eval_value(args[8], s)),
			(uv_fs_cb) jl_unbox_voidpointer(eval_value(args[9], s))
		);
	return jl_box_int32(result);
} else if (strcmp(target, "uv_fs_mkdtemp") == 0) {
	int result = uv_fs_mkdtemp(
			(uv_loop_t *) jl_unbox_voidpointer(eval_value(args[5], s)),
			(uv_fs_t *) jl_unbox_voidpointer(eval_value(args[6], s)),
			(const char *) jl_unbox_voidpointer(eval_value(args[7], s)),
			(uv_fs_cb) jl_unbox_voidpointer(eval_value(args[8], s))
	...
	return jl_box_int32(result);
} else if (strcmp(target, "uv_fs_mkstemp") == 0) {
	int result = uv_fs_mkstemp(
			(uv_loop_t *) jl_unbox_voidpointer(eval_value(args[5], s)),
			(uv_fs_t *) jl_unbox_voidpointer(eval_value(args[6], s)),
			(const char *) jl_unbox_voidpointer(eval_value(args[7], s)),
			(uv_fs_cb) jl_unbox_voidpointer(eval_value(args[8], s))
	...
	return jl_box_int32(result);
} else if (strcmp(target, "uv_fs_rmdir") == 0) {
	int result = uv_fs_rmdir(
			(uv_loop_t *) jl_unbox_voidpointer(eval_value(args[5], s)),
			(uv_fs_t *) jl_unbox_voidpointer(eval_value(args[6], s)),
			(const char *) jl_unbox_voidpointer(eval_value(args[7], s)),
			(uv_fs_cb) jl_unbox_voidpointer(eval_value(args[8], s))
	...
	return jl_box_int32(result);
} else if (strcmp(target, "uv_fs_scandir") == 0) {
	int result = uv_fs_scandir(
			(uv_loop_t *) jl_unbox_voidpointer(eval_value(args[5], s)),
			(uv_fs_t *) jl_unbox_voidpointer(eval_value(args[6], s)),
			(const char *) jl_unbox_voidpointer(eval_value(args[7], s)),
			(int) jl_unbox_int32(eval_value(args[8], s)),
	...
	return jl_box_int32(result);
} else if (strcmp(target, "uv_fs_scandir_next") == 0) {
	int result = uv_fs_scandir_next(
			(uv_fs_t *) jl_unbox_voidpointer(eval_value(args[5], s)),
			(uv_dirent_t *) jl_unbox_voidpointer(eval_value(args[6], s))
		);
	return jl_box_int32(result);
} else if (strcmp(target, "uv_fs_opendir") == 0) {
	int result = uv_fs_opendir(
			(uv_loop_t *) jl_unbox_voidpointer(eval_value(args[5], s)),
			(uv_fs_t *) jl_unbox_voidpointer(eval_value(args[6], s)),
			(const char *) jl_unbox_voidpointer(eval_value(args[7], s)),
			(uv_fs_cb) jl_unbox_voidpointer(eval_value(args[8], s))
	...
	return jl_box_int32(result);
} else if (strcmp(target, "uv_fs_readdir") == 0) {
	int result = uv_fs_readdir(
			(uv_loop_t *) jl_unbox_voidpointer(eval_value(args[5], s)),
			(uv_fs_t *) jl_unbox_voidpointer(eval_value(args[6], s)),
			(uv_dir_t *) jl_unbox_voidpointer(eval_value(args[7], s)),
			(uv_fs_cb) jl_unbox_voidpointer(eval_value(args[8], s))
		);
	return jl_box_int32(result);
} else if (strcmp(target, "uv_fs_closedir") == 0) {
	int result = uv_fs_closedir(
			(uv_loop_t *) jl_unbox_voidpointer(eval_value(args[5], s)),
			(uv_fs_t *) jl_unbox_voidpointer(eval_value(args[6], s)),
			(uv_dir_t *) jl_unbox_voidpointer(eval_value(args[7], s)),
			(uv_fs_cb) jl_unbox_voidpointer(eval_value(args[8], s))
	...
	return jl_box_int32(result);
} else if (strcmp(target, "uv_fs_stat") == 0) {
	int result = uv_fs_stat(
			(uv_loop_t *) jl_unbox_voidpointer(eval_value(args[5], s)),
			(uv_fs_t *) jl_unbox_voidpointer(eval_value(args[6], s)),
			(const char *) jl_unbox_voidpointer(eval_value(args[7], s)),
			(uv_fs_cb) jl_unbox_voidpointer(eval_value(args[8], s))
	...
	return jl_box_int32(result);
} else if (strcmp(target, "uv_fs_fstat") == 0) {
	int result = uv_fs_fstat(
			(uv_loop_t *) jl_unbox_voidpointer(eval_value(args[5], s)),
			(uv_fs_t *) jl_unbox_voidpointer(eval_value(args[6], s)),
			(uv_os_fd_t) jl_unbox_int32(eval_value(args[7], s)),
			(uv_fs_cb) jl_unbox_voidpointer(eval_value(args[8], s))
	...
	return jl_box_int32(result);
} else if (strcmp(target, "uv_fs_rename") == 0) {
	...
	return jl_box_int32(result);
} else if (strcmp(target, "uv_fs_fsync") == 0) {
	int result = uv_fs_fsync(
			(uv_loop_t *) jl_unbox_voidpointer(eval_value(args[5], s)),
			(uv_fs_t *) jl_unbox_voidpointer(eval_value(args[6], s)),
			(uv_os_fd_t) jl_unbox_int32(eval_value(args[7], s)),
			(uv_fs_cb) jl_unbox_voidpointer(eval_value(args[8], s))
	...
	return jl_box_int32(result);
} else if (strcmp(target, "uv_fs_fdatasync") == 0) {
	int result = uv_fs_fdatasync(
			(uv_loop_t *) jl_unbox_voidpointer(eval_value(args[5], s)),
			(uv_fs_t *) jl_unbox_voidpointer(eval_value(args[6], s)),
			(uv_os_fd_t) jl_unbox_int32(eval_value(args[7], s)),
			(uv_fs_cb) jl_unbox_voidpointer(eval_value(args[8], s))
	...
	return jl_box_int32(result);
} else if (strcmp(target, "uv_fs_ftruncate") == 0) {
	...
	return jl_box_int32(result);
} else if (strcmp(target, "uv_fs_sendfile") == 0) {
	int result = uv_fs_sendfile(
			(uv_loop_t *) jl_unbox_voidpointer(eval_value(args[5], s)),
			(uv_fs_t *) jl_unbox_voidpointer(eval_value(args[6], s)),
			(uv_os_fd_t) jl_unbox_int32(eval_value(args[7], s)),
			(uv_os_fd_t) jl_unbox_int32(eval_value(args[8], s)),
			(int64_t) jl_unbox_long(eval_value(args[9], s)),
			(size_t) jl_unbox_uint32(eval_value(args[10], s)),
			(uv_fs_cb) jl_unbox_voidpointer(eval_value(args[11], s))
		);
	return jl_box_int32(result);
} else if (strcmp(target, "uv_fs_access") == 0) {
	int result = uv_fs_access(
			(uv_loop_t *) jl_unbox_voidpointer(eval_value(args[5], s)),
			(uv_fs_t *) jl_unbox_voidpointer(eval_value(args[6], s)),
			(const char *) jl_unbox_voidpointer(eval_value(args[7], s)),
			(int) jl_unbox_int32(eval_value(args[8], s)),
	...
	return jl_box_int32(result);
} else if (strcmp(target, "uv_fs_chmod") == 0) {
	int result = uv_fs_chmod(
			(uv_loop_t *) jl_unbox_voidpointer(eval_value(args[5], s)),
			(uv_fs_t *) jl_unbox_voidpointer(eval_value(args[6], s)),
			(const char *) jl_unbox_voidpointer(eval_value(args[7], s)),
			(int) jl_unbox_int32(eval_value(args[8], s)),
	...
	return jl_box_int32(result);
} else if (strcmp(target, "uv_fs_utime") == 0) {
	int result = uv_fs_utime(
			(uv_loop_t *) jl_unbox_voidpointer(eval_value(args[5], s)),
			(uv_fs_t *) jl_unbox_voidpointer(eval_value(args[6], s)),
			(const char *) jl_unbox_voidpointer(eval_value(args[7], s)),
			(double) jl_unbox_float64(eval_value(args[8], s)),
			(double) jl_unbox_float64(eval_value(args[9], s)),
			(uv_fs_cb) jl_unbox_voidpointer(eval_value(args[10], s))
		);
	return jl_box_int32(result);
} else if (strcmp(target, "uv_fs_utime_ex") == 0) {
	int result = uv_fs_utime_ex(
			(uv_loop_t *) jl_unbox_voidpointer(eval_value(args[5], s)),
			(uv_fs_t *) jl_unbox_voidpointer(eval_value(args[6], s)),
			(const char *) jl_unbox_voidpointer(eval_value(args[7], s)),
			(double) jl_unbox_float64(eval_value(args[8], s)),
			(double) jl_unbox_float64(eval_value(args[9], s)),
			(double) jl_unbox_float64(eval_value(args[10], s)),
			(uv_fs_cb) jl_unbox_voidpointer(eval_value(args[11], s))
		);
	return jl_box_int32(result);
} else if (strcmp(target, "uv_fs_futime") == 0) {
	int result = uv_fs_futime(
			(uv_loop_t *) jl_unbox_voidpointer(eval_value(args[5], s)),
			(uv_fs_t *) jl_unbox_voidpointer(eval_value(args[6], s)),
			(uv_os_fd_t) jl_unbox_int32(eval_value(args[7], s)),
			(double) jl_unbox_float64(eval_value(args[8], s)),
	...
	return jl_box_int32(result);
} else if (strcmp(target, "uv_fs_futime_ex") == 0) {
	int result = uv_fs_futime_ex(
			(uv_loop_t *) jl_unbox_voidpointer(eval_value(args[5], s)),
			(uv_fs_t *) jl_unbox_voidpointer(eval_value(args[6], s)),
			(uv_os_fd_t) jl_unbox_int32(eval_value(args[7], s)),
			(double) jl_unbox_float64(eval_value(args[8], s)),
	...
	return jl_box_int32(result);
} else if (strcmp(target, "uv_fs_lutime") == 0) {
	int result = uv_fs_lutime(
			(uv_loop_t *) jl_unbox_voidpointer(eval_value(args[5], s)),
			(uv_fs_t *) jl_unbox_voidpointer(eval_value(args[6], s)),
			(const char *) jl_unbox_voidpointer(eval_value(args[7], s)),
			(double) jl_unbox_float64(eval_value(args[8], s)),
	...
	return jl_box_int32(result);
} else if (strcmp(target, "uv_fs_lstat") == 0) {
	int result = uv_fs_lstat(
			(uv_loop_t *) jl_unbox_voidpointer(eval_value(args[5], s)),
			(uv_fs_t *) jl_unbox_voidpointer(eval_value(args[6], s)),
			(const char *) jl_unbox_voidpointer(eval_value(args[7], s)),
			(uv_fs_cb) jl_unbox_voidpointer(eval_value(args[8], s))
	...
	return jl_box_int32(result);
} else if (strcmp(target, "uv_fs_link") == 0) {
	int result = uv_fs_link(
			(uv_loop_t *) jl_unbox_voidpointer(eval_value(args[5], s)),
			(uv_fs_t *) jl_unbox_voidpointer(eval_value(args[6], s)),
			(const char *) jl_unbox_voidpointer(eval_value(args[7], s)),
			(const char *) jl_unbox_voidpointer(eval_value(args[8], s)),
	...
	return jl_box_int32(result);
} else if (strcmp(target, "uv_fs_symlink") == 0) {
	...
	return jl_box_int32(result);
} else if (strcmp(target, "uv_fs_readlink") == 0) {
	int result = uv_fs_readlink(
			(uv_loop_t *) jl_unbox_voidpointer(eval_value(args[5], s)),
			(uv_fs_t *) jl_unbox_voidpointer(eval_value(args[6], s)),
			(const char *) jl_unbox_voidpointer(eval_value(args[7], s)),
			(uv_fs_cb) jl_unbox_voidpointer(eval_value(args[8], s))
	...
	return jl_box_int32(result);
} else if (strcmp(target, "uv_fs_realpath") == 0) {
	int result = uv_fs_realpath(
			(uv_loop_t *) jl_unbox_voidpointer(eval_value(args[5], s)),
			(uv_fs_t *) jl_unbox_voidpointer(eval_value(args[6], s)),
			(const char *) jl_unbox_voidpointer(eval_value(args[7], s)),
			(uv_fs_cb) jl_unbox_voidpointer(eval_value(args[8], s))
	...
	return jl_box_int32(result);
} else if (strcmp(target, "uv_fs_fchmod") == 0) {
	int result = uv_fs_fchmod(
			(uv_loop_t *) jl_unbox_voidpointer(eval_value(args[5], s)),
			(uv_fs_t *) jl_unbox_voidpointer(eval_value(args[6], s)),
			(uv_os_fd_t) jl_unbox_int32(eval_value(args[7], s)),
			(int) jl_unbox_int32(eval_value(args[8], s)),
	...
	return jl_box_int32(result);
} else if (strcmp(target, "uv_fs_chown") == 0) {
	int result = uv_fs_chown(
			(uv_loop_t *) jl_unbox_voidpointer(eval_value(args[5], s)),
			(uv_fs_t *) jl_unbox_voidpointer(eval_value(args[6], s)),
			(const char *) jl_unbox_voidpointer(eval_value(args[7], s)),
			(uv_uid_t) jl_unbox_uint32(eval_value(args[8], s)),
			(uv_gid_t) jl_unbox_uint32(eval_value(args[9], s)),
			(uv_fs_cb) jl_unbox_voidpointer(eval_value(args[10], s))
		);
	return jl_box_int32(result);
} else if (strcmp(target, "uv_fs_fchown") == 0) {
	int result = uv_fs_fchown(
			(uv_loop_t *) jl_unbox_voidpointer(eval_value(args[5], s)),
			(uv_fs_t *) jl_unbox_voidpointer(eval_value(args[6], s)),
			(uv_os_fd_t) jl_unbox_int32(eval_value(args[7], s)),
			(uv_uid_t) jl_unbox_uint32(eval_value(args[8], s)),
	...
	return jl_box_int32(result);
} else if (strcmp(target, "uv_fs_lchown") == 0) {
	int result = uv_fs_lchown(
			(uv_loop_t *) jl_unbox_voidpointer(eval_value(args[5], s)),
			(uv_fs_t *) jl_unbox_voidpointer(eval_value(args[6], s)),
			(const char *) jl_unbox_voidpointer(eval_value(args[7], s)),
			(uv_uid_t) jl_unbox_uint32(eval_value(args[8], s)),
	...
	return jl_box_int32(result);
} else if (strcmp(target, "uv_fs_statfs") == 0) {
	int result = uv_fs_statfs(
			(uv_loop_t *) jl_unbox_voidpointer(eval_value(args[5], s)),
			(uv_fs_t *) jl_unbox_voidpointer(eval_value(args[6], s)),
			(const char *) jl_unbox_voidpointer(eval_value(args[7], s)),
			(uv_fs_cb) jl_unbox_voidpointer(eval_value(args[8], s))
	...
	return jl_box_int32(result);
} else if (strcmp(target, "uv_fs_poll_init") == 0) {
	int result = uv_fs_poll_init(
			(uv_loop_t *) jl_unbox_voidpointer(eval_value(args[5], s)),
			(uv_fs_poll_t *) jl_unbox_voidpointer(eval_value(args[6], s))
		);
	return jl_box_int32(result);
} else if (strcmp(target, "uv_fs_poll_start") == 0) {
	int result = uv_fs_poll_start(
			(uv_fs_poll_t *) jl_unbox_voidpointer(eval_value(args[5], s)),
			(uv_fs_poll_cb) jl_unbox_voidpointer(eval_value(args[6], s)),
			(const char *) jl_unbox_voidpointer(eval_value(args[7], s)),
			(unsigned int) jl_unbox_uint32(eval_value(args[8], s))
		);
	return jl_box_int32(result);
} else if (strcmp(target, "uv_fs_poll_stop") == 0) {
	int result = uv_fs_poll_stop(
			(uv_fs_poll_t *) jl_unbox_voidpointer(eval_value(args[5], s))
		);
	return jl_box_int32(result);
} else if (strcmp(target, "uv_fs_poll_getpath") == 0) {
	int result = uv_fs_poll_getpath(
			(uv_fs_poll_t *) jl_unbox_voidpointer(eval_value(args[5], s)),
			(char *) jl_unbox_voidpointer(eval_value(args[6], s)),
			(size_t *) jl_unbox_voidpointer(eval_value(args[7], s))
		);
	return jl_box_int32(result);
} else if (strcmp(target, "uv_signal_init") == 0) {
	int result = uv_signal_init(
			(uv_loop_t *) jl_unbox_voidpointer(eval_value(args[5], s)),
			(uv_signal_t *) jl_unbox_voidpointer(eval_value(args[6], s))
		);
	return jl_box_int32(result);
} else if (strcmp(target, "uv_signal_start") == 0) {
	int result = uv_signal_start(
			(uv_signal_t *) jl_unbox_voidpointer(eval_value(args[5], s)),
			(uv_signal_cb) jl_unbox_voidpointer(eval_value(args[6], s)),
			(int) jl_unbox_int32(eval_value(args[7], s))
		);
	return jl_box_int32(result);
} else if (strcmp(target, "uv_signal_start_oneshot") == 0) {
	int result = uv_signal_start_oneshot(
			(uv_signal_t *) jl_unbox_voidpointer(eval_value(args[5], s)),
			(uv_signal_cb) jl_unbox_voidpointer(eval_value(args[6], s)),
			(int) jl_unbox_int32(eval_value(args[7], s))
		);
	return jl_box_int32(result);
} else if (strcmp(target, "uv_signal_stop") == 0) {
	int result = uv_signal_stop(
			(uv_signal_t *) jl_unbox_voidpointer(eval_value(args[5], s))
		);
	return jl_box_int32(result);
} else if (strcmp(target, "uv_loadavg") == 0) {
	uv_loadavg(
			(double [3]) jl_unbox_voidpointer(eval_value(args[5], s))
		);
	return jl_nothing;
} else if (strcmp(target, "uv_fs_event_init") == 0) {
	int result = uv_fs_event_init(
			(uv_loop_t *) jl_unbox_voidpointer(eval_value(args[5], s)),
			(uv_fs_event_t *) jl_unbox_voidpointer(eval_value(args[6], s))
		);
	return jl_box_int32(result);
} else if (strcmp(target, "uv_fs_event_start") == 0) {
	int result = uv_fs_event_start(
			(uv_fs_event_t *) jl_unbox_voidpointer(eval_value(args[5], s)),
			(uv_fs_event_cb) jl_unbox_voidpointer(eval_value(args[6], s)),
			(const char *) jl_unbox_voidpointer(eval_value(args[7], s)),
			(unsigned int) jl_unbox_uint32(eval_value(args[8], s))
		);
	return jl_box_int32(result);
} else if (strcmp(target, "uv_fs_event_stop") == 0) {
	int result = uv_fs_event_stop(
			(uv_fs_event_t *) jl_unbox_voidpointer(eval_value(args[5], s))
		);
	return jl_box_int32(result);
} else if (strcmp(target, "uv_fs_event_getpath") == 0) {
	...
	return jl_box_int32(result);
} else if (strcmp(target, "uv_ip4_addr") == 0) {
	int result = uv_ip4_addr(
			(const char *) jl_unbox_voidpointer(eval_value(args[5], s)),
			(int) jl_unbox_int32(eval_value(args[6], s)),
			(struct sockaddr_in *) jl_unbox_voidpointer(eval_value(args[7], s))
		);
	return jl_box_int32(result);
} else if (strcmp(target, "uv_ip6_addr") == 0) {
	int result = uv_ip6_addr(
			(const char *) jl_unbox_voidpointer(eval_value(args[5], s)),
			(int) jl_unbox_int32(eval_value(args[6], s)),
			(struct sockaddr_in6 *) jl_unbox_voidpointer(eval_value(args[7], s))
		);
	return jl_box_int32(result);
} else if (strcmp(target, "uv_ip4_name") == 0) {
	int result = uv_ip4_name(
			(const struct sockaddr_in *) jl_unbox_voidpointer(eval_value(args[5], s)),
			(char *) jl_unbox_voidpointer(eval_value(args[6], s)),
			(size_t) jl_unbox_uint32(eval_value(args[7], s))
		);
	return jl_box_int32(result);
} else if (strcmp(target, "uv_ip6_name") == 0) {
	int result = uv_ip6_name(
			(const struct sockaddr_in6 *) jl_unbox_voidpointer(eval_value(args[5], s)),
			(char *) jl_unbox_voidpointer(eval_value(args[6], s)),
			(size_t) jl_unbox_uint32(eval_value(args[7], s))
		);
	return jl_box_int32(result);
} else if (strcmp(target, "uv_ip_name") == 0) {
	int result = uv_ip_name(
			(const struct sockaddr *) jl_unbox_voidpointer(eval_value(args[5], s)),
			(char *) jl_unbox_voidpointer(eval_value(args[6], s)),
			(size_t) jl_unbox_uint32(eval_value(args[7], s))
		);
	return jl_box_int32(result);
} else if (strcmp(target, "uv_inet_ntop") == 0) {
	int result = uv_inet_ntop(
			(int) jl_unbox_int32(eval_value(args[5], s)),
			(const void *) jl_unbox_voidpointer(eval_value(args[6], s)),
			(char *) jl_unbox_voidpointer(eval_value(args[7], s)),
			(size_t) jl_unbox_uint32(eval_value(args[8], s))
	...
	return jl_box_int32(result);
} else if (strcmp(target, "uv_inet_pton") == 0) {
	int result = uv_inet_pton(
			(int) jl_unbox_int32(eval_value(args[5], s)),
			(const char *) jl_unbox_voidpointer(eval_value(args[6], s)),
			(void *) jl_unbox_voidpointer(eval_value(args[7], s))
		);
	return jl_box_int32(result);
} else if (strcmp(target, "uv_random") == 0) {
	int result = uv_random(
			(uv_loop_t *) jl_unbox_voidpointer(eval_value(args[5], s)),
			(uv_random_t *) jl_unbox_voidpointer(eval_value(args[6], s)),
			(void *) jl_unbox_voidpointer(eval_value(args[7], s)),
			(size_t) jl_unbox_uint32(eval_value(args[8], s)),
			(unsigned int) jl_unbox_uint32(eval_value(args[9], s)),
			(uv_random_cb) jl_unbox_voidpointer(eval_value(args[10], s))
		);
	return jl_box_int32(result);
} else if (strcmp(target, "uv_if_indextoname") == 0) {
	int result = uv_if_indextoname(
			(unsigned int) jl_unbox_uint32(eval_value(args[5], s)),
			(char *) jl_unbox_voidpointer(eval_value(args[6], s)),
			(size_t *) jl_unbox_voidpointer(eval_value(args[7], s))
		);
	return jl_box_int32(result);
} else if (strcmp(target, "uv_if_indextoiid") == 0) {
	int result = uv_if_indextoiid(
			(unsigned int) jl_unbox_uint32(eval_value(args[5], s)),
			(char *) jl_unbox_voidpointer(eval_value(args[6], s)),
			(size_t *) jl_unbox_voidpointer(eval_value(args[7], s))
		);
	return jl_box_int32(result);
} else if (strcmp(target, "uv_exepath") == 0) {
	int result = uv_exepath(
			(char *) jl_unbox_voidpointer(eval_value(args[5], s)),
			(size_t *) jl_unbox_voidpointer(eval_value(args[6], s))
		);
	return jl_box_int32(result);
} else if (strcmp(target, "uv_cwd") == 0) {
	int result = uv_cwd(
			(char *) jl_unbox_voidpointer(eval_value(args[5], s)),
			(size_t *) jl_unbox_voidpointer(eval_value(args[6], s))
		);
	return jl_box_int32(result);
} else if (strcmp(target, "uv_chdir") == 0) {
	int result = uv_chdir(
			(const char *) jl_unbox_voidpointer(eval_value(args[5], s))
		);
	return jl_box_int32(result);
} else if (strcmp(target, "uv_get_free_memory") == 0) {
	uint64_t result = uv_get_free_memory();
	return jl_box_uint32(result);
} else if (strcmp(target, "uv_get_total_memory") == 0) {
	uint64_t result = uv_get_total_memory();
	return jl_box_uint32(result);
} else if (strcmp(target, "uv_get_constrained_memory") == 0) {
	uint64_t result = uv_get_constrained_memory();
	return jl_box_uint32(result);
} else if (strcmp(target, "uv_hrtime") == 0) {
	uint64_t result = uv_hrtime();
	return jl_box_uint32(result);
} else if (strcmp(target, "uv_sleep") == 0) {
	uv_sleep(
			(unsigned int) jl_unbox_uint32(eval_value(args[5], s))
		);
	return jl_nothing;
} else if (strcmp(target, "uv_disable_stdio_inheritance") == 0) {
	uv_disable_stdio_inheritance();
	return jl_nothing;
} else if (strcmp(target, "uv_dlopen") == 0) {
	int result = uv_dlopen(
			(const char *) jl_unbox_voidpointer(eval_value(args[5], s)),
			(uv_lib_t *) jl_unbox_voidpointer(eval_value(args[6], s))
		);
	return jl_box_int32(result);
} else if (strcmp(target, "uv_dlclose") == 0) {
	uv_dlclose(
			(uv_lib_t *) jl_unbox_voidpointer(eval_value(args[5], s))
		);
	return jl_nothing;
} else if (strcmp(target, "uv_dlsym") == 0) {
	int result = uv_dlsym(
			(uv_lib_t *) jl_unbox_voidpointer(eval_value(args[5], s)),
			(const char *) jl_unbox_voidpointer(eval_value(args[6], s)),
			(void **) jl_unbox_voidpointer(eval_value(args[7], s))
	...
	return jl_box_int32(result);
} else if (strcmp(target, "uv_dlerror") == 0) {
	const char * result = uv_dlerror(
			(const uv_lib_t *) jl_unbox_voidpointer(eval_value(args[5], s))
		);
	jl_ptls_t ptls = jl_get_ptls_states();
	jl_datatype_t *rt = eval_value(args[1], s);
	rt = instantiate_foreigncall_rt(rt, s);
...
} else if (strcmp(target, "uv_mutex_init") == 0) {
	int result = uv_mutex_init(
			(uv_mutex_t *) jl_unbox_voidpointer(eval_value(args[5], s))
		);
	return jl_box_int32(result);
} else if (strcmp(target, "uv_mutex_init_recursive") == 0) {
	int result = uv_mutex_init_recursive(
			(uv_mutex_t *) jl_unbox_voidpointer(eval_value(args[5], s))
		);
	return jl_box_int32(result);
} else if (strcmp(target, "uv_mutex_destroy") == 0) {
	uv_mutex_destroy(
			(uv_mutex_t *) jl_unbox_voidpointer(eval_value(args[5], s))
		);
	return jl_nothing;
} else if (strcmp(target, "uv_mutex_lock") == 0) {
	uv_mutex_lock(
			(uv_mutex_t *) jl_unbox_voidpointer(eval_value(args[5], s))
		);
	return jl_nothing;
} else if (strcmp(target, "uv_mutex_trylock") == 0) {
	int result = uv_mutex_trylock(
			(uv_mutex_t *) jl_unbox_voidpointer(eval_value(args[5], s))
		);
	return jl_box_int32(result);
} else if (strcmp(target, "uv_mutex_unlock") == 0) {
	uv_mutex_unlock(
			(uv_mutex_t *) jl_unbox_voidpointer(eval_value(args[5], s))
		);
	return jl_nothing;
} else if (strcmp(target, "uv_rwlock_init") == 0) {
	int result = uv_rwlock_init(
			(uv_rwlock_t *) jl_unbox_voidpointer(eval_value(args[5], s))
		);
	return jl_box_int32(result);
} else if (strcmp(target, "uv_rwlock_destroy") == 0) {
	uv_rwlock_destroy(
			(uv_rwlock_t *) jl_unbox_voidpointer(eval_value(args[5], s))
		);
	return jl_nothing;
} else if (strcmp(target, "uv_rwlock_rdlock") == 0) {
	uv_rwlock_rdlock(
			(uv_rwlock_t *) jl_unbox_voidpointer(eval_value(args[5], s))
		);
	return jl_nothing;
} else if (strcmp(target, "uv_rwlock_tryrdlock") == 0) {
	int result = uv_rwlock_tryrdlock(
			(uv_rwlock_t *) jl_unbox_voidpointer(eval_value(args[5], s))
		);
	return jl_box_int32(result);
} else if (strcmp(target, "uv_rwlock_rdunlock") == 0) {
	uv_rwlock_rdunlock(
			(uv_rwlock_t *) jl_unbox_voidpointer(eval_value(args[5], s))
		);
	return jl_nothing;
} else if (strcmp(target, "uv_rwlock_wrlock") == 0) {
	uv_rwlock_wrlock(
			(uv_rwlock_t *) jl_unbox_voidpointer(eval_value(args[5], s))
		);
	return jl_nothing;
} else if (strcmp(target, "uv_rwlock_trywrlock") == 0) {
	int result = uv_rwlock_trywrlock(
			(uv_rwlock_t *) jl_unbox_voidpointer(eval_value(args[5], s))
		);
	return jl_box_int32(result);
} else if (strcmp(target, "uv_rwlock_wrunlock") == 0) {
	uv_rwlock_wrunlock(
			(uv_rwlock_t *) jl_unbox_voidpointer(eval_value(args[5], s))
		);
	return jl_nothing;
} else if (strcmp(target, "uv_sem_init") == 0) {
	int result = uv_sem_init(
			(uv_sem_t *) jl_unbox_voidpointer(eval_value(args[5], s)),
			(unsigned int) jl_unbox_uint32(eval_value(args[6], s))
		);
	return jl_box_int32(result);
} else if (strcmp(target, "uv_sem_destroy") == 0) {
	uv_sem_destroy(
			(uv_sem_t *) jl_unbox_voidpointer(eval_value(args[5], s))
		);
	return jl_nothing;
} else if (strcmp(target, "uv_sem_post") == 0) {
	uv_sem_post(
			(uv_sem_t *) jl_unbox_voidpointer(eval_value(args[5], s))
		);
	return jl_nothing;
} else if (strcmp(target, "uv_sem_wait") == 0) {
	uv_sem_wait(
			(uv_sem_t *) jl_unbox_voidpointer(eval_value(args[5], s))
		);
	return jl_nothing;
} else if (strcmp(target, "uv_sem_trywait") == 0) {
	int result = uv_sem_trywait(
			(uv_sem_t *) jl_unbox_voidpointer(eval_value(args[5], s))
		);
	return jl_box_int32(result);
} else if (strcmp(target, "uv_cond_init") == 0) {
	int result = uv_cond_init(
			(uv_cond_t *) jl_unbox_voidpointer(eval_value(args[5], s))
		);
	return jl_box_int32(result);
} else if (strcmp(target, "uv_cond_destroy") == 0) {
	uv_cond_destroy(
			(uv_cond_t *) jl_unbox_voidpointer(eval_value(args[5], s))
		);
	return jl_nothing;
} else if (strcmp(target, "uv_cond_signal") == 0) {
	uv_cond_signal(
			(uv_cond_t *) jl_unbox_voidpointer(eval_value(args[5], s))
		);
	return jl_nothing;
} else if (strcmp(target, "uv_cond_broadcast") == 0) {
	uv_cond_broadcast(
			(uv_cond_t *) jl_unbox_voidpointer(eval_value(args[5], s))
		);
	return jl_nothing;
} else if (strcmp(target, "uv_barrier_init") == 0) {
	int result = uv_barrier_init(
			(uv_barrier_t *) jl_unbox_voidpointer(eval_value(args[5], s)),
			(unsigned int) jl_unbox_uint32(eval_value(args[6], s))
		);
	return jl_box_int32(result);
} else if (strcmp(target, "uv_barrier_destroy") == 0) {
	uv_barrier_destroy(
			(uv_barrier_t *) jl_unbox_voidpointer(eval_value(args[5], s))
		);
	return jl_nothing;
} else if (strcmp(target, "uv_barrier_wait") == 0) {
	int result = uv_barrier_wait(
			(uv_barrier_t *) jl_unbox_voidpointer(eval_value(args[5], s))
		);
	return jl_box_int32(result);
} else if (strcmp(target, "uv_cond_wait") == 0) {
	uv_cond_wait(
			(uv_cond_t *) jl_unbox_voidpointer(eval_value(args[5], s)),
			(uv_mutex_t *) jl_unbox_voidpointer(eval_value(args[6], s))
		);
	return jl_nothing;
} else if (strcmp(target, "uv_cond_timedwait") == 0) {
	int result = uv_cond_timedwait(
			(uv_cond_t *) jl_unbox_voidpointer(eval_value(args[5], s)),
			(uv_mutex_t *) jl_unbox_voidpointer(eval_value(args[6], s)),
			(uint64_t) jl_unbox_uint32(eval_value(args[7], s))
		);
	return jl_box_int32(result);
} else if (strcmp(target, "uv_once") == 0) {
	uv_once(
			(uv_once_t *) jl_unbox_voidpointer(eval_value(args[5], s)),
			(void (*)(void)) jl_unbox_voidpointer(eval_value(args[6], s))
		);
	return jl_nothing;
} else if (strcmp(target, "uv_key_create") == 0) {
	int result = uv_key_create(
			(uv_key_t *) jl_unbox_voidpointer(eval_value(args[5], s))
		);
	return jl_box_int32(result);
} else if (strcmp(target, "uv_key_delete") == 0) {
	uv_key_delete(
			(uv_key_t *) jl_unbox_voidpointer(eval_value(args[5], s))
		);
	return jl_nothing;
} else if (strcmp(target, "uv_key_get") == 0) {
	void * result = uv_key_get(
			(uv_key_t *) jl_unbox_voidpointer(eval_value(args[5], s))
		);
	jl_ptls_t ptls = jl_get_ptls_states();
	jl_datatype_t *rt = eval_value(args[1], s);
	...
	*(void**)jl_data_ptr(v) = (void*)result;
...
} else if (strcmp(target, "uv_key_set") == 0) {
	uv_key_set(
			(uv_key_t *) jl_unbox_voidpointer(eval_value(args[5], s)),
			(void *) jl_unbox_voidpointer(eval_value(args[6], s))
		);
	return jl_nothing;
} else if (strcmp(target, "uv_gettimeofday") == 0) {
	int result = uv_gettimeofday(
			(uv_timeval64_t *) jl_unbox_voidpointer(eval_value(args[5], s))
		);
	return jl_box_int32(result);
} else if (strcmp(target, "uv_thread_create") == 0) {
	int result = uv_thread_create(
			(uv_thread_t *) jl_unbox_voidpointer(eval_value(args[5], s)),
			(uv_thread_cb) jl_unbox_voidpointer(eval_value(args[6], s)),
			(void *) jl_unbox_voidpointer(eval_value(args[7], s))
		);
	return jl_box_int32(result);
} else if (strcmp(target, "uv_thread_create_ex") == 0) {
	int result = uv_thread_create_ex(
			(uv_thread_t *) jl_unbox_voidpointer(eval_value(args[5], s)),
			(const uv_thread_options_t *) jl_unbox_voidpointer(eval_value(args[6], s)),
			(uv_thread_cb) jl_unbox_voidpointer(eval_value(args[7], s)),
			(void *) jl_unbox_voidpointer(eval_value(args[8], s))
		);
	return jl_box_int32(result);
} else if (strcmp(target, "uv_thread_setaffinity") == 0) {
	int result = uv_thread_setaffinity(
			(uv_thread_t *) jl_unbox_voidpointer(eval_value(args[5], s)),
			(char *) jl_unbox_voidpointer(eval_value(args[6], s)),
			(char *) jl_unbox_voidpointer(eval_value(args[7], s)),
			(size_t) jl_unbox_uint32(eval_value(args[8], s))
	...
	return jl_box_int32(result);
} else if (strcmp(target, "uv_thread_getaffinity") == 0) {
	int result = uv_thread_getaffinity(
			(uv_thread_t *) jl_unbox_voidpointer(eval_value(args[5], s)),
			(char *) jl_unbox_voidpointer(eval_value(args[6], s)),
			(size_t) jl_unbox_uint32(eval_value(args[7], s))
		);
	return jl_box_int32(result);
} else if (strcmp(target, "uv_thread_detach") == 0) {
	int result = uv_thread_detach(
			(uv_thread_t *) jl_unbox_voidpointer(eval_value(args[5], s))
		);
	return jl_box_int32(result);
} else if (strcmp(target, "uv_thread_join") == 0) {
	int result = uv_thread_join(
			(uv_thread_t *) jl_unbox_voidpointer(eval_value(args[5], s))
		);
	return jl_box_int32(result);
} else if (strcmp(target, "uv_thread_self") == 0) {
	uv_thread_t result = uv_thread_self();
	return jl_box_uint32(result);
} else if (strcmp(target, "uv_thread_equal") == 0) {
	int result = uv_thread_equal(
			(const uv_thread_t *) jl_unbox_voidpointer(eval_value(args[5], s)),
			(const uv_thread_t *) jl_unbox_voidpointer(eval_value(args[6], s))
		);
	return jl_box_int32(result);
} else if (strcmp(target, "uv_loop_get_data") == 0) {
	void * result = uv_loop_get_data(
			(const uv_loop_t *) jl_unbox_voidpointer(eval_value(args[5], s))
		);
	jl_ptls_t ptls = jl_get_ptls_states();
	jl_datatype_t *rt = eval_value(args[1], s);
	...
	*(void**)jl_data_ptr(v) = (void*)result;
...
} else if (strcmp(target, "uv_loop_set_data") == 0) {
	uv_loop_set_data(
			(uv_loop_t *) jl_unbox_voidpointer(eval_value(args[5], s)),
			(void *) jl_unbox_voidpointer(eval_value(args[6], s))
		);
	...
	return jl_box_uint32(result);
} else if (strcmp(target, "jl_set_peek_cond") == 0) {
	jl_set_peek_cond(
			(uintptr_t) jl_unbox_uint32(eval_value(args[5], s))
		);
	return jl_nothing;
} else if (strcmp(target, "jl_get_profile_peek_duration") == 0) {
	double result = jl_get_profile_peek_duration();
	return jl_box_float64(result);
} else if (strcmp(target, "jl_set_profile_peek_duration") == 0) {
	jl_set_profile_peek_duration(
			(double) jl_unbox_float64(eval_value(args[5], s))
		);
	return jl_nothing;
} else if (strcmp(target, "jl_gc_classify_pools") == 0) {
	int result = jl_gc_classify_pools(
			(size_t) jl_unbox_uint32(eval_value(args[5], s)),
			(int *) jl_unbox_voidpointer(eval_value(args[6], s))
		);
	return jl_box_int32(result);
	...
	*(void**)jl_data_ptr(v) = (void*)result;
	...
	return jl_box_long(result);
} else if (strcmp(target, "jl_gc_sync_total_bytes") == 0) {
	int64_t result = jl_gc_sync_total_bytes(
			(int64_t) jl_unbox_long(eval_value(args[5], s))
		);
	return jl_box_long(result);
} else if (strcmp(target, "jl_gc_debug_critical_error") == 0) {
	jl_gc_debug_critical_error();
	return jl_nothing;
} else if (strcmp(target, "jl_type_infer") == 0) {
	jl_code_info_t * result = jl_type_infer(
			(jl_method_instance_t *) eval_value(args[5], s),
			(size_t) jl_unbox_uint32(eval_value(args[6], s)),
			(int) jl_unbox_int32(eval_value(args[7], s))
		);
	return result;
} else if (strcmp(target, "jl_compile_method_internal") == 0) {
	jl_code_instance_t * result = jl_compile_method_internal(
			(jl_method_instance_t *) eval_value(args[5], s),
			(size_t) jl_unbox_uint32(eval_value(args[6], s))
		);
	return result;
	...
	return result;
} else if (strcmp(target, "jl_add_method_root") == 0) {
	jl_add_method_root(
			(jl_method_t *) eval_value(args[5], s),
			(jl_module_t *) eval_value(args[6], s),
			(jl_value_t *) eval_value(args[7], s)
	...
	return result;
} else if (strcmp(target, "jl_get_exceptionf") == 0) {
	jl_value_t * result = jl_get_exceptionf(
			(jl_datatype_t *) eval_value(args[5], s),
			(const char *) jl_unbox_voidpointer(eval_value(args[6], s))
		);
	return result;
	...
	return result;
} else if (strcmp(target, "jl_f_opaque_closure_call") == 0) {
	jl_value_t * result = jl_f_opaque_closure_call(
			(jl_value_t *) eval_value(args[5], s),
			(jl_value_t **) jl_unbox_voidpointer(eval_value(args[6], s)),
			(uint32_t) jl_unbox_uint32(eval_value(args[7], s))
		);
	return result;
} else if (strcmp(target, "jl_get_builtin_fptr") == 0) {
	jl_fptr_args_t result = jl_get_builtin_fptr(
			(jl_value_t *) eval_value(args[5], s)
		);
	jl_ptls_t ptls = jl_get_ptls_states();
	jl_datatype_t *rt = eval_value(args[1], s);
	...
	*(void**)jl_data_ptr(v) = (void*)result;
...
} else if (strcmp(target, "jl_has_intersect_type_not_kind") == 0) {
	int result = jl_has_intersect_type_not_kind(
			(jl_value_t *) eval_value(args[5], s)
		);
	return jl_box_int32(result);
	...
	return result;
} else if (strcmp(target, "jl_struct_try_layout") == 0) {
	int result = jl_struct_try_layout(
			(jl_datatype_t *) eval_value(args[5], s)
		);
	return jl_box_int32(result);
} else if (strcmp(target, "jl_type_mappable_to_c") == 0) {
	int result = jl_type_mappable_to_c(
			(jl_value_t *) eval_value(args[5], s)
		);
	return jl_box_int32(result);
} else if (strcmp(target, "jl_types_egal") == 0) {
	int result = jl_types_egal(
			(jl_value_t *) eval_value(args[5], s),
			(jl_value_t *) eval_value(args[6], s)
		);
	return jl_box_int32(result);
	...
	return result;
} else if (strcmp(target, "jl_unwrap_unionall") == 0) {
	jl_value_t * result = jl_unwrap_unionall(
			(jl_value_t *) eval_value(args[5], s)
		);
	return result;
} else if (strcmp(target, "jl_rewrap_unionall") == 0) {
	jl_value_t * result = jl_rewrap_unionall(
			(jl_value_t *) eval_value(args[5], s),
			(jl_value_t *) eval_value(args[6], s)
		);
	return result;
} else if (strcmp(target, "jl_nth_union_component") == 0) {
	jl_value_t * result = jl_nth_union_component(
			(jl_value_t *) eval_value(args[5], s),
			(int) jl_unbox_int32(eval_value(args[6], s))
		);
	return result;
} else if (strcmp(target, "jl_wrap_Type") == 0) {
	jl_datatype_t * result = jl_wrap_Type(
			(jl_value_t *) eval_value(args[5], s)
		);
	return result;
} else if (strcmp(target, "jl_is_submodule") == 0) {
	int result = jl_is_submodule(
			(jl_module_t *) eval_value(args[5], s),
			(jl_module_t *) eval_value(args[6], s)
		);
	return jl_box_int32(result);
} else if (strcmp(target, "jl_datatype_isinlinealloc") == 0) {
	int result = jl_datatype_isinlinealloc(
			(jl_datatype_t *) eval_value(args[5], s),
			(int) jl_unbox_int32(eval_value(args[6], s))
		);
	return jl_box_int32(result);
} else if (strcmp(target, "jl_is_toplevel_only_expr") == 0) {
	int result = jl_is_toplevel_only_expr(
			(jl_value_t *) eval_value(args[5], s)
		);
	return jl_box_int32(result);
	...
	jl_value_t * result = jl_matching_methods(
			...
			(size_t *) jl_unbox_voidpointer(eval_value(args[11], s)),
	...
	return result;
} else if (strcmp(target, "jl_method_get_table") == 0) {
	jl_methtable_t * result = jl_method_get_table(
			(jl_method_t *) eval_value(args[5], s)
		);
	return result;
} else if (strcmp(target, "jl_pointer_egal") == 0) {
	int result = jl_pointer_egal(
			(jl_value_t *) eval_value(args[5], s)
		);
	return jl_box_int32(result);
} else if (strcmp(target, "jl_nth_slot_type") == 0) {
	jl_value_t * result = jl_nth_slot_type(
			(jl_value_t *) eval_value(args[5], s),
			(size_t) jl_unbox_uint32(eval_value(args[6], s))
		);
	return result;
} else if (strcmp(target, "jl_binding_deprecation_warning") == 0) {
	jl_binding_deprecation_warning(
			(jl_module_t *) eval_value(args[5], s),
			(jl_binding_t *) jl_unbox_voidpointer(eval_value(args[6], s))
		);
	return jl_nothing;
} else if (strcmp(target, "jl_is_valid_oc_argtype") == 0) {
	int result = jl_is_valid_oc_argtype(
			(jl_tupletype_t *) eval_value(args[5], s),
			(jl_method_t *) eval_value(args[6], s)
		);
	return jl_box_int32(result);
} else if (strcmp(target, "jl_init_options") == 0) {
	jl_init_options();
	return jl_nothing;
} else if (strcmp(target, "jl_pgcstack_getkey") == 0) {
	jl_pgcstack_getkey(
			(jl_get_pgcstack_func **) jl_unbox_voidpointer(eval_value(args[5], s)),
			(jl_pgcstack_key_t *) jl_unbox_voidpointer(eval_value(args[6], s))
		);
	return jl_nothing;
} else if (strcmp(target, "jl_dump_method_asm") == 0) {
	jl_value_t * result = jl_dump_method_asm(
			(jl_method_instance_t *) eval_value(args[5], s),
			(size_t) jl_unbox_uint32(eval_value(args[6], s)),
			(char) jl_unbox_uint8(eval_value(args[7], s)),
			(char) jl_unbox_uint8(eval_value(args[8], s)),
			(const char *) jl_unbox_voidpointer(eval_value(args[9], s)),
			(const char *) jl_unbox_voidpointer(eval_value(args[10], s)),
			(char) jl_unbox_uint8(eval_value(args[11], s))
		);
	return result;
} else if (strcmp(target, "jl_dump_fptr_asm") == 0) {
	jl_value_t * result = jl_dump_fptr_asm(
			(uint64_t) jl_unbox_uint32(eval_value(args[5], s)),
			(char) jl_unbox_uint8(eval_value(args[6], s)),
			(const char *) jl_unbox_voidpointer(eval_value(args[7], s)),
			(const char *) jl_unbox_voidpointer(eval_value(args[8], s)),
			(char) jl_unbox_uint8(eval_value(args[9], s))
		);
	return result;
} else if (strcmp(target, "jl_dump_function_ir") == 0) {
	jl_value_t * result = jl_dump_function_ir(
			(void *) jl_unbox_voidpointer(eval_value(args[5], s)),
			(char) jl_unbox_uint8(eval_value(args[6], s)),
			(char) jl_unbox_uint8(eval_value(args[7], s)),
			(const char *) jl_unbox_voidpointer(eval_value(args[8], s))
	...
	jl_value_t * result = jl_dump_function_asm(
			(void *) jl_unbox_voidpointer(eval_value(args[5], s)),
			(char) jl_unbox_uint8(eval_value(args[6], s)),
			(const char *) jl_unbox_voidpointer(eval_value(args[7], s)),
			(const char *) jl_unbox_voidpointer(eval_value(args[8], s)),
	...
	return result;
} else if (strcmp(target, "jl_get_ee_context") == 0) {
	LLVMContextRef result = jl_get_ee_context();
	jl_ptls_t ptls = jl_get_ptls_states();
	jl_datatype_t *rt = eval_value(args[1], s);
	rt = instantiate_foreigncall_rt(rt, s);
	jl_value_t *v = jl_gc_alloc(ptls, sizeof(void*), rt);
	*(void**)jl_data_ptr(v) = (void*)result;
...
} else if (strcmp(target, "jl_get_function_id") == 0) {
	jl_get_function_id(
			(void *) jl_unbox_voidpointer(eval_value(args[5], s)),
			(jl_code_instance_t *) eval_value(args[6], s),
			(int32_t *) jl_unbox_voidpointer(eval_value(args[7], s)),
			(int32_t *) jl_unbox_voidpointer(eval_value(args[8], s))
		);
	return jl_nothing;
	...
	return result;
} else if (strcmp(target, "jl_get_specialization1") == 0) {
	jl_method_instance_t * result = jl_get_specialization1(
			(jl_tupletype_t *) eval_value(args[5], s),
			(size_t) jl_unbox_uint32(eval_value(args[6], s)),
			(size_t *) jl_unbox_voidpointer(eval_value(args[7], s)),
			(size_t *) jl_unbox_voidpointer(eval_value(args[8], s)),
	...
	return result;
} else if (strcmp(target, "jl_method_compiled") == 0) {
	jl_code_instance_t * result = jl_method_compiled(
			(jl_method_instance_t *) eval_value(args[5], s),
			(size_t) jl_unbox_uint32(eval_value(args[6], s))
		);
	return result;
	...
	return jl_nothing;
} else if (strcmp(target, "jl_has_meta") == 0) {
	int result = jl_has_meta(
			(jl_array_t *) eval_value(args[5], s),
			(jl_sym_t *) eval_value(args[6], s)
		);
	return jl_box_int32(result);
	...
	return jl_box_uint32(result);
} else if (strcmp(target, "jl_get_library_") == 0) {
	void * result = jl_get_library_(
			(const char *) jl_unbox_voidpointer(eval_value(args[5], s)),
			(int) jl_unbox_int32(eval_value(args[6], s))
		);
	jl_ptls_t ptls = jl_get_ptls_states();
	...
	*(void**)jl_data_ptr(v) = (void*)result;
	...
	void * result = jl_load_and_lookup(
			(const char *) jl_unbox_voidpointer(eval_value(args[5], s)),
			(const char *) jl_unbox_voidpointer(eval_value(args[6], s)),
			(_Atomic(void *) *) jl_unbox_voidpointer(eval_value(args[7], s))
		);
	jl_ptls_t ptls = jl_get_ptls_states();
	jl_datatype_t *rt = eval_value(args[1], s);
	rt = instantiate_foreigncall_rt(rt, s);
...
} else if (strcmp(target, "jl_lazy_load_and_lookup") == 0) {
	void * result = jl_lazy_load_and_lookup(
			(jl_value_t *) eval_value(args[5], s),
			(const char *) jl_unbox_voidpointer(eval_value(args[6], s))
		);
	jl_ptls_t ptls = jl_get_ptls_states();
	...
	*(void**)jl_data_ptr(v) = (void*)result;
	...
	return result;
} else if (strcmp(target, "jl_dlfind_win32") == 0) {
	const char * result = jl_dlfind_win32(
			(const char *) jl_unbox_voidpointer(eval_value(args[5], s))
		);
	jl_ptls_t ptls = jl_get_ptls_states();
	jl_datatype_t *rt = eval_value(args[1], s);
	...
	*(void**)jl_data_ptr(v) = (void*)result;
...
} else if (strcmp(target, "jl_intrinsic_nargs") == 0) {
	unsigned int result = jl_intrinsic_nargs(
			(int) jl_unbox_int32(eval_value(args[5], s))
		);
	return jl_box_uint32(result);
	...
	return result;
} else if (strcmp(target, "jl_atomic_fence") == 0) {
	jl_value_t * result = jl_atomic_fence(
			(jl_value_t *) eval_value(args[5], s)
		);
	return result;
} else if (strcmp(target, "jl_atomic_pointerref") == 0) {
	jl_value_t * result = jl_atomic_pointerref(
			(jl_value_t *) eval_value(args[5], s),
			(jl_value_t *) eval_value(args[6], s)
		);
	return result;
} else if (strcmp(target, "jl_atomic_pointerset") == 0) {
	jl_value_t * result = jl_atomic_pointerset(
			(jl_value_t *) eval_value(args[5], s),
			(jl_value_t *) eval_value(args[6], s),
			(jl_value_t *) eval_value(args[7], s)
		);
	return result;
} else if (strcmp(target, "jl_atomic_pointerswap") == 0) {
	jl_value_t * result = jl_atomic_pointerswap(
			(jl_value_t *) eval_value(args[5], s),
			(jl_value_t *) eval_value(args[6], s),
			(jl_value_t *) eval_value(args[7], s)
		);
	return result;
} else if (strcmp(target, "jl_atomic_pointermodify") == 0) {
	jl_value_t * result = jl_atomic_pointermodify(
			(jl_value_t *) eval_value(args[5], s),
			(jl_value_t *) eval_value(args[6], s),
			(jl_value_t *) eval_value(args[7], s),
			(jl_value_t *) eval_value(args[8], s)
	...
	return result;
} else if (strcmp(target, "jl_atomic_pointerreplace") == 0) {
	jl_value_t * result = jl_atomic_pointerreplace(
			(jl_value_t *) eval_value(args[5], s),
			(jl_value_t *) eval_value(args[6], s),
			(jl_value_t *) eval_value(args[7], s),
			(jl_value_t *) eval_value(args[8], s),
	...
	return result;
} else if (strcmp(target, "jl_have_fma") == 0) {
	jl_value_t * result = jl_have_fma(
			(jl_value_t *) eval_value(args[5], s)
		);
	return result;
} else if (strcmp(target, "jl_stored_inline") == 0) {
	int result = jl_stored_inline(
			(jl_value_t *) eval_value(args[5], s)
		);
	return jl_box_int32(result);
	...
	return jl_box_uint32(result);
} else if (strcmp(target, "jl_set_next_task") == 0) {
	jl_set_next_task(
			(jl_task_t *) eval_value(args[5], s)
		);
	return jl_nothing;
} else if (strcmp(target, "jl_svec_len") == 0) {
	size_t result = jl_svec_len(
			(jl_svec_t *) eval_value(args[5], s)
		);
	return jl_box_uint32(result);
} else if (strcmp(target, "jl_svec_isassigned") == 0) {
	int8_t result = jl_svec_isassigned(
			(jl_svec_t *) eval_value(args[5], s),
...
} else if (strcmp(target, "jl_svec_ref") == 0) {
	jl_value_t * result = jl_svec_ref(
			(jl_svec_t *) eval_value(args[5], s),
			(ssize_t) jl_unbox_long(eval_value(args[6], s))
		);
	return result;
} else if (strcmp(target, "jl_special_vector_alignment") == 0) {
	unsigned int result = jl_special_vector_alignment(
			(size_t) jl_unbox_uint32(eval_value(args[5], s)),
			(jl_value_t *) eval_value(args[6], s)
		);
	return jl_box_uint32(result);
	...
	return result;
} else if (strcmp(target, "jl_isabspath") == 0) {
	int result = jl_isabspath(
			(const char *) jl_unbox_voidpointer(eval_value(args[5], s))
		);
	return jl_box_int32(result);
} else if (strcmp(target, "jl_get_atomic_order") == 0) {
	enum jl_memory_order result = jl_get_atomic_order(
			(jl_sym_t *) eval_value(args[5], s),
			(char) jl_unbox_uint8(eval_value(args[6], s)),
			(char) jl_unbox_uint8(eval_value(args[7], s))
		);
	return jl_box_int32(result);
} else if (strcmp(target, "jl_get_atomic_order_checked") == 0) {
	enum jl_memory_order result = jl_get_atomic_order_checked(
			(jl_sym_t *) eval_value(args[5], s),
			(char) jl_unbox_uint8(eval_value(args[6], s)),
			(char) jl_unbox_uint8(eval_value(args[7], s))
		);
	...
	*(void**)jl_data_ptr(v) = (void*)result;
	...
	return jl_box_int32(result);
} else if (strcmp(target, "jl_sizeof_uv_fs_t") == 0) {
	int result = jl_sizeof_uv_fs_t();
	return jl_box_int32(result);
} else if (strcmp(target, "jl_uv_fs_t_ptr") == 0) {
	char * result = jl_uv_fs_t_ptr(
			(uv_fs_t *) jl_unbox_voidpointer(eval_value(args[5], s))
		);
	jl_ptls_t ptls = jl_get_ptls_states();
	jl_datatype_t *rt = eval_value(args[1], s);
...
} else if (strcmp(target, "jl_uv_fs_t_path") == 0) {
	char * result = jl_uv_fs_t_path(
			(uv_fs_t *) jl_unbox_voidpointer(eval_value(args[5], s))
		);
	jl_ptls_t ptls = jl_get_ptls_states();
	jl_datatype_t *rt = eval_value(args[1], s);
	...
	*(void**)jl_data_ptr(v) = (void*)result;
	...
	return jl_box_float64(result);
} else if (strcmp(target, "jl_getuid") == 0) {
	unsigned long result = jl_getuid();
	return jl_box_uint32(result);
} else if (strcmp(target, "jl_geteuid") == 0) {
	unsigned long result = jl_geteuid();
	return jl_box_uint32(result);
	...
	return result;
} else if (strcmp(target, "jl_f__call_in_world") == 0) {
	jl_value_t * result = jl_f__call_in_world(
			(jl_value_t *) eval_value(args[5], s),
			(jl_value_t **) jl_unbox_voidpointer(eval_value(args[6], s)),
			(uint32_t) jl_unbox_uint32(eval_value(args[7], s))
		);
	return result;
} else if (strcmp(target, "jl_f__call_in_world_total") == 0) {
	jl_value_t * result = jl_f__call_in_world_total(
			(jl_value_t *) eval_value(args[5], s),
			(jl_value_t **) jl_unbox_voidpointer(eval_value(args[6], s)),
			(uint32_t) jl_unbox_uint32(eval_value(args[7], s))
		);
	return result;
} else if (strcmp(target, "jl_f__call_latest") == 0) {
	jl_value_t * result = jl_f__call_latest(
			(jl_value_t *) eval_value(args[5], s),
			(jl_value_t **) jl_unbox_voidpointer(eval_value(args[6], s)),
			(uint32_t) jl_unbox_uint32(eval_value(args[7], s))
		);
	return result;
} else if (strcmp(target, "jl_f_replacefield") == 0) {
	jl_value_t * result = jl_f_replacefield(
			(jl_value_t *) eval_value(args[5], s),
			(jl_value_t **) jl_unbox_voidpointer(eval_value(args[6], s)),
			(uint32_t) jl_unbox_uint32(eval_value(args[7], s))
		);
	...
	return result;
} else if (strcmp(target, "jl_f_modifyfield") == 0) {
	jl_value_t * result = jl_f_modifyfield(
			(jl_value_t *) eval_value(args[5], s),
			(jl_value_t **) jl_unbox_voidpointer(eval_value(args[6], s)),
			(uint32_t) jl_unbox_uint32(eval_value(args[7], s))
		);
	...
	return result;
} else if (strcmp(target, "jl_f_swapfield") == 0) {
	jl_value_t * result = jl_f_swapfield(
			(jl_value_t *) eval_value(args[5], s),
			(jl_value_t **) jl_unbox_voidpointer(eval_value(args[6], s)),
			(uint32_t) jl_unbox_uint32(eval_value(args[7], s))
		);
	...
	return result;
} else if (strcmp(target, "jl_f__typebody") == 0) {
	jl_value_t * result = jl_f__typebody(
			(jl_value_t *) eval_value(args[5], s),
			(jl_value_t **) jl_unbox_voidpointer(eval_value(args[6], s)),
			(uint32_t) jl_unbox_uint32(eval_value(args[7], s))
		);
	...
	return result;
} else if (strcmp(target, "jl_f_donotdelete") == 0) {
	jl_value_t * result = jl_f_donotdelete(
			(jl_value_t *) eval_value(args[5], s),
			(jl_value_t **) jl_unbox_voidpointer(eval_value(args[6], s)),
			(uint32_t) jl_unbox_uint32(eval_value(args[7], s))
		);
	...
	return result;
} else if (strcmp(target, "jl_f__structtype") == 0) {
	jl_value_t * result = jl_f__structtype(
			(jl_value_t *) eval_value(args[5], s),
			(jl_value_t **) jl_unbox_voidpointer(eval_value(args[6], s)),
			(uint32_t) jl_unbox_uint32(eval_value(args[7], s))
		);
	return result;
} else if (strcmp(target, "jl_f__abstracttype") == 0) {
	jl_value_t * result = jl_f__abstracttype(
			(jl_value_t *) eval_value(args[5], s),
			(jl_value_t **) jl_unbox_voidpointer(eval_value(args[6], s)),
			(uint32_t) jl_unbox_uint32(eval_value(args[7], s))
		);
	return result;
} else if (strcmp(target, "jl_f__primitivetype") == 0) {
	jl_value_t * result = jl_f__primitivetype(
			(jl_value_t *) eval_value(args[5], s),
			(jl_value_t **) jl_unbox_voidpointer(eval_value(args[6], s)),
			(uint32_t) jl_unbox_uint32(eval_value(args[7], s))
		);
	return result;
} else if (strcmp(target, "jl_f__setsuper") == 0) {
	jl_value_t * result = jl_f__setsuper(
			(jl_value_t *) eval_value(args[5], s),
			(jl_value_t **) jl_unbox_voidpointer(eval_value(args[6], s)),
			(uint32_t) jl_unbox_uint32(eval_value(args[7], s))
		);
	return result;
} else if (strcmp(target, "jl_f__equiv_typedef") == 0) {
	jl_value_t * result = jl_f__equiv_typedef(
			(jl_value_t *) eval_value(args[5], s),
			(jl_value_t **) jl_unbox_voidpointer(eval_value(args[6], s)),
			(uint32_t) jl_unbox_uint32(eval_value(args[7], s))
		);
	return result;
} else if (strcmp(target, "jl_f_get_binding_type") == 0) {
	jl_value_t * result = jl_f_get_binding_type(
			(jl_value_t *) eval_value(args[5], s),
			(jl_value_t **) jl_unbox_voidpointer(eval_value(args[6], s)),
			(uint32_t) jl_unbox_uint32(eval_value(args[7], s))
		);
	return result;
} else if (strcmp(target, "jl_f_set_binding_type") == 0) {
	jl_value_t * result = jl_f_set_binding_type(
			(jl_value_t *) eval_value(args[5], s),
			(jl_value_t **) jl_unbox_voidpointer(eval_value(args[6], s)),
			(uint32_t) jl_unbox_uint32(eval_value(args[7], s))
		);
	return result;
} else if (strcmp(target, "jl_test_cpu_feature") == 0) {
	int result = jl_test_cpu_feature(
			(jl_cpu_feature_t) jl_unbox_int32(eval_value(args[5], s))
		);
	return jl_box_int32(result);
	...
	jl_dump_host_cpu();
	return jl_nothing;
} else if (strcmp(target, "jl_set_zero_subnormals") == 0) {
	int32_t result = jl_set_zero_subnormals(
			(int8_t) jl_unbox_uint8(eval_value(args[5], s))
		);
	return jl_box_int32(result);
} else if (strcmp(target, "jl_get_zero_subnormals") == 0) {
	int32_t result = jl_get_zero_subnormals();
	return jl_box_int32(result);
} else if (strcmp(target, "jl_set_default_nans") == 0) {
	int32_t result = jl_set_default_nans(
			(int8_t) jl_unbox_uint8(eval_value(args[5], s))
		);
	return jl_box_int32(result);
} else if (strcmp(target, "jl_get_default_nans") == 0) {
	int32_t result = jl_get_default_nans();
	return jl_box_int32(result);
	...
	return jl_box_uint32(result);
} else if (strcmp(target, "jl_init__threading") == 0) {
	jl_init__threading();
	return jl_nothing;
} else if (strcmp(target, "jl_init_with_image__threading") == 0) {
	...
	*(void**)jl_data_ptr(v) = (void*)result;
	...
	return result;
} else if (strcmp(target, "ijl_egal") == 0) {
	int result = ijl_egal(
			(jl_value_t *) eval_value(args[5], s),
			(jl_value_t *) eval_value(args[6], s)
		);
	...
	return jl_nothing;
} else if (strcmp(target, "jl_cumulative_compile_time_ns_before") == 0) {
	uint64_t result = jl_cumulative_compile_time_ns_before();
	return jl_box_uint32(result);
} else if (strcmp(target, "jl_cumulative_compile_time_ns_after") == 0) {
	uint64_t result = jl_cumulative_compile_time_ns_after();
	return jl_box_uint32(result);
	...
	return jl_nothing;
} else if (strcmp(target, "jl_get_fenv_rounding") == 0) {
	int result = jl_get_fenv_rounding();
	return jl_box_int32(result);
} else if (strcmp(target, "jl_set_fenv_rounding") == 0) {
	int result = jl_set_fenv_rounding(
			(int) jl_unbox_int32(eval_value(args[5], s))
		);
	return jl_box_int32(result);
} else if (strcmp(target, "jl_repl_entrypoint") == 0) {
	int result = jl_repl_entrypoint(
			(int) jl_unbox_int32(eval_value(args[5], s)),
			(char * *) jl_unbox_voidpointer(eval_value(args[6], s))
		);
	return jl_box_int32(result);
	...
	return jl_nothing;
} else if (strcmp(target, "jl_new_module_") == 0) {
	jl_module_t * result = jl_new_module_(
			(jl_sym_t *) eval_value(args[5], s),
			(uint8_t) jl_unbox_uint8(eval_value(args[6], s))
		);
	return result;
	...
	*(void**)jl_data_ptr(v) = (void*)result;
	...
	return jl_nothing;
} else if (strcmp(target, "jl_clear_implicit_imports") == 0) {
	jl_clear_implicit_imports(
			(jl_module_t *) eval_value(args[5], s)
		);
	return jl_nothing;
} else if (strcmp(target, "jl_enable_gc_logging") == 0) {
	jl_enable_gc_logging(
			(int) jl_unbox_int32(eval_value(args[5], s))
		);
	return jl_nothing;
	...
	return result;
} else if (strcmp(target, "jl_is_foreign_type") == 0) {
	int result = jl_is_foreign_type(
			(jl_datatype_t *) eval_value(args[5], s)
		);
	return jl_box_int32(result);
	...
	*(void**)jl_data_ptr(v) = (void*)result;
...
} else if (strcmp(target, "jl_active_task_stack") == 0) {
	...
	return jl_nothing;
} else if (strcmp(target, "jl_gc_get_finalizers_inhibited") == 0) {
	int result = jl_gc_get_finalizers_inhibited(
			(jl_ptls_t) jl_unbox_voidpointer(eval_value(args[5], s))
		);
	return jl_box_int32(result);
...
} else if (strcmp(target, "jl_gc_live_bytes") == 0) {
	int64_t result = jl_gc_live_bytes();
	return jl_box_long(result);
	...
	*(void**)jl_data_ptr(v) = (void*)result;
	...
	return jl_box_int32(result);
} else if (strcmp(target, "jl_profile_is_buffer_full") == 0) {
	int result = jl_profile_is_buffer_full();
	return jl_box_int32(result);
	...
	*(void**)jl_data_ptr(v) = (void*)result;
	...
	return jl_box_int32(result);
} else if (strcmp(target, "__stack_chk_fail") == 0) {
	__stack_chk_fail();
	return jl_nothing;
	...
	return result;
} else if (strcmp(target, "jl_new_codeinst") == 0) {
	jl_code_instance_t * result = jl_new_codeinst(
			(jl_method_instance_t *) eval_value(args[5], s),
			(jl_value_t *) eval_value(args[6], s),
			(jl_value_t *) eval_value(args[7], s),
			(jl_value_t *) eval_value(args[8], s),
			...
			(uint8_t) jl_unbox_uint8(eval_value(args[12], s)),
			(uint8_t) jl_unbox_uint8(eval_value(args[13], s)),
			(jl_value_t *) eval_value(args[14], s),
			(uint8_t) jl_unbox_uint8(eval_value(args[15], s))
		);
	return result;
} else if (strcmp(target, "jl_mi_cache_insert") == 0) {
	jl_mi_cache_insert(
			(jl_method_instance_t *) eval_value(args[5], s),
			(jl_code_instance_t *) eval_value(args[6], s)
		);
	...
	return jl_nothing;
} else if (strcmp(target, "jl_debug_method_invalidation") == 0) {
	jl_value_t * result = jl_debug_method_invalidation(
			(int) jl_unbox_int32(eval_value(args[5], s))
		);
	return result;
	...
	return jl_nothing;
} else if (strcmp(target, "jl_normalize_to_compilable_sig") == 0) {
	jl_value_t * result = jl_normalize_to_compilable_sig(
			(jl_methtable_t *) eval_value(args[5], s),
			(jl_tupletype_t *) eval_value(args[6], s),
			(jl_svec_t *) eval_value(args[7], s),
			(jl_method_t *) eval_value(args[8], s)
		);
	return result;
	...
	return result;
} else if (strcmp(target, "jl_gf_invoke_lookup_worlds") == 0) {
	jl_value_t * result = jl_gf_invoke_lookup_worlds(
			(jl_value_t *) eval_value(args[5], s),
			(jl_value_t *) eval_value(args[6], s),
			(size_t) jl_unbox_uint32(eval_value(args[7], s)),
			(size_t *) jl_unbox_voidpointer(eval_value(args[8], s)),
	...
	jl_typeinf_end();
	return jl_nothing;
} else if (strcmp(target, "jl_get_next_task") == 0) {
	jl_task_t * result = jl_get_next_task();
	return result;
} else if (strcmp(target, "jl_switch") == 0) {
	jl_switch();
	return jl_nothing;
} else if (strcmp(target, "jl_tasklocal_genrandom") == 0) {
	uint64_t result = jl_tasklocal_genrandom(
			(jl_task_t *) eval_value(args[5], s)
		);
	return jl_box_uint32(result);
	...
	return jl_box_int16(result);
} else if (strcmp(target, "jl_enqueue_task") == 0) {
	int result = jl_enqueue_task(
			(jl_task_t *) eval_value(args[5], s)
		);
	return jl_box_int32(result);
	...
	*(void**)jl_data_ptr(v) = (void*)result;
	...
	int result = pcre2_set_character_tables_8(
			(pcre2_compile_context_8 *) jl_unbox_voidpointer(eval_value(args[5], s)),
			(const uint8_t *) jl_unbox_voidpointer(eval_value(args[6], s))
		);
	return jl_box_int32(result);
	...
	*(void**)jl_data_ptr(v) = (void*)result;
	...
	return jl_nothing;
} else if (strcmp(target, "pcre2_set_substitute_callout_8") == 0) {
	int result = pcre2_set_substitute_callout_8(
			(pcre2_match_context_8 *) jl_unbox_voidpointer(eval_value(args[5], s)),
			(int (*)(pcre2_substitute_callout_block_8 *, void *)) jl_unbox_voidpointer(eval_value(args[6], s)),
			(void *) jl_unbox_voidpointer(eval_value(args[7], s))
		);
	return jl_box_int32(result);
...
} else if (strcmp(target, "pcre2_get_match_data_size_8") == 0) {
	size_t result = pcre2_get_match_data_size_8(
			(pcre2_match_data_8 *) jl_unbox_voidpointer(eval_value(args[5], s))
		);
	return jl_box_uint32(result);
...
} else if (strcmp(target, "pcre2_maketables_free_8") == 0) {
	...
	*(void**)jl_data_ptr(v) = (void*)result;
	...
	return jl_nothing;
} else if (strcmp(target, "pcre2_set_substitute_callout_16") == 0) {
	int result = pcre2_set_substitute_callout_16(
			(pcre2_match_context_16 *) jl_unbox_voidpointer(eval_value(args[5], s)),
			(int (*)(pcre2_substitute_callout_block_16 *, void *)) jl_unbox_voidpointer(eval_value(args[6], s)),
			(void *) jl_unbox_voidpointer(eval_value(args[7], s))
		);
	return jl_box_int32(result);
...
} else if (strcmp(target, "pcre2_get_match_data_size_16") == 0) {
	size_t result = pcre2_get_match_data_size_16(
			(pcre2_match_data_16 *) jl_unbox_voidpointer(eval_value(args[5], s))
		);
	return jl_box_uint32(result);
...
} else if (strcmp(target, "pcre2_maketables_free_16") == 0) {
	...
	*(void**)jl_data_ptr(v) = (void*)result;
	...
	return jl_nothing;
} else if (strcmp(target, "pcre2_set_substitute_callout_32") == 0) {
	int result = pcre2_set_substitute_callout_32(
			(pcre2_match_context_32 *) jl_unbox_voidpointer(eval_value(args[5], s)),
			(int (*)(pcre2_substitute_callout_block_32 *, void *)) jl_unbox_voidpointer(eval_value(args[6], s)),
			(void *) jl_unbox_voidpointer(eval_value(args[7], s))
		);
	return jl_box_int32(result);
...
} else if (strcmp(target, "pcre2_get_match_data_size_32") == 0) {
	size_t result = pcre2_get_match_data_size_32(
			(pcre2_match_data_32 *) jl_unbox_voidpointer(eval_value(args[5], s))
		);
	return jl_box_uint32(result);
...
} else if (strcmp(target, "pcre2_maketables_free_32") == 0) {
	...
	*(void**)jl_data_ptr(v) = (void*)result;
	...
	return jl_box_int32(result);
} else if (strcmp(target, "utf8proc_islower") == 0) {
	int result = utf8proc_islower(
			(utf8proc_int32_t) jl_unbox_int32(eval_value(args[5], s))
		);
	return jl_box_int32(result);
} else if (strcmp(target, "utf8proc_isupper") == 0) {
	int result = utf8proc_isupper(
			(utf8proc_int32_t) jl_unbox_int32(eval_value(args[5], s))
		);
	return jl_box_int32(result);
	...
	*(void**)jl_data_ptr(v) = (void*)result;
	...
	return jl_box_long(result);
} else if (strcmp(target, "__gmpn_gcd_11") == 0) {
	mp_limb_t result = __gmpn_gcd_11(
			(mp_limb_t) jl_unbox_uint32(eval_value(args[5], s)),
			(mp_limb_t) jl_unbox_uint32(eval_value(args[6], s))
		);
	return jl_box_uint32(result);
	...
	*(void**)jl_data_ptr(v) = (void*)result;
	...
	return jl_box_uint32(result);
} else if (strcmp(target, "mpfr_get_str_ndigits") == 0) {
	size_t result = mpfr_get_str_ndigits(
			(int) jl_unbox_int32(eval_value(args[5], s)),
			(mpfr_prec_t) jl_unbox_long(eval_value(args[6], s))
		);
	return jl_box_uint32(result);
	...
	*(void**)jl_data_ptr(v) = (void*)result;
	...
	return jl_box_int32(result);
} else if (strcmp(target, "mpfr_cmpabs_ui") == 0) {
	int result = mpfr_cmpabs_ui(
			(mpfr_srcptr) jl_unbox_voidpointer(eval_value(args[5], s)),
			(unsigned long) jl_unbox_uint32(eval_value(args[6], s))
		);
	return jl_box_int32(result);
	...
	return jl_box_int32(result);
} else if (strcmp(target, "mpfr_dot") == 0) {
	int result = mpfr_dot(
			(mpfr_ptr) jl_unbox_voidpointer(eval_value(args[5], s)),
			(const mpfr_ptr *) jl_unbox_voidpointer(eval_value(args[6], s)),
			(const mpfr_ptr *) jl_unbox_voidpointer(eval_value(args[7], s)),
			(unsigned long) jl_unbox_uint32(eval_value(args[8], s)),
			(mpfr_rnd_t) jl_unbox_int32(eval_value(args[9], s))
		);
	return jl_box_int32(result);
	...
	*(void**)jl_data_ptr(v) = (void*)result;
	...
	return jl_box_int32(result);
} else if (strcmp(target, "mpfr_total_order_p") == 0) {
	int result = mpfr_total_order_p(
			(mpfr_srcptr) jl_unbox_voidpointer(eval_value(args[5], s)),
			(mpfr_srcptr) jl_unbox_voidpointer(eval_value(args[6], s))
		);
	return jl_box_int32(result);
	...
	*(void**)jl_data_ptr(v) = (void*)result;
	...
	return jl_box_float64(result);
} else if (strcmp(target, "emscripten_set_window_title") == 0) {
	emscripten_set_window_title(
			(const char *) jl_unbox_voidpointer(eval_value(args[5], s))
		);
	return jl_nothing;
} else if (strcmp(target, "emscripten_get_screen_size") == 0) {
	...
	emscripten_idb_async_load(
			...
			(const char *) jl_unbox_voidpointer(eval_value(args[6], s)),
			(void *) jl_unbox_voidpointer(eval_value(args[7], s)),
			(em_idb_onload_func) jl_unbox_voidpointer(eval_value(args[8], s)),
	...
	return jl_box_int32(result);
} else if (strcmp(target, "emscripten_has_asyncify") == 0) {
	int result = emscripten_has_asyncify();
	return jl_box_int32(result);
	...
	*(void**)jl_data_ptr(v) = (void*)result;
	...
	return jl_nothing;
} else if (strcmp(target, "emscripten_dlopen") == 0) {
	emscripten_dlopen(
			(const char *) jl_unbox_voidpointer(eval_value(args[5], s)),
			(int) jl_unbox_int32(eval_value(args[6], s)),
			(void *) jl_unbox_voidpointer(eval_value(args[7], s)),
			(em_dlopen_callback) jl_unbox_voidpointer(eval_value(args[8], s)),
			(em_arg_callback_func) jl_unbox_voidpointer(eval_value(args[9], s))
		);
	return jl_nothing;
} else if (strcmp(target, "emscripten_throw_number") == 0) {
	emscripten_throw_number(
			(double) jl_unbox_float64(eval_value(args[5], s))
		);
	return jl_nothing;
} else if (strcmp(target, "emscripten_throw_string") == 0) {
...
return (void*)&small_arraylist_grow; } 
else if (strcmp(target, "jl_threadid") == 0) {
...
return (void*)&jl_gc_disable_finalizers_internal; } 
else if (strcmp(target, "jl_gc_enable_finalizers_internal") == 0) {
return (void*)&jl_gc_enable_finalizers_internal; } 
else if (strcmp(target, "jl_gc_run_pending_finalizers") == 0) {
return (void*)&jl_gc_run_pending_finalizers; } 
else if (strcmp(target, "jl_wakeup_thread") == 0) {
...
return (void*)&jl_gc_queue_multiroot; } 
else if (strcmp(target, "jl_gc_managed_malloc") == 0) {
...
return (void*)&jl_egal__bits; } 
else if (strcmp(target, "jl_egal__special") == 0) {
return (void*)&jl_egal__special; } 
else if (strcmp(target, "jl_egal__unboxed") == 0) {
return (void*)&jl_egal__unboxed; } 
else if (strcmp(target, "jl_object_id") == 0) {
return (void*)&jl_object_id; } 
else if (strcmp(target, "jl_type_equality_is_identity") == 0) {
return (void*)&jl_type_equality_is_identity; } 
else if (strcmp(target, "jl_has_free_typevars") == 0) {
...
return (void*)&jl_apply_modify_type; } 
else if (strcmp(target, "jl_apply_cmpswap_type") == 0) {
return (void*)&jl_apply_cmpswap_type; } 
else if (strcmp(target, "jl_apply_tuple_type") == 0) {
...
return (void*)&jl_atomic_new_bits; } 
else if (strcmp(target, "jl_atomic_store_bits") == 0) {
return (void*)&jl_atomic_store_bits; } 
else if (strcmp(target, "jl_atomic_swap_bits") == 0) {
return (void*)&jl_atomic_swap_bits; } 
else if (strcmp(target, "jl_atomic_bool_cmpswap_bits") == 0) {
return (void*)&jl_atomic_bool_cmpswap_bits; } 
else if (strcmp(target, "jl_atomic_cmpswap_bits") == 0) {
return (void*)&jl_atomic_cmpswap_bits; } 
else if (strcmp(target, "jl_new_struct") == 0) {
...
return (void*)&jl_box_uint8pointer; } 
else if (strcmp(target, "jl_box_ssavalue") == 0) {
...
return (void*)&jl_unbox_uint8pointer; } 
else if (strcmp(target, "jl_get_size") == 0) {
...
return (void*)&jl_array_validate_dims; } 
else if (strcmp(target, "jl_array_ptr") == 0) {
...
return (void*)&jl_set_module_optlevel; } 
else if (strcmp(target, "jl_get_module_optlevel") == 0) {
return (void*)&jl_get_module_optlevel; } 
else if (strcmp(target, "jl_set_module_compile") == 0) {
return (void*)&jl_set_module_compile; } 
else if (strcmp(target, "jl_get_module_compile") == 0) {
return (void*)&jl_get_module_compile; } 
else if (strcmp(target, "jl_set_module_infer") == 0) {
return (void*)&jl_set_module_infer; } 
else if (strcmp(target, "jl_get_module_infer") == 0) {
return (void*)&jl_get_module_infer; } 
else if (strcmp(target, "jl_set_module_max_methods") == 0) {
return (void*)&jl_set_module_max_methods; } 
else if (strcmp(target, "jl_get_module_max_methods") == 0) {
return (void*)&jl_get_module_max_methods; } 
else if (strcmp(target, "jl_get_binding") == 0) {
...
return (void*)&jl_module_use_as; } 
else if (strcmp(target, "jl_module_import") == 0) {
return (void*)&jl_module_import; } 
else if (strcmp(target, "jl_module_import_as") == 0) {
return (void*)&jl_module_import_as; } 
else if (strcmp(target, "jl_module_export") == 0) {
...
return (void*)&jl_set_newly_inferred; } 
else if (strcmp(target, "jl_save_incremental") == 0) {
...
return (void*)&jl_expand_with_loc_warn; } 
else if (strcmp(target, "jl_expand_in_world") == 0) {
return (void*)&jl_expand_in_world; } 
else if (strcmp(target, "jl_expand_stmt") == 0) {
...
return (void*)&jl_compress_ir; } 
else if (strcmp(target, "jl_uncompress_ir") == 0) {
return (void*)&jl_uncompress_ir; } 
else if (strcmp(target, "jl_ir_flag_inferred") == 0) {
return (void*)&jl_ir_flag_inferred; } 
else if (strcmp(target, "jl_ir_flag_inlineable") == 0) {
return (void*)&jl_ir_flag_inlineable; } 
else if (strcmp(target, "jl_ir_flag_pure") == 0) {
return (void*)&jl_ir_flag_pure; } 
else if (strcmp(target, "jl_ir_nslots") == 0) {
return (void*)&jl_ir_nslots; } 
else if (strcmp(target, "jl_ir_slotflag") == 0) {
return (void*)&jl_ir_slotflag; } 
else if (strcmp(target, "jl_compress_argnames") == 0) {
...
return (void*)&jl_is_syntactic_operator; } 
else if (strcmp(target, "jl_operator_precedence") == 0) {
...
return (void*)&jl_process_events; } 
else if (strcmp(target, "jl_global_event_loop") == 0) {
return (void*)&jl_global_event_loop; } 
else if (strcmp(target, "jl_close_uv") == 0) {
return (void*)&jl_close_uv; } 
else if (strcmp(target, "jl_take_buffer") == 0) {
...
return (void*)&jl_print_backtrace; } 
else if (strcmp(target, "jlbacktrace") == 0) {
...
return (void*)&jl_get_safe_restore; } 
else if (strcmp(target, "jl_set_safe_restore") == 0) {
return (void*)&jl_set_safe_restore; } 
else if (strcmp(target, "memhash") == 0) {
return (void*)&memhash; } 
else if (strcmp(target, "memhash_seed") == 0) {
...
return (void*)&jl_start_alloc_profile; } 
else if (strcmp(target, "jl_stop_alloc_profile") == 0) {
return (void*)&jl_stop_alloc_profile; } 
else if (strcmp(target, "jl_free_alloc_profile") == 0) {
return (void*)&jl_free_alloc_profile; } 
else if (strcmp(target, "uv_version") == 0) {
return (void*)&uv_version; } 
else if (strcmp(target, "uv_version_string") == 0) {
return (void*)&uv_version_string; } 
else if (strcmp(target, "uv_library_shutdown") == 0) {
return (void*)&uv_library_shutdown; } 
else if (strcmp(target, "uv_replace_allocator") == 0) {
return (void*)&uv_replace_allocator; } 
else if (strcmp(target, "uv_default_loop") == 0) {
return (void*)&uv_default_loop; } 
else if (strcmp(target, "uv_loop_init") == 0) {
return (void*)&uv_loop_init; } 
else if (strcmp(target, "uv_loop_close") == 0) {
return (void*)&uv_loop_close; } 
else if (strcmp(target, "uv_loop_new") == 0) {
return (void*)&uv_loop_new; } 
else if (strcmp(target, "uv_loop_delete") == 0) {
return (void*)&uv_loop_delete; } 
else if (strcmp(target, "uv_loop_size") == 0) {
return (void*)&uv_loop_size; } 
else if (strcmp(target, "uv_loop_alive") == 0) {
return (void*)&uv_loop_alive; } 
else if (strcmp(target, "uv_loop_configure") == 0) {
return (void*)&uv_loop_configure; } 
else if (strcmp(target, "uv_run") == 0) {
return (void*)&uv_run; } 
else if (strcmp(target, "uv_stop") == 0) {
return (void*)&uv_stop; } 
...
return (void*)&uv_unref; } 
else if (strcmp(target, "uv_has_ref") == 0) {
return (void*)&uv_has_ref; } 
else if (strcmp(target, "uv_update_time") == 0) {
return (void*)&uv_update_time; } 
else if (strcmp(target, "uv_now") == 0) {
return (void*)&uv_now; } 
else if (strcmp(target, "uv_backend_fd") == 0) {
return (void*)&uv_backend_fd; } 
else if (strcmp(target, "uv_backend_timeout") == 0) {
return (void*)&uv_backend_timeout; } 
else if (strcmp(target, "uv_translate_sys_error") == 0) {
return (void*)&uv_translate_sys_error; } 
else if (strcmp(target, "uv_strerror") == 0) {
return (void*)&uv_strerror; } 
else if (strcmp(target, "uv_strerror_r") == 0) {
return (void*)&uv_strerror_r; } 
else if (strcmp(target, "uv_err_name") == 0) {
return (void*)&uv_err_name; } 
else if (strcmp(target, "uv_err_name_r") == 0) {
return (void*)&uv_err_name_r; } 
else if (strcmp(target, "uv_shutdown") == 0) {
return (void*)&uv_shutdown; } 
else if (strcmp(target, "uv_handle_size") == 0) {
return (void*)&uv_handle_size; } 
else if (strcmp(target, "uv_handle_get_type") == 0) {
return (void*)&uv_handle_get_type; } 
else if (strcmp(target, "uv_handle_type_name") == 0) {
return (void*)&uv_handle_type_name; } 
else if (strcmp(target, "uv_handle_get_data") == 0) {
return (void*)&uv_handle_get_data; } 
else if (strcmp(target, "uv_handle_get_loop") == 0) {
return (void*)&uv_handle_get_loop; } 
else if (strcmp(target, "uv_handle_set_data") == 0) {
return (void*)&uv_handle_set_data; } 
else if (strcmp(target, "uv_req_size") == 0) {
return (void*)&uv_req_size; } 
else if (strcmp(target, "uv_req_get_data") == 0) {
return (void*)&uv_req_get_data; } 
else if (strcmp(target, "uv_req_set_data") == 0) {
return (void*)&uv_req_set_data; } 
else if (strcmp(target, "uv_req_get_loop") == 0) {
return (void*)&uv_req_get_loop; } 
else if (strcmp(target, "uv_req_get_type") == 0) {
return (void*)&uv_req_get_type; } 
else if (strcmp(target, "uv_req_type_name") == 0) {
return (void*)&uv_req_type_name; } 
else if (strcmp(target, "uv_is_active") == 0) {
return (void*)&uv_is_active; } 
else if (strcmp(target, "uv_walk") == 0) {
return (void*)&uv_walk; } 
else if (strcmp(target, "uv_print_all_handles") == 0) {
return (void*)&uv_print_all_handles; } 
else if (strcmp(target, "uv_print_active_handles") == 0) {
return (void*)&uv_print_active_handles; } 
else if (strcmp(target, "uv_close") == 0) {
return (void*)&uv_close; } 
else if (strcmp(target, "uv_send_buffer_size") == 0) {
return (void*)&uv_send_buffer_size; } 
else if (strcmp(target, "uv_recv_buffer_size") == 0) {
return (void*)&uv_recv_buffer_size; } 
else if (strcmp(target, "uv_fileno") == 0) {
return (void*)&uv_fileno; } 
else if (strcmp(target, "uv_pipe") == 0) {
return (void*)&uv_pipe; } 
else if (strcmp(target, "uv_socketpair") == 0) {
return (void*)&uv_socketpair; } 
else if (strcmp(target, "uv_stream_get_write_queue_size") == 0) {
return (void*)&uv_stream_get_write_queue_size; } 
else if (strcmp(target, "uv_listen") == 0) {
return (void*)&uv_listen; } 
else if (strcmp(target, "uv_accept") == 0) {
return (void*)&uv_accept; } 
else if (strcmp(target, "uv_read_start") == 0) {
return (void*)&uv_read_start; } 
else if (strcmp(target, "uv_read_stop") == 0) {
return (void*)&uv_read_stop; } 
else if (strcmp(target, "uv_write") == 0) {
return (void*)&uv_write; } 
else if (strcmp(target, "uv_write2") == 0) {
return (void*)&uv_write2; } 
else if (strcmp(target, "uv_try_write") == 0) {
return (void*)&uv_try_write; } 
else if (strcmp(target, "uv_try_write2") == 0) {
return (void*)&uv_try_write2; } 
else if (strcmp(target, "uv_is_readable") == 0) {
return (void*)&uv_is_readable; } 
else if (strcmp(target, "uv_is_writable") == 0) {
return (void*)&uv_is_writable; } 
else if (strcmp(target, "uv_stream_set_blocking") == 0) {
return (void*)&uv_stream_set_blocking; } 
else if (strcmp(target, "uv_is_closing") == 0) {
return (void*)&uv_is_closing; } 
else if (strcmp(target, "uv_tcp_init") == 0) {
return (void*)&uv_tcp_init; } 
else if (strcmp(target, "uv_tcp_init_ex") == 0) {
return (void*)&uv_tcp_init_ex; } 
else if (strcmp(target, "uv_tcp_open") == 0) {
return (void*)&uv_tcp_open; } 
else if (strcmp(target, "uv_tcp_nodelay") == 0) {
return (void*)&uv_tcp_nodelay; } 
else if (strcmp(target, "uv_tcp_keepalive") == 0) {
return (void*)&uv_tcp_keepalive; } 
else if (strcmp(target, "uv_tcp_simultaneous_accepts") == 0) {
return (void*)&uv_tcp_simultaneous_accepts; } 
else if (strcmp(target, "uv_tcp_bind") == 0) {
return (void*)&uv_tcp_bind; } 
else if (strcmp(target, "uv_tcp_getsockname") == 0) {
return (void*)&uv_tcp_getsockname; } 
else if (strcmp(target, "uv_tcp_getpeername") == 0) {
return (void*)&uv_tcp_getpeername; } 
else if (strcmp(target, "uv_tcp_close_reset") == 0) {
return (void*)&uv_tcp_close_reset; } 
else if (strcmp(target, "uv_tcp_connect") == 0) {
return (void*)&uv_tcp_connect; } 
else if (strcmp(target, "uv_udp_init") == 0) {
return (void*)&uv_udp_init; } 
else if (strcmp(target, "uv_udp_init_ex") == 0) {
return (void*)&uv_udp_init_ex; } 
else if (strcmp(target, "uv_udp_open") == 0) {
return (void*)&uv_udp_open; } 
else if (strcmp(target, "uv_udp_bind") == 0) {
return (void*)&uv_udp_bind; } 
else if (strcmp(target, "uv_udp_connect") == 0) {
return (void*)&uv_udp_connect; } 
else if (strcmp(target, "uv_udp_getpeername") == 0) {
return (void*)&uv_udp_getpeername; } 
else if (strcmp(target, "uv_udp_getsockname") == 0) {
return (void*)&uv_udp_getsockname; } 
else if (strcmp(target, "uv_udp_set_membership") == 0) {
return (void*)&uv_udp_set_membership; } 
else if (strcmp(target, "uv_udp_set_source_membership") == 0) {
return (void*)&uv_udp_set_source_membership; } 
else if (strcmp(target, "uv_udp_set_multicast_loop") == 0) {
return (void*)&uv_udp_set_multicast_loop; } 
else if (strcmp(target, "uv_udp_set_multicast_ttl") == 0) {
return (void*)&uv_udp_set_multicast_ttl; } 
else if (strcmp(target, "uv_udp_set_multicast_interface") == 0) {
return (void*)&uv_udp_set_multicast_interface; } 
else if (strcmp(target, "uv_udp_set_broadcast") == 0) {
return (void*)&uv_udp_set_broadcast; } 
else if (strcmp(target, "uv_udp_set_ttl") == 0) {
return (void*)&uv_udp_set_ttl; } 
else if (strcmp(target, "uv_udp_send") == 0) {
return (void*)&uv_udp_send; } 
else if (strcmp(target, "uv_udp_try_send") == 0) {
return (void*)&uv_udp_try_send; } 
else if (strcmp(target, "uv_udp_recv_start") == 0) {
return (void*)&uv_udp_recv_start; } 
else if (strcmp(target, "uv_udp_using_recvmmsg") == 0) {
return (void*)&uv_udp_using_recvmmsg; } 
else if (strcmp(target, "uv_udp_recv_stop") == 0) {
return (void*)&uv_udp_recv_stop; } 
else if (strcmp(target, "uv_udp_get_send_queue_size") == 0) {
return (void*)&uv_udp_get_send_queue_size; } 
else if (strcmp(target, "uv_udp_get_send_queue_count") == 0) {
return (void*)&uv_udp_get_send_queue_count; } 
else if (strcmp(target, "uv_tty_init") == 0) {
return (void*)&uv_tty_init; } 
else if (strcmp(target, "uv_tty_set_mode") == 0) {
return (void*)&uv_tty_set_mode; } 
else if (strcmp(target, "uv_tty_reset_mode") == 0) {
return (void*)&uv_tty_reset_mode; } 
else if (strcmp(target, "uv_tty_get_winsize") == 0) {
return (void*)&uv_tty_get_winsize; } 
else if (strcmp(target, "uv_tty_set_vterm_state") == 0) {
return (void*)&uv_tty_set_vterm_state; } 
else if (strcmp(target, "uv_tty_get_vterm_state") == 0) {
return (void*)&uv_tty_get_vterm_state; } 
else if (strcmp(target, "uv_guess_handle") == 0) {
return (void*)&uv_guess_handle; } 
else if (strcmp(target, "uv_pipe_init") == 0) {
return (void*)&uv_pipe_init; } 
else if (strcmp(target, "uv_pipe_open") == 0) {
return (void*)&uv_pipe_open; } 
else if (strcmp(target, "uv_pipe_bind") == 0) {
return (void*)&uv_pipe_bind; } 
else if (strcmp(target, "uv_pipe_connect") == 0) {
return (void*)&uv_pipe_connect; } 
else if (strcmp(target, "uv_pipe_getsockname") == 0) {
return (void*)&uv_pipe_getsockname; } 
else if (strcmp(target, "uv_pipe_getpeername") == 0) {
return (void*)&uv_pipe_getpeername; } 
else if (strcmp(target, "uv_pipe_pending_instances") == 0) {
return (void*)&uv_pipe_pending_instances; } 
else if (strcmp(target, "uv_pipe_pending_count") == 0) {
return (void*)&uv_pipe_pending_count; } 
else if (strcmp(target, "uv_pipe_pending_type") == 0) {
return (void*)&uv_pipe_pending_type; } 
else if (strcmp(target, "uv_pipe_chmod") == 0) {
return (void*)&uv_pipe_chmod; } 
else if (strcmp(target, "uv_poll_init") == 0) {
return (void*)&uv_poll_init; } 
else if (strcmp(target, "uv_poll_start") == 0) {
return (void*)&uv_poll_start; } 
else if (strcmp(target, "uv_poll_stop") == 0) {
return (void*)&uv_poll_stop; } 
else if (strcmp(target, "uv_prepare_init") == 0) {
return (void*)&uv_prepare_init; } 
else if (strcmp(target, "uv_prepare_start") == 0) {
return (void*)&uv_prepare_start; } 
else if (strcmp(target, "uv_prepare_stop") == 0) {
return (void*)&uv_prepare_stop; } 
else if (strcmp(target, "uv_check_init") == 0) {
return (void*)&uv_check_init; } 
else if (strcmp(target, "uv_check_start") == 0) {
return (void*)&uv_check_start; } 
else if (strcmp(target, "uv_check_stop") == 0) {
return (void*)&uv_check_stop; } 
else if (strcmp(target, "uv_idle_init") == 0) {
return (void*)&uv_idle_init; } 
else if (strcmp(target, "uv_idle_start") == 0) {
return (void*)&uv_idle_start; } 
else if (strcmp(target, "uv_idle_stop") == 0) {
return (void*)&uv_idle_stop; } 
else if (strcmp(target, "uv_async_init") == 0) {
return (void*)&uv_async_init; } 
else if (strcmp(target, "uv_async_send") == 0) {
return (void*)&uv_async_send; } 
else if (strcmp(target, "uv_timer_init") == 0) {
return (void*)&uv_timer_init; } 
else if (strcmp(target, "uv_timer_start") == 0) {
return (void*)&uv_timer_start; } 
else if (strcmp(target, "uv_timer_stop") == 0) {
return (void*)&uv_timer_stop; } 
else if (strcmp(target, "uv_timer_again") == 0) {
return (void*)&uv_timer_again; } 
else if (strcmp(target, "uv_timer_set_repeat") == 0) {
return (void*)&uv_timer_set_repeat; } 
else if (strcmp(target, "uv_timer_get_repeat") == 0) {
return (void*)&uv_timer_get_repeat; } 
else if (strcmp(target, "uv_timer_get_due_in") == 0) {
return (void*)&uv_timer_get_due_in; } 
else if (strcmp(target, "uv_getaddrinfo") == 0) {
return (void*)&uv_getaddrinfo; } 
else if (strcmp(target, "uv_freeaddrinfo") == 0) {
return (void*)&uv_freeaddrinfo; } 
else if (strcmp(target, "uv_getnameinfo") == 0) {
return (void*)&uv_getnameinfo; } 
else if (strcmp(target, "uv_spawn") == 0) {
return (void*)&uv_spawn; } 
else if (strcmp(target, "uv_process_kill") == 0) {
return (void*)&uv_process_kill; } 
else if (strcmp(target, "uv_kill") == 0) {
return (void*)&uv_kill; } 
else if (strcmp(target, "uv_process_get_pid") == 0) {
return (void*)&uv_process_get_pid; } 
else if (strcmp(target, "uv_queue_work") == 0) {
return (void*)&uv_queue_work; } 
else if (strcmp(target, "uv_cancel") == 0) {
return (void*)&uv_cancel; } 
else if (strcmp(target, "uv_setup_args") == 0) {
return (void*)&uv_setup_args; } 
else if (strcmp(target, "uv_get_process_title") == 0) {
return (void*)&uv_get_process_title; } 
else if (strcmp(target, "uv_set_process_title") == 0) {
return (void*)&uv_set_process_title; } 
else if (strcmp(target, "uv_resident_set_memory") == 0) {
return (void*)&uv_resident_set_memory; } 
else if (strcmp(target, "uv_uptime") == 0) {
return (void*)&uv_uptime; } 
else if (strcmp(target, "uv_getrusage") == 0) {
return (void*)&uv_getrusage; } 
else if (strcmp(target, "uv_os_homedir") == 0) {
return (void*)&uv_os_homedir; } 
else if (strcmp(target, "uv_os_tmpdir") == 0) {
return (void*)&uv_os_tmpdir; } 
else if (strcmp(target, "uv_os_get_passwd") == 0) {
return (void*)&uv_os_get_passwd; } 
else if (strcmp(target, "uv_os_free_passwd") == 0) {
return (void*)&uv_os_free_passwd; } 
else if (strcmp(target, "uv_os_get_passwd2") == 0) {
return (void*)&uv_os_get_passwd2; } 
else if (strcmp(target, "uv_os_get_group") == 0) {
return (void*)&uv_os_get_group; } 
else if (strcmp(target, "uv_os_free_group") == 0) {
return (void*)&uv_os_free_group; } 
else if (strcmp(target, "uv_os_getpid") == 0) {
return (void*)&uv_os_getpid; } 
else if (strcmp(target, "uv_os_getppid") == 0) {
return (void*)&uv_os_getppid; } 
else if (strcmp(target, "uv_os_getpriority") == 0) {
return (void*)&uv_os_getpriority; } 
else if (strcmp(target, "uv_os_setpriority") == 0) {
return (void*)&uv_os_setpriority; } 
else if (strcmp(target, "uv_available_parallelism") == 0) {
return (void*)&uv_available_parallelism; } 
else if (strcmp(target, "uv_cpu_info") == 0) {
return (void*)&uv_cpu_info; } 
else if (strcmp(target, "uv_free_cpu_info") == 0) {
return (void*)&uv_free_cpu_info; } 
else if (strcmp(target, "uv_cpumask_size") == 0) {
return (void*)&uv_cpumask_size; } 
else if (strcmp(target, "uv_interface_addresses") == 0) {
return (void*)&uv_interface_addresses; } 
else if (strcmp(target, "uv_free_interface_addresses") == 0) {
return (void*)&uv_free_interface_addresses; } 
else if (strcmp(target, "uv_os_environ") == 0) {
return (void*)&uv_os_environ; } 
else if (strcmp(target, "uv_os_free_environ") == 0) {
return (void*)&uv_os_free_environ; } 
else if (strcmp(target, "uv_os_getenv") == 0) {
return (void*)&uv_os_getenv; } 
else if (strcmp(target, "uv_os_setenv") == 0) {
return (void*)&uv_os_setenv; } 
else if (strcmp(target, "uv_os_unsetenv") == 0) {
return (void*)&uv_os_unsetenv; } 
else if (strcmp(target, "uv_os_gethostname") == 0) {
return (void*)&uv_os_gethostname; } 
else if (strcmp(target, "uv_os_uname") == 0) {
return (void*)&uv_os_uname; } 
else if (strcmp(target, "uv_metrics_idle_time") == 0) {
return (void*)&uv_metrics_idle_time; } 
else if (strcmp(target, "uv_fs_get_type") == 0) {
return (void*)&uv_fs_get_type; } 
else if (strcmp(target, "uv_fs_get_result") == 0) {
return (void*)&uv_fs_get_result; } 
else if (strcmp(target, "uv_fs_get_system_error") == 0) {
return (void*)&uv_fs_get_system_error; } 
else if (strcmp(target, "uv_fs_get_ptr") == 0) {
return (void*)&uv_fs_get_ptr; } 
else if (strcmp(target, "uv_fs_get_path") == 0) {
return (void*)&uv_fs_get_path; } 
else if (strcmp(target, "uv_fs_get_statbuf") == 0) {
return (void*)&uv_fs_get_statbuf; } 
else if (strcmp(target, "uv_fs_req_cleanup") == 0) {
return (void*)&uv_fs_req_cleanup; } 
else if (strcmp(target, "uv_fs_close") == 0) {
return (void*)&uv_fs_close; } 
else if (strcmp(target, "uv_fs_open") == 0) {
return (void*)&uv_fs_open; } 
else if (strcmp(target, "uv_fs_read") == 0) {
return (void*)&uv_fs_read; } 
else if (strcmp(target, "uv_fs_unlink") == 0) {
return (void*)&uv_fs_unlink; } 
else if (strcmp(target, "uv_fs_write") == 0) {
return (void*)&uv_fs_write; } 
else if (strcmp(target, "uv_fs_copyfile") == 0) {
return (void*)&uv_fs_copyfile; } 
else if (strcmp(target, "uv_fs_mkdir") == 0) {
return (void*)&uv_fs_mkdir; } 
else if (strcmp(target, "uv_fs_mkdtemp") == 0) {
return (void*)&uv_fs_mkdtemp; } 
else if (strcmp(target, "uv_fs_mkstemp") == 0) {
return (void*)&uv_fs_mkstemp; } 
else if (strcmp(target, "uv_fs_rmdir") == 0) {
return (void*)&uv_fs_rmdir; } 
else if (strcmp(target, "uv_fs_scandir") == 0) {
return (void*)&uv_fs_scandir; } 
else if (strcmp(target, "uv_fs_scandir_next") == 0) {
return (void*)&uv_fs_scandir_next; } 
else if (strcmp(target, "uv_fs_opendir") == 0) {
return (void*)&uv_fs_opendir; } 
else if (strcmp(target, "uv_fs_readdir") == 0) {
return (void*)&uv_fs_readdir; } 
else if (strcmp(target, "uv_fs_closedir") == 0) {
return (void*)&uv_fs_closedir; } 
else if (strcmp(target, "uv_fs_stat") == 0) {
return (void*)&uv_fs_stat; } 
else if (strcmp(target, "uv_fs_fstat") == 0) {
return (void*)&uv_fs_fstat; } 
else if (strcmp(target, "uv_fs_rename") == 0) {
return (void*)&uv_fs_rename; } 
else if (strcmp(target, "uv_fs_fsync") == 0) {
return (void*)&uv_fs_fsync; } 
else if (strcmp(target, "uv_fs_fdatasync") == 0) {
return (void*)&uv_fs_fdatasync; } 
else if (strcmp(target, "uv_fs_ftruncate") == 0) {
return (void*)&uv_fs_ftruncate; } 
else if (strcmp(target, "uv_fs_sendfile") == 0) {
return (void*)&uv_fs_sendfile; } 
else if (strcmp(target, "uv_fs_access") == 0) {
return (void*)&uv_fs_access; } 
else if (strcmp(target, "uv_fs_chmod") == 0) {
return (void*)&uv_fs_chmod; } 
else if (strcmp(target, "uv_fs_utime") == 0) {
return (void*)&uv_fs_utime; } 
else if (strcmp(target, "uv_fs_utime_ex") == 0) {
return (void*)&uv_fs_utime_ex; } 
else if (strcmp(target, "uv_fs_futime") == 0) {
return (void*)&uv_fs_futime; } 
else if (strcmp(target, "uv_fs_futime_ex") == 0) {
return (void*)&uv_fs_futime_ex; } 
else if (strcmp(target, "uv_fs_lutime") == 0) {
return (void*)&uv_fs_lutime; } 
else if (strcmp(target, "uv_fs_lstat") == 0) {
return (void*)&uv_fs_lstat; } 
else if (strcmp(target, "uv_fs_link") == 0) {
return (void*)&uv_fs_link; } 
else if (strcmp(target, "uv_fs_symlink") == 0) {
return (void*)&uv_fs_symlink; } 
else if (strcmp(target, "uv_fs_readlink") == 0) {
return (void*)&uv_fs_readlink; } 
else if (strcmp(target, "uv_fs_realpath") == 0) {
return (void*)&uv_fs_realpath; } 
else if (strcmp(target, "uv_fs_fchmod") == 0) {
return (void*)&uv_fs_fchmod; } 
else if (strcmp(target, "uv_fs_chown") == 0) {
return (void*)&uv_fs_chown; } 
else if (strcmp(target, "uv_fs_fchown") == 0) {
return (void*)&uv_fs_fchown; } 
else if (strcmp(target, "uv_fs_lchown") == 0) {
return (void*)&uv_fs_lchown; } 
else if (strcmp(target, "uv_fs_statfs") == 0) {
return (void*)&uv_fs_statfs; } 
else if (strcmp(target, "uv_fs_poll_init") == 0) {
return (void*)&uv_fs_poll_init; } 
else if (strcmp(target, "uv_fs_poll_start") == 0) {
return (void*)&uv_fs_poll_start; } 
else if (strcmp(target, "uv_fs_poll_stop") == 0) {
return (void*)&uv_fs_poll_stop; } 
else if (strcmp(target, "uv_fs_poll_getpath") == 0) {
return (void*)&uv_fs_poll_getpath; } 
else if (strcmp(target, "uv_signal_init") == 0) {
return (void*)&uv_signal_init; } 
else if (strcmp(target, "uv_signal_start") == 0) {
return (void*)&uv_signal_start; } 
else if (strcmp(target, "uv_signal_start_oneshot") == 0) {
return (void*)&uv_signal_start_oneshot; } 
else if (strcmp(target, "uv_signal_stop") == 0) {
return (void*)&uv_signal_stop; } 
else if (strcmp(target, "uv_loadavg") == 0) {
return (void*)&uv_loadavg; } 
else if (strcmp(target, "uv_fs_event_init") == 0) {
return (void*)&uv_fs_event_init; } 
else if (strcmp(target, "uv_fs_event_start") == 0) {
return (void*)&uv_fs_event_start; } 
else if (strcmp(target, "uv_fs_event_stop") == 0) {
return (void*)&uv_fs_event_stop; } 
else if (strcmp(target, "uv_fs_event_getpath") == 0) {
return (void*)&uv_fs_event_getpath; } 
else if (strcmp(target, "uv_ip4_addr") == 0) {
return (void*)&uv_ip4_addr; } 
else if (strcmp(target, "uv_ip6_addr") == 0) {
return (void*)&uv_ip6_addr; } 
else if (strcmp(target, "uv_ip4_name") == 0) {
return (void*)&uv_ip4_name; } 
else if (strcmp(target, "uv_ip6_name") == 0) {
return (void*)&uv_ip6_name; } 
else if (strcmp(target, "uv_ip_name") == 0) {
return (void*)&uv_ip_name; } 
else if (strcmp(target, "uv_inet_ntop") == 0) {
return (void*)&uv_inet_ntop; } 
else if (strcmp(target, "uv_inet_pton") == 0) {
return (void*)&uv_inet_pton; } 
else if (strcmp(target, "uv_random") == 0) {
return (void*)&uv_random; } 
else if (strcmp(target, "uv_if_indextoname") == 0) {
return (void*)&uv_if_indextoname; } 
else if (strcmp(target, "uv_if_indextoiid") == 0) {
return (void*)&uv_if_indextoiid; } 
else if (strcmp(target, "uv_exepath") == 0) {
return (void*)&uv_exepath; } 
else if (strcmp(target, "uv_cwd") == 0) {
return (void*)&uv_cwd; } 
else if (strcmp(target, "uv_chdir") == 0) {
return (void*)&uv_chdir; } 
else if (strcmp(target, "uv_get_free_memory") == 0) {
return (void*)&uv_get_free_memory; } 
else if (strcmp(target, "uv_get_total_memory") == 0) {
return (void*)&uv_get_total_memory; } 
else if (strcmp(target, "uv_get_constrained_memory") == 0) {
return (void*)&uv_get_constrained_memory; } 
else if (strcmp(target, "uv_hrtime") == 0) {
return (void*)&uv_hrtime; } 
else if (strcmp(target, "uv_sleep") == 0) {
return (void*)&uv_sleep; } 
else if (strcmp(target, "uv_disable_stdio_inheritance") == 0) {
return (void*)&uv_disable_stdio_inheritance; } 
else if (strcmp(target, "uv_dlopen") == 0) {
return (void*)&uv_dlopen; } 
else if (strcmp(target, "uv_dlclose") == 0) {
return (void*)&uv_dlclose; } 
else if (strcmp(target, "uv_dlsym") == 0) {
return (void*)&uv_dlsym; } 
else if (strcmp(target, "uv_dlerror") == 0) {
return (void*)&uv_dlerror; } 
else if (strcmp(target, "uv_mutex_init") == 0) {
return (void*)&uv_mutex_init; } 
else if (strcmp(target, "uv_mutex_init_recursive") == 0) {
return (void*)&uv_mutex_init_recursive; } 
else if (strcmp(target, "uv_mutex_destroy") == 0) {
return (void*)&uv_mutex_destroy; } 
else if (strcmp(target, "uv_mutex_lock") == 0) {
return (void*)&uv_mutex_lock; } 
else if (strcmp(target, "uv_mutex_trylock") == 0) {
return (void*)&uv_mutex_trylock; } 
else if (strcmp(target, "uv_mutex_unlock") == 0) {
return (void*)&uv_mutex_unlock; } 
else if (strcmp(target, "uv_rwlock_init") == 0) {
return (void*)&uv_rwlock_init; } 
else if (strcmp(target, "uv_rwlock_destroy") == 0) {
return (void*)&uv_rwlock_destroy; } 
else if (strcmp(target, "uv_rwlock_rdlock") == 0) {
return (void*)&uv_rwlock_rdlock; } 
else if (strcmp(target, "uv_rwlock_tryrdlock") == 0) {
return (void*)&uv_rwlock_tryrdlock; } 
else if (strcmp(target, "uv_rwlock_rdunlock") == 0) {
return (void*)&uv_rwlock_rdunlock; } 
else if (strcmp(target, "uv_rwlock_wrlock") == 0) {
return (void*)&uv_rwlock_wrlock; } 
else if (strcmp(target, "uv_rwlock_trywrlock") == 0) {
return (void*)&uv_rwlock_trywrlock; } 
else if (strcmp(target, "uv_rwlock_wrunlock") == 0) {
return (void*)&uv_rwlock_wrunlock; } 
else if (strcmp(target, "uv_sem_init") == 0) {
return (void*)&uv_sem_init; } 
else if (strcmp(target, "uv_sem_destroy") == 0) {
return (void*)&uv_sem_destroy; } 
else if (strcmp(target, "uv_sem_post") == 0) {
return (void*)&uv_sem_post; } 
else if (strcmp(target, "uv_sem_wait") == 0) {
return (void*)&uv_sem_wait; } 
else if (strcmp(target, "uv_sem_trywait") == 0) {
return (void*)&uv_sem_trywait; } 
else if (strcmp(target, "uv_cond_init") == 0) {
return (void*)&uv_cond_init; } 
else if (strcmp(target, "uv_cond_destroy") == 0) {
return (void*)&uv_cond_destroy; } 
else if (strcmp(target, "uv_cond_signal") == 0) {
return (void*)&uv_cond_signal; } 
else if (strcmp(target, "uv_cond_broadcast") == 0) {
return (void*)&uv_cond_broadcast; } 
else if (strcmp(target, "uv_barrier_init") == 0) {
return (void*)&uv_barrier_init; } 
else if (strcmp(target, "uv_barrier_destroy") == 0) {
return (void*)&uv_barrier_destroy; } 
else if (strcmp(target, "uv_barrier_wait") == 0) {
return (void*)&uv_barrier_wait; } 
else if (strcmp(target, "uv_cond_wait") == 0) {
return (void*)&uv_cond_wait; } 
else if (strcmp(target, "uv_cond_timedwait") == 0) {
return (void*)&uv_cond_timedwait; } 
else if (strcmp(target, "uv_once") == 0) {
return (void*)&uv_once; } 
else if (strcmp(target, "uv_key_create") == 0) {
return (void*)&uv_key_create; } 
else if (strcmp(target, "uv_key_delete") == 0) {
return (void*)&uv_key_delete; } 
else if (strcmp(target, "uv_key_get") == 0) {
return (void*)&uv_key_get; } 
else if (strcmp(target, "uv_key_set") == 0) {
return (void*)&uv_key_set; } 
else if (strcmp(target, "uv_gettimeofday") == 0) {
return (void*)&uv_gettimeofday; } 
else if (strcmp(target, "uv_thread_create") == 0) {
return (void*)&uv_thread_create; } 
else if (strcmp(target, "uv_thread_create_ex") == 0) {
return (void*)&uv_thread_create_ex; } 
else if (strcmp(target, "uv_thread_setaffinity") == 0) {
return (void*)&uv_thread_setaffinity; } 
else if (strcmp(target, "uv_thread_getaffinity") == 0) {
return (void*)&uv_thread_getaffinity; } 
else if (strcmp(target, "uv_thread_detach") == 0) {
return (void*)&uv_thread_detach; } 
else if (strcmp(target, "uv_thread_join") == 0) {
return (void*)&uv_thread_join; } 
else if (strcmp(target, "uv_thread_self") == 0) {
return (void*)&uv_thread_self; } 
else if (strcmp(target, "uv_thread_equal") == 0) {
return (void*)&uv_thread_equal; } 
else if (strcmp(target, "uv_loop_get_data") == 0) {
return (void*)&uv_loop_get_data; } 
else if (strcmp(target, "uv_loop_set_data") == 0) {
return (void*)&uv_loop_set_data; } 
else if (strcmp(target, "jl_hrtime") == 0) {
return (void*)&jl_hrtime; } 
else if (strcmp(target, "jl_set_peek_cond") == 0) {
return (void*)&jl_set_peek_cond; } 
else if (strcmp(target, "jl_get_profile_peek_duration") == 0) {
return (void*)&jl_get_profile_peek_duration; } 
else if (strcmp(target, "jl_set_profile_peek_duration") == 0) {
return (void*)&jl_set_profile_peek_duration; } 
else if (strcmp(target, "jl_gc_classify_pools") == 0) {
return (void*)&jl_gc_classify_pools; } 
else if (strcmp(target, "jl_alignment") == 0) {
...
return (void*)&jl_gc_sync_total_bytes; } 
else if (strcmp(target, "jl_gc_debug_critical_error") == 0) {
return (void*)&jl_gc_debug_critical_error; } 
else if (strcmp(target, "jl_type_infer") == 0) {
return (void*)&jl_type_infer; } 
else if (strcmp(target, "jl_compile_method_internal") == 0) {
return (void*)&jl_compile_method_internal; } 
else if (strcmp(target, "jl_get_method_inferred") == 0) {
...
return (void*)&jl_add_method_root; } 
else if (strcmp(target, "jl_apply_2va") == 0) {
return (void*)&jl_apply_2va; } 
else if (strcmp(target, "jl_get_exceptionf") == 0) {
return (void*)&jl_get_exceptionf; } 
else if (strcmp(target, "jl_get_keyword_sorter") == 0) {
...
return (void*)&jl_f_opaque_closure_call; } 
else if (strcmp(target, "jl_get_builtin_fptr") == 0) {
return (void*)&jl_get_builtin_fptr; } 
else if (strcmp(target, "jl_has_intersect_type_not_kind") == 0) {
return (void*)&jl_has_intersect_type_not_kind; } 
else if (strcmp(target, "jl_method_table_insert") == 0) {
return (void*)&jl_method_table_insert; } 
else if (strcmp(target, "jl_find_free_typevars") == 0) {
return (void*)&jl_find_free_typevars; } 
else if (strcmp(target, "jl_struct_try_layout") == 0) {
return (void*)&jl_struct_try_layout; } 
else if (strcmp(target, "jl_type_mappable_to_c") == 0) {
return (void*)&jl_type_mappable_to_c; } 
else if (strcmp(target, "jl_types_egal") == 0) {
return (void*)&jl_types_egal; } 
else if (strcmp(target, "jl_type_morespecific_no_subtype") == 0) {
return (void*)&jl_type_morespecific_no_subtype; } 
else if (strcmp(target, "jl_instantiate_type_in_env") == 0) {
return (void*)&jl_instantiate_type_in_env; } 
else if (strcmp(target, "jl_unwrap_unionall") == 0) {
return (void*)&jl_unwrap_unionall; } 
else if (strcmp(target, "jl_rewrap_unionall") == 0) {
return (void*)&jl_rewrap_unionall; } 
else if (strcmp(target, "jl_nth_union_component") == 0) {
return (void*)&jl_nth_union_component; } 
else if (strcmp(target, "jl_wrap_Type") == 0) {
return (void*)&jl_wrap_Type; } 
else if (strcmp(target, "jl_is_submodule") == 0) {
return (void*)&jl_is_submodule; } 
else if (strcmp(target, "jl_datatype_isinlinealloc") == 0) {
return (void*)&jl_datatype_isinlinealloc; } 
else if (strcmp(target, "jl_is_toplevel_only_expr") == 0) {
return (void*)&jl_is_toplevel_only_expr; } 
else if (strcmp(target, "jl_matching_methods") == 0) {
...
return (void*)&jl_method_get_table; } 
else if (strcmp(target, "jl_pointer_egal") == 0) {
return (void*)&jl_pointer_egal; } 
else if (strcmp(target, "jl_nth_slot_type") == 0) {
return (void*)&jl_nth_slot_type; } 
else if (strcmp(target, "jl_binding_deprecation_warning") == 0) {
return (void*)&jl_binding_deprecation_warning; } 
else if (strcmp(target, "jl_is_valid_oc_argtype") == 0) {
return (void*)&jl_is_valid_oc_argtype; } 
else if (strcmp(target, "jl_init_options") == 0) {
return (void*)&jl_init_options; } 
else if (strcmp(target, "jl_pgcstack_getkey") == 0) {
return (void*)&jl_pgcstack_getkey; } 
else if (strcmp(target, "jl_dump_method_asm") == 0) {
return (void*)&jl_dump_method_asm; } 
else if (strcmp(target, "jl_dump_fptr_asm") == 0) {
...
return (void*)&jl_get_ee_context; } 
else if (strcmp(target, "jl_get_function_id") == 0) {
return (void*)&jl_get_function_id; } 
else if (strcmp(target, "jl_idtable_rehash") == 0) {
...
return (void*)&jl_get_specialization1; } 
else if (strcmp(target, "jl_rettype_inferred") == 0) {
return (void*)&jl_rettype_inferred; } 
else if (strcmp(target, "jl_method_compiled") == 0) {
return (void*)&jl_method_compiled; } 
else if (strcmp(target, "jl_methtable_lookup") == 0) {
...
return (void*)&jl_atomic_fence; } 
else if (strcmp(target, "jl_atomic_pointerref") == 0) {
return (void*)&jl_atomic_pointerref; } 
else if (strcmp(target, "jl_atomic_pointerset") == 0) {
return (void*)&jl_atomic_pointerset; } 
else if (strcmp(target, "jl_atomic_pointerswap") == 0) {
return (void*)&jl_atomic_pointerswap; } 
else if (strcmp(target, "jl_atomic_pointermodify") == 0) {
return (void*)&jl_atomic_pointermodify; } 
else if (strcmp(target, "jl_atomic_pointerreplace") == 0) {
return (void*)&jl_atomic_pointerreplace; } 
else if (strcmp(target, "jl_cglobal") == 0) {
...
return (void*)&jl_have_fma; } 
else if (strcmp(target, "jl_stored_inline") == 0) {
return (void*)&jl_stored_inline; } 
else if (strcmp(target, "jl_array_data_owner") == 0) {
...
return (void*)&jl_set_next_task; } 
else if (strcmp(target, "jl_svec_len") == 0) {
return (void*)&jl_svec_len; } 
else if (strcmp(target, "jl_svec_isassigned") == 0) {
return (void*)&jl_svec_isassigned; } 
else if (strcmp(target, "jl_svec_ref") == 0) {
return (void*)&jl_svec_ref; } 
else if (strcmp(target, "jl_special_vector_alignment") == 0) {
return (void*)&jl_special_vector_alignment; } 
else if (strcmp(target, "jl_array_cconvert_cstring") == 0) {
return (void*)&jl_array_cconvert_cstring; } 
else if (strcmp(target, "jl_isabspath") == 0) {
return (void*)&jl_isabspath; } 
else if (strcmp(target, "jl_get_atomic_order") == 0) {
return (void*)&jl_get_atomic_order; } 
else if (strcmp(target, "jl_get_atomic_order_checked") == 0) {
return (void*)&jl_get_atomic_order_checked; } 
else if (strcmp(target, "jl_extern_c") == 0) {
...
return (void*)&jl_sizeof_uv_fs_t; } 
else if (strcmp(target, "jl_uv_fs_t_ptr") == 0) {
return (void*)&jl_uv_fs_t_ptr; } 
else if (strcmp(target, "jl_uv_fs_t_path") == 0) {
return (void*)&jl_uv_fs_t_path; } 
else if (strcmp(target, "jl_sizeof_stat") == 0) {
...
return (void*)&jl_getuid; } 
else if (strcmp(target, "jl_geteuid") == 0) {
return (void*)&jl_geteuid; } 
else if (strcmp(target, "jl_readuntil") == 0) {
...
return (void*)&jl_f__call_in_world; } 
else if (strcmp(target, "jl_f__call_in_world_total") == 0) {
return (void*)&jl_f__call_in_world_total; } 
else if (strcmp(target, "jl_f__call_latest") == 0) {
return (void*)&jl_f__call_latest; } 
else if (strcmp(target, "jl_f_replacefield") == 0) {
return (void*)&jl_f_replacefield; } 
else if (strcmp(target, "jl_f_const_arrayref") == 0) {
...
return (void*)&jl_f_swapfield; } 
else if (strcmp(target, "jl_f_throw") == 0) {
return (void*)&jl_f_throw; } 
else if (strcmp(target, "jl_f_typeassert") == 0) {
return (void*)&jl_f_typeassert; } 
else if (strcmp(target, "jl_f__typebody") == 0) {
return (void*)&jl_f__typebody; } 
else if (strcmp(target, "jl_f_typeof") == 0) {
return (void*)&jl_f_typeof; } 
else if (strcmp(target, "jl_f__typevar") == 0) {
return (void*)&jl_f__typevar; } 
else if (strcmp(target, "jl_f_donotdelete") == 0) {
return (void*)&jl_f_donotdelete; } 
else if (strcmp(target, "jl_f_invoke_kwsorter") == 0) {
return (void*)&jl_f_invoke_kwsorter; } 
else if (strcmp(target, "jl_f__structtype") == 0) {
return (void*)&jl_f__structtype; } 
else if (strcmp(target, "jl_f__abstracttype") == 0) {
return (void*)&jl_f__abstracttype; } 
else if (strcmp(target, "jl_f__primitivetype") == 0) {
return (void*)&jl_f__primitivetype; } 
else if (strcmp(target, "jl_f__setsuper") == 0) {
return (void*)&jl_f__setsuper; } 
else if (strcmp(target, "jl_f__equiv_typedef") == 0) {
return (void*)&jl_f__equiv_typedef; } 
else if (strcmp(target, "jl_f_get_binding_type") == 0) {
return (void*)&jl_f_get_binding_type; } 
else if (strcmp(target, "jl_f_set_binding_type") == 0) {
return (void*)&jl_f_set_binding_type; } 
else if (strcmp(target, "jl_test_cpu_feature") == 0) {
return (void*)&jl_test_cpu_feature; } 
else if (strcmp(target, "jl_get_cpu_name") == 0) {
return (void*)&jl_get_cpu_name; } 
else if (strcmp(target, "jl_dump_host_cpu") == 0) {
return (void*)&jl_dump_host_cpu; } 
else if (strcmp(target, "jl_set_zero_subnormals") == 0) {
return (void*)&jl_set_zero_subnormals; } 
else if (strcmp(target, "jl_get_zero_subnormals") == 0) {
return (void*)&jl_get_zero_subnormals; } 
else if (strcmp(target, "jl_set_default_nans") == 0) {
return (void*)&jl_set_default_nans; } 
else if (strcmp(target, "jl_get_default_nans") == 0) {
return (void*)&jl_get_default_nans; } 
else if (strcmp(target, "jl_running_on_valgrind") == 0) {
return (void*)&jl_running_on_valgrind; } 
else if (strcmp(target, "ios_write_direct") == 0) {
return (void*)&ios_write_direct; } 
else if (strcmp(target, "jl_init__threading") == 0) {
return (void*)&jl_init__threading; } 
else if (strcmp(target, "jl_init_with_image__threading") == 0) {
return (void*)&jl_init_with_image__threading; } 
else if (strcmp(target, "jl_is_memdebug") == 0) {
...
return (void*)&jl_cumulative_compile_time_ns_before; } 
else if (strcmp(target, "jl_cumulative_compile_time_ns_after") == 0) {
return (void*)&jl_cumulative_compile_time_ns_after; } 
else if (strcmp(target, "jl_get_fenv_consts") == 0) {
return (void*)&jl_get_fenv_consts; } 
else if (strcmp(target, "jl_get_fenv_rounding") == 0) {
return (void*)&jl_get_fenv_rounding; } 
else if (strcmp(target, "jl_set_fenv_rounding") == 0) {
return (void*)&jl_set_fenv_rounding; } 
else if (strcmp(target, "jl_repl_entrypoint") == 0) {
return (void*)&jl_repl_entrypoint; } 
else if (strcmp(target, "jl_eqtable_pop") == 0) {
...
return (void*)&jl_clear_implicit_imports; } 
else if (strcmp(target, "jl_enable_gc_logging") == 0) {
return (void*)&jl_enable_gc_logging; } 
else if (strcmp(target, "jl_gc_set_cb_root_scanner") == 0) {
...
return (void*)&jl_is_foreign_type; } 
else if (strcmp(target, "jl_gc_max_internal_obj_size") == 0) {
...
return (void*)&jl_active_task_stack; } 
else if (strcmp(target, "jl_gc_get_finalizers_inhibited") == 0) {
return (void*)&jl_gc_get_finalizers_inhibited; } 
else if (strcmp(target, "jl_gc_add_finalizer_th") == 0) {
...
return (void*)&jl_profile_is_buffer_full; } 
else if (strcmp(target, "jl_exit_on_sigint") == 0) {
...
return (void*)&jl_new_codeinst; } 
else if (strcmp(target, "jl_mi_cache_insert") == 0) {
return (void*)&jl_mi_cache_insert; } 
else if (strcmp(target, "jl_call_in_typeinf_world") == 0) {
return (void*)&jl_call_in_typeinf_world; } 
else if (strcmp(target, "jl_set_typeinf_func") == 0) {
return (void*)&jl_set_typeinf_func; } 
else if (strcmp(target, "jl_debug_method_invalidation") == 0) {
return (void*)&jl_debug_method_invalidation; } 
else if (strcmp(target, "jl_method_table_disable") == 0) {
return (void*)&jl_method_table_disable; } 
else if (strcmp(target, "jl_normalize_to_compilable_sig") == 0) {
return (void*)&jl_normalize_to_compilable_sig; } 
else if (strcmp(target, "jl_gf_invoke_lookup") == 0) {
return (void*)&jl_gf_invoke_lookup; } 
else if (strcmp(target, "jl_gf_invoke_lookup_worlds") == 0) {
return (void*)&jl_gf_invoke_lookup_worlds; } 
else if (strcmp(target, "jl_typeinf_begin") == 0) {
return (void*)&jl_typeinf_begin; } 
else if (strcmp(target, "jl_typeinf_end") == 0) {
return (void*)&jl_typeinf_end; } 
else if (strcmp(target, "jl_get_next_task") == 0) {
return (void*)&jl_get_next_task; } 
else if (strcmp(target, "jl_switch") == 0) {
return (void*)&jl_switch; } 
else if (strcmp(target, "jl_tasklocal_genrandom") == 0) {
return (void*)&jl_tasklocal_genrandom; } 
else if (strcmp(target, "jl_is_task_started") == 0) {
return (void*)&jl_is_task_started; } 
else if (strcmp(target, "jl_get_task_tid") == 0) {
return (void*)&jl_get_task_tid; } 
else if (strcmp(target, "jl_enqueue_task") == 0) {
return (void*)&jl_enqueue_task; } 
else if (strcmp(target, "jl_task_get_next") == 0) {
...
return (void*)&pcre2_set_substitute_callout_8; } 
else if (strcmp(target, "pcre2_set_depth_limit_8") == 0) {
...
return (void*)&pcre2_get_match_data_size_8; } 
else if (strcmp(target, "pcre2_get_ovector_count_8") == 0) {
...
return (void*)&pcre2_maketables_free_8; } 
else if (strcmp(target, "pcre2_config_16") == 0) {
...
return (void*)&pcre2_set_substitute_callout_16; } 
else if (strcmp(target, "pcre2_set_depth_limit_16") == 0) {
...
return (void*)&pcre2_get_match_data_size_16; } 
else if (strcmp(target, "pcre2_get_ovector_count_16") == 0) {
...
return (void*)&pcre2_maketables_free_16; } 
else if (strcmp(target, "pcre2_config_32") == 0) {
...
return (void*)&pcre2_set_substitute_callout_32; } 
else if (strcmp(target, "pcre2_set_depth_limit_32") == 0) {
...
return (void*)&pcre2_get_match_data_size_32; } 
else if (strcmp(target, "pcre2_get_ovector_count_32") == 0) {
...
return (void*)&pcre2_maketables_free_32; } 
else if (strcmp(target, "utf8proc_version") == 0) {
...
return (void*)&utf8proc_islower; } 
else if (strcmp(target, "utf8proc_isupper") == 0) {
return (void*)&utf8proc_isupper; } 
else if (strcmp(target, "utf8proc_charwidth") == 0) {
...
return (void*)&mpfr_get_str_ndigits; } 
else if (strcmp(target, "mpfr_get_str") == 0) {
...
return (void*)&mpfr_total_order_p; } 
else if (strcmp(target, "dsfmt_gen_rand_all") == 0) {
...
return (void*)&emscripten_set_window_title; } 
else if (strcmp(target, "emscripten_get_screen_size") == 0) {
return (void*)&emscripten_get_screen_size; } 
else if (strcmp(target, "emscripten_hide_mouse") == 0) {
...
return (void*)&emscripten_has_asyncify; } 
else if (strcmp(target, "emscripten_debugger") == 0) {
...
return (void*)&emscripten_dlopen; } 
else if (strcmp(target, "emscripten_throw_number") == 0) {
return (void*)&emscripten_throw_number; } 
else if (strcmp(target, "emscripten_throw_string") == 0) {
return (void*)&emscripten_throw_string; } 
else if (strcmp(target, "emscripten_sleep") == 0) {
